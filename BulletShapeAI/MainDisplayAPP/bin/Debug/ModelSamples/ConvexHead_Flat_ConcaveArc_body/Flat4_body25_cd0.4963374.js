...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_ConcaveArc_body\Flat4_body25_cd0.4963374.js
//         On: 07/04/19, 21:27:33
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln24 = Line(-0.00000000, 4.00000000, 0.00000000, 0.00000000);
  p.Cr29 = ArcCtrEdge(
              0.00000000, 109.08333333,
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V13";
  dim = VerticalDim(p.Ln24.Base, -0.00000000, 4.00000000, 
    p.Ln24.End, 0.00000000, 0.00000000, 
    -1.36157420, 1.84821788);
  if(dim) dim.Name = "V18";
  ...
  CoincidentCon(p.Cr29.Base, -0.00000000, 4.00000000, 
                p.Ln24.Base, -0.00000000, 4.00000000);
  CoincidentCon(p.Cr29.End, 35.00000000, 10.00000000, 
                p.Ln23.End, 35.00000000, 10.00000000);
}
