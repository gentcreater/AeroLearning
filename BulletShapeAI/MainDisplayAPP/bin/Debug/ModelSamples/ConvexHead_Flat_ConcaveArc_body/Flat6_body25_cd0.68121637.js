...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_ConcaveArc_body\Flat6_body25_cd0.68121637.js
//         On: 07/04/19, 21:50:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln24 = Line(-0.00000000, 6.00000000, 0.00000000, 0.00000000);
  p.Cr29 = ArcCtrEdge(
              0.00000000, 161.12500000,
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V13";
  dim = VerticalDim(p.Ln24.Base, -0.00000000, 6.00000000, 
    p.Ln24.End, 0.00000000, 0.00000000, 
    -1.36157420, 2.77232682);
  if(dim) dim.Name = "V18";
  ...
  CoincidentCon(p.Cr29.End, 35.00000000, 10.00000000, 
                p.Ln23, 35.08684637, 10.00000000);
  CoincidentCon(p.Cr29.Base, -0.00000000, 6.00000000, 
                p.Ln24.Base, -0.00000000, 6.00000000);
  CoincidentCon(p.Cr29.End, 35.00000000, 10.00000000, 
                p.Ln23.End, 35.00000000, 10.00000000);
}
