...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_ConcaveArc_body\Flat2_body25_cd0.39796681.js
//         On: 07/04/19, 20:34:48
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln24 = Line(-0.00000000, 2.00000000, 0.00000000, 0.00000000);
  p.Cr29 = ArcCtrEdge(
              0.00000000, 82.56250000,
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V13";
  dim = VerticalDim(p.Ln24.Base, -0.00000000, 2.00000000, 
    p.Ln24.End, 0.00000000, 0.00000000, 
    -1.36157420, 0.92410894);
  if(dim) dim.Name = "V18";
  ...
  CoincidentCon(p.Cr29.Base, -0.00000000, 2.00000000, 
                p.Ln24.Base, -0.00000000, 2.00000000);
  CoincidentCon(p.Cr29.End, 35.00000000, 10.00000000, 
                p.Ln23.End, 35.00000000, 10.00000000);
}
