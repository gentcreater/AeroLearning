...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head25_body30_cd0.98859113.js
//         On: 06/27/19, 20:04:33
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 23.38246985, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.44927742, 10.00000000);
  p.Ln49 = Line(29.78181160, 9.60726087, 25.78554208, 2.41397575);
  p.Cr50 = ArcCtrEdge(
              30.44927742, 9.23644652,
              30.44927742, 10.00000000,
              29.78181160, 9.60726087);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              23.38246985, 3.74901587,
              23.38246985, 1.00000000,
              25.78554208, 2.41397575);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.44927742, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.78181160, 9.60726087, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 23.38246985, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.78554208, 2.41397575, 
  ...
  CoincidentCon(p.Ln46.End, 30.44927742, 10.00000000, 
                p.Cr50.Base, 30.44927742, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.78181160, 9.60726087, 
                p.Cr50.End, 29.78181160, 9.60726087);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 23.38246985, 1.00000000, 
                p.Cr52.Base, 23.38246985, 1.00000000);
  CoincidentCon(p.Ln49.End, 25.78554208, 2.41397575, 
                p.Cr52.End, 25.78554208, 2.41397575);
}
