...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body10_cd0.31331536.js
//         On: 06/27/19, 19:45:46
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(5.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.75245122, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.24754878, 10.00000000);
  p.Ln49 = Line(49.75725845, 9.95145169, 5.24274155, 1.04854831);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.75245122, 3.50000000,
              4.75245122, 1.00000000,
              5.24274155, 1.04854831);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 5.00000000, 1.00000000, 
    3.25119201, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  TangentCon(p.Cr52, 4.75245122, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.24274155, 1.04854831, 
  ...
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.75245122, 1.00000000, 
                p.Cr52.Base, 4.75245122, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.24274155, 1.04854831, 
                p.Cr52.End, 5.24274155, 1.04854831);
}
