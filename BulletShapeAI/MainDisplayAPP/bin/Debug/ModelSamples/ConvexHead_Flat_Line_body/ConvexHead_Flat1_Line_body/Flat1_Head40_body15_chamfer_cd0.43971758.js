...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head40_body15_cd1.3098875.js
//         On: 06/27/19, 19:47:17
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 38.69747861, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 46.30252139, 10.00000000);
  p.Ln49 = Line(44.36743970, 8.86139145, 40.63256030, 2.13860855);
  p.Cr50 = ArcCtrEdge(
              46.30252139, 7.78634607,
              46.30252139, 10.00000000,
              44.36743970, 8.86139145);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              38.69747861, 3.21365393,
              38.69747861, 1.00000000,
              40.63256030, 2.13860855);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 46.30252139, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.36743970, 8.86139145, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 38.69747861, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.63256030, 2.13860855, 
  ...
  CoincidentCon(p.Ln46.End, 46.30252139, 10.00000000, 
                p.Cr50.Base, 46.30252139, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.36743970, 8.86139145, 
                p.Cr50.End, 44.36743970, 8.86139145);
  CoincidentCon(p.Pt114, 40.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 38.69747861, 1.00000000, 
                p.Cr52.Base, 38.69747861, 1.00000000);
  CoincidentCon(p.Ln49.End, 40.63256030, 2.13860855, 
                p.Cr52.End, 40.63256030, 2.13860855);
}
