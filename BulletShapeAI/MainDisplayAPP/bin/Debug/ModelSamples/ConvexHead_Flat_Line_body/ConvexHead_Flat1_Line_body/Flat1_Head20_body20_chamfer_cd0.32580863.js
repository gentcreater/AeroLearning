...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body20_cd0.35121256.js
//         On: 06/27/19, 19:58:48
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 19.53821501, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.33652688, 10.00000000);
  p.Ln49 = Line(39.69311390, 9.86190126, 20.42111166, 1.18950025);
  p.Cr50 = ArcCtrEdge(
              40.33652688, 8.43209465,
              40.33652688, 10.00000000,
              39.69311390, 9.86190126);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.53821501, 3.15149279,
              19.53821501, 1.00000000,
              20.42111166, 1.18950025);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.33652688, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.69311390, 9.86190126, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.53821501, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.42111166, 1.18950025, 
  ...
  CoincidentCon(p.Ln46.End, 40.33652688, 10.00000000, 
                p.Cr50.Base, 40.33652688, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.69311390, 9.86190126, 
                p.Cr50.End, 39.69311390, 9.86190126);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.53821501, 1.00000000, 
                p.Cr52.Base, 19.53821501, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.42111166, 1.18950025, 
                p.Cr52.End, 20.42111166, 1.18950025);
}
