...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head30_body20_cd0.71137686.js
//         On: 06/27/19, 19:57:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 29.17439475, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.60166173, 10.00000000);
  p.Ln49 = Line(39.55278835, 9.59750952, 30.61366755, 1.55230079);
  p.Cr50 = ArcCtrEdge(
              40.60166173, 8.43209465,
              40.60166173, 10.00000000,
              39.55278835, 9.59750952);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.17439475, 3.15149279,
              29.17439475, 1.00000000,
              30.61366755, 1.55230079);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.60166173, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.55278835, 9.59750952, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.17439475, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.61366755, 1.55230079, 
  ...
  CoincidentCon(p.Ln46.End, 40.60166173, 10.00000000, 
                p.Cr50.Base, 40.60166173, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.55278835, 9.59750952, 
                p.Cr50.End, 39.55278835, 9.59750952);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.17439475, 1.00000000, 
                p.Cr52.Base, 29.17439475, 1.00000000);
  CoincidentCon(p.Ln49.End, 30.61366755, 1.55230079, 
                p.Cr52.End, 30.61366755, 1.55230079);
}
