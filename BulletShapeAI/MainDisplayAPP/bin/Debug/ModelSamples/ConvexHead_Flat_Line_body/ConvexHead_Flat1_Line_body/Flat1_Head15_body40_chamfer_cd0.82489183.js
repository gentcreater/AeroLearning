...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body40_cd1.2551068.js
//         On: 06/27/19, 20:09:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 13.10531480, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.26400563, 10.00000000);
  p.Ln49 = Line(19.87178753, 9.76921755, 15.92014048, 2.65625286);
  p.Cr50 = ArcCtrEdge(
              20.26400563, 9.55131861,
              20.26400563, 10.00000000,
              19.87178753, 9.76921755);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              13.10531480, 4.22004490,
              13.10531480, 1.00000000,
              15.92014048, 2.65625286);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.26400563, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.87178753, 9.76921755, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 13.10531480, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.92014048, 2.65625286, 
  ...
  CoincidentCon(p.Ln46.End, 20.26400563, 10.00000000, 
                p.Cr50.Base, 20.26400563, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.87178753, 9.76921755, 
                p.Cr50.End, 19.87178753, 9.76921755);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 13.10531480, 1.00000000, 
                p.Cr52.Base, 13.10531480, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.92014048, 2.65625286, 
                p.Cr52.End, 15.92014048, 2.65625286);
}
