...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body50_cd1.0959141.js
//         On: 06/27/19, 20:12:47
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 2.93425592, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 10.17837754, 10.00000000);
  p.Ln49 = Line(9.91337221, 9.84406997, 6.00321401, 2.80578522);
  p.Cr50 = ArcCtrEdge(
              10.17837754, 9.69684479,
              10.17837754, 10.00000000,
              9.91337221, 9.84406997);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              2.93425592, 4.51076193,
              2.93425592, 1.00000000,
              6.00321401, 2.80578522);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 10.17837754, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 9.91337221, 9.84406997, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 2.93425592, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 6.00321401, 2.80578522, 
  ...
  CoincidentCon(p.Ln46.End, 10.17837754, 10.00000000, 
                p.Cr50.Base, 10.17837754, 10.00000000);
  CoincidentCon(p.Ln49.Base, 9.91337221, 9.84406997, 
                p.Cr50.End, 9.91337221, 9.84406997);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 2.93425592, 1.00000000, 
                p.Cr52.Base, 2.93425592, 1.00000000);
  CoincidentCon(p.Ln49.End, 6.00321401, 2.80578522, 
                p.Cr52.End, 6.00321401, 2.80578522);
}
