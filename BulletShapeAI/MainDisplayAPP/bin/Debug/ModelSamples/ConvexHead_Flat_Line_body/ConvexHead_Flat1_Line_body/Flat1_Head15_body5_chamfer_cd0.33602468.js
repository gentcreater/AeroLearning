...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head19_body5_cd0.33655071.js
//         On: 06/27/19, 19:20:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.72222222, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.27777778, 10.00000000);
  p.Ln49 = Line(54.72899729, 9.93902439, 15.27100271, 1.06097561);
  p.Cr50 = ArcCtrEdge(
              55.27777778, 7.50000000,
              55.27777778, 10.00000000,
              54.72899729, 9.93902439);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.72222222, 3.50000000,
              14.72222222, 1.00000000,
              15.27100271, 1.06097561);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.27777778, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.72899729, 9.93902439, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.72222222, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.27100271, 1.06097561, 
  ...
  CoincidentCon(p.Ln46.End, 55.27777778, 10.00000000, 
                p.Cr50.Base, 55.27777778, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.72899729, 9.93902439, 
                p.Cr50.End, 54.72899729, 9.93902439);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.72222222, 1.00000000, 
                p.Cr52.Base, 14.72222222, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.27100271, 1.06097561, 
                p.Cr52.End, 15.27100271, 1.06097561);
}
