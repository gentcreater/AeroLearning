...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head25_body25_cd0.7064775.js
//         On: 06/27/19, 20:01:38
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 24.06661334, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.41097777, 10.00000000);
  p.Ln49 = Line(34.69452263, 9.72507037, 25.69378084, 1.62440275);
  p.Cr50 = ArcCtrEdge(
              35.41097777, 8.92900910,
              35.41097777, 10.00000000,
              34.69452263, 9.72507037);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.06661334, 3.43236663,
              24.06661334, 1.00000000,
              25.69378084, 1.62440275);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.41097777, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.69452263, 9.72507037, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.06661334, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.69378084, 1.62440275, 
  ...
  CoincidentCon(p.Ln46.End, 35.41097777, 10.00000000, 
                p.Cr50.Base, 35.41097777, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.69452263, 9.72507037, 
                p.Cr50.End, 34.69452263, 9.72507037);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.06661334, 1.00000000, 
                p.Cr52.Base, 24.06661334, 1.00000000);
  CoincidentCon(p.Ln49.End, 25.69378084, 1.62440275, 
                p.Cr52.End, 25.69378084, 1.62440275);
}
