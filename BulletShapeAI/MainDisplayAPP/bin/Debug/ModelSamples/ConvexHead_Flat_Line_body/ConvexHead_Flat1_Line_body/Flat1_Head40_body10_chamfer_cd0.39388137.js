...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head40_body10_cd1.0947655.js
//         On: 06/27/19, 19:23:29
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(40.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 39.04065999, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.95934001, 10.00000000);
  p.Ln49 = Line(49.28692818, 9.35823537, 40.71307182, 1.64176463);
  p.Cr50 = ArcCtrEdge(
              50.95934001, 7.50000000,
              50.95934001, 10.00000000,
              49.28692818, 9.35823537);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.04065999, 3.50000000,
              39.04065999, 1.00000000,
              40.71307182, 1.64176463);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 40.00000000, 1.00000000, 
    26.00953608, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.95934001, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.28692818, 9.35823537, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.04065999, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.71307182, 1.64176463, 
  ...
  CoincidentCon(p.Ln46.End, 50.95934001, 10.00000000, 
                p.Cr50.Base, 50.95934001, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.28692818, 9.35823537, 
                p.Cr50.End, 49.28692818, 9.35823537);
  CoincidentCon(p.Pt114, 40.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.04065999, 1.00000000, 
                p.Cr52.Base, 39.04065999, 1.00000000);
  CoincidentCon(p.Ln49.End, 40.71307182, 1.64176463, 
                p.Cr52.End, 40.71307182, 1.64176463);
}
