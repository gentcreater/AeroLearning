...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head35_body10_cd0.50335613.js
//         On: 06/27/19, 19:26:21
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(35.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 34.30754009, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.69245991, 10.00000000);
  p.Ln49 = Line(49.40622052, 9.64373231, 35.59377948, 1.35626769);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.30754009, 3.50000000,
              34.30754009, 1.00000000,
              35.59377948, 1.35626769);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 35.00000000, 1.00000000, 
    22.75834407, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  TangentCon(p.Cr52, 34.30754009, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.59377948, 1.35626769, 
  ...
  CoincidentCon(p.Pt114, 35.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.30754009, 1.00000000, 
                p.Cr52.Base, 34.30754009, 1.00000000);
  CoincidentCon(p.Ln49.End, 35.59377948, 1.35626769, 
                p.Cr52.End, 35.59377948, 1.35626769);
}
