...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body15_cd0.31338528.js
//         On: 06/27/19, 19:55:21
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.67510459, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.32489541, 10.00000000);
  p.Ln49 = Line(44.68880663, 9.90664199, 15.31119337, 1.09335801);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.67510459, 3.21365393,
              14.67510459, 1.00000000,
              15.31119337, 1.09335801);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 14.67510459, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.31119337, 1.09335801, 
  ...
  CoincidentCon(p.Ln43.End, 14.67510459, 1.00000000, 
                p.Cr52.Base, 14.67510459, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.31119337, 1.09335801, 
                p.Cr52.End, 15.31119337, 1.09335801);
}
