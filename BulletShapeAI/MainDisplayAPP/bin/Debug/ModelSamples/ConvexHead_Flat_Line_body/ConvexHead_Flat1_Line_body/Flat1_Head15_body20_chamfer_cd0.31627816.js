...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body20_cd0.32400604.js
//         On: 06/27/19, 19:59:20
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.62452614, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.27362745, 10.00000000);
  p.Ln49 = Line(39.74254738, 9.90731706, 15.35327863, 1.12718031);
  p.Cr50 = ArcCtrEdge(
              40.27362745, 8.43209465,
              40.27362745, 10.00000000,
              39.74254738, 9.90731706);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.62452614, 3.15149279,
              14.62452614, 1.00000000,
              15.35327863, 1.12718031);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.27362745, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.74254738, 9.90731706, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.62452614, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.35327863, 1.12718031, 
  ...
  CoincidentCon(p.Ln46.End, 40.27362745, 10.00000000, 
                p.Cr50.Base, 40.27362745, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.74254738, 9.90731706, 
                p.Cr50.End, 39.74254738, 9.90731706);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.62452614, 1.00000000, 
                p.Cr52.Base, 14.62452614, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.35327863, 1.12718031, 
                p.Cr52.End, 15.35327863, 1.12718031);
}
