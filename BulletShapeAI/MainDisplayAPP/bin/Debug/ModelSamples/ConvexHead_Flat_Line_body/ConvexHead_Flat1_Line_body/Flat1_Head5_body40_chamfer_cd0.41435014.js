...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body40_cd0.46592607.js
//         On: 06/27/19, 20:10:56
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.10809920, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.12427755, 10.00000000);
  p.Ln49 = Line(19.89343288, 9.93605973, 5.76479863, 1.45887918);
  p.Cr50 = ArcCtrEdge(
              20.12427755, 9.55131861,
              20.12427755, 10.00000000,
              19.89343288, 9.93605973);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.10809920, 4.22004490,
              4.10809920, 1.00000000,
              5.76479863, 1.45887918);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.12427755, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.89343288, 9.93605973, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.10809920, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.76479863, 1.45887918, 
  ...
  CoincidentCon(p.Ln46.End, 20.12427755, 10.00000000, 
                p.Cr50.Base, 20.12427755, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.89343288, 9.93605973, 
                p.Cr50.End, 19.89343288, 9.93605973);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.10809920, 1.00000000, 
                p.Cr52.Base, 4.10809920, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.76479863, 1.45887918, 
                p.Cr52.End, 5.76479863, 1.45887918);
}
