...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head35_body20_cd1.2059271.js
//         On: 06/27/19, 19:57:06
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(50.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 48.52899163, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 56.47100837, 10.00000000);
  p.Ln49 = Line(54.28561518, 8.71410733, 50.71438482, 2.28589267);
  p.Cr50 = ArcCtrEdge(
              56.47100837, 7.50000000,
              56.47100837, 10.00000000,
              54.28561518, 8.71410733);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              48.52899163, 3.50000000,
              48.52899163, 1.00000000,
              50.71438482, 2.28589267);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 50.00000000, 1.00000000, 
    32.51192010, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 56.47100837, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.28561518, 8.71410733, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 48.52899163, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 50.71438482, 2.28589267, 
  ...
  CoincidentCon(p.Ln46.End, 56.47100837, 10.00000000, 
                p.Cr50.Base, 56.47100837, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.28561518, 8.71410733, 
                p.Cr50.End, 54.28561518, 8.71410733);
  CoincidentCon(p.Pt114, 50.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 50.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 48.52899163, 1.00000000, 
                p.Cr52.Base, 48.52899163, 1.00000000);
  CoincidentCon(p.Ln49.End, 50.71438482, 2.28589267, 
                p.Cr52.End, 50.71438482, 2.28589267);
}
