...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body30_cd0.45513994.js
//         On: 06/27/19, 20:05:47
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.23856668, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.21149207, 10.00000000);
  p.Ln49 = Line(29.81864705, 9.89118823, 15.65292368, 1.39175421);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.23856668, 3.74901587,
              14.23856668, 1.00000000,
              15.65292368, 1.39175421);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 14.23856668, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.65292368, 1.39175421, 
  ...
  CoincidentCon(p.Ln43.End, 14.23856668, 1.00000000, 
                p.Cr52.Base, 14.23856668, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.65292368, 1.39175421, 
                p.Cr52.End, 15.65292368, 1.39175421);
}
