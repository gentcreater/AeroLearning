...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body5_cd0.32799093.js
//         On: 06/27/19, 19:22:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.77679356, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.22320644, 10.00000000);
  p.Ln49 = Line(54.78032394, 9.96045831, 5.21967606, 1.03954169);
  p.Cr50 = ArcCtrEdge(
              55.22320644, 7.50000000,
              55.22320644, 10.00000000,
              54.78032394, 9.96045831);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.77679356, 3.50000000,
              4.77679356, 1.00000000,
              5.21967606, 1.03954169);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.22320644, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.78032394, 9.96045831, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.77679356, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.21967606, 1.03954169, 
  ...
  CoincidentCon(p.Ln46.End, 55.22320644, 10.00000000, 
                p.Cr50.Base, 55.22320644, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.78032394, 9.96045831, 
                p.Cr50.End, 54.78032394, 9.96045831);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.77679356, 1.00000000, 
                p.Cr52.Base, 4.77679356, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.21967606, 1.03954169, 
                p.Cr52.End, 5.21967606, 1.03954169);
}
