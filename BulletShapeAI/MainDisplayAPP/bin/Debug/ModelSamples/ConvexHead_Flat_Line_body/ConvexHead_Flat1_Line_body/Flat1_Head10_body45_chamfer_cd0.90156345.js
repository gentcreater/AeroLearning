...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body45_cd1.007777.js
//         On: 06/27/19, 20:11:28
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 8.00989992, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.21406408, 10.00000000);
  p.Ln49 = Line(14.89604129, 9.81287432, 10.96647804, 2.73966047);
  p.Cr50 = ArcCtrEdge(
              15.21406408, 9.63619499,
              15.21406408, 10.00000000,
              14.89604129, 9.81287432);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              8.00989992, 4.38220386,
              8.00989992, 1.00000000,
              10.96647804, 2.73966047);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.21406408, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.89604129, 9.81287432, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 8.00989992, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.96647804, 2.73966047, 
  ...
  CoincidentCon(p.Ln46.End, 15.21406408, 10.00000000, 
                p.Cr50.Base, 15.21406408, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.89604129, 9.81287432, 
                p.Cr50.End, 14.89604129, 9.81287432);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 8.00989992, 1.00000000, 
                p.Cr52.Base, 8.00989992, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.96647804, 2.73966047, 
                p.Cr52.End, 10.96647804, 2.73966047);
}
