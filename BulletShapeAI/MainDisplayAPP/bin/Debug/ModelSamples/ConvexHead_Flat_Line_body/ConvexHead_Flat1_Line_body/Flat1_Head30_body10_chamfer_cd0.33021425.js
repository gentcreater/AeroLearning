...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head30_body10_cd0.37398857.js
//         On: 06/27/19, 19:26:52
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(30.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 29.46341328, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.53658672, 10.00000000);
  p.Ln49 = Line(49.51067503, 9.77980376, 30.48932497, 1.22019624);
  p.Cr50 = ArcCtrEdge(
              50.53658672, 7.50000000,
              50.53658672, 10.00000000,
              49.51067503, 9.77980376);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.46341328, 3.50000000,
              29.46341328, 1.00000000,
              30.48932497, 1.22019624);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 30.00000000, 1.00000000, 
    19.50715206, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.53658672, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.51067503, 9.77980376, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.46341328, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.48932497, 1.22019624, 
  ...
  CoincidentCon(p.Ln46.End, 50.53658672, 10.00000000, 
                p.Cr50.Base, 50.53658672, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.51067503, 9.77980376, 
                p.Cr50.End, 49.51067503, 9.77980376);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.46341328, 1.00000000, 
                p.Cr52.Base, 29.46341328, 1.00000000);
  CoincidentCon(p.Ln49.End, 30.48932497, 1.22019624, 
                p.Cr52.End, 30.48932497, 1.22019624);
}
