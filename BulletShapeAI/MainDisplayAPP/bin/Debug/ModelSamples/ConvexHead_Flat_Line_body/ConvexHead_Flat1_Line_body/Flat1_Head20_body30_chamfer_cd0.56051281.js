...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body30_cd0.71997488.js
//         On: 06/27/19, 20:05:13
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 18.94510363, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.29300296, 10.00000000);
  p.Ln49 = Line(29.78221261, 9.80399135, 20.78409830, 1.70568847);
  p.Cr50 = ArcCtrEdge(
              30.29300296, 9.23644652,
              30.29300296, 10.00000000,
              29.78221261, 9.80399135);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              18.94510363, 3.74901587,
              18.94510363, 1.00000000,
              20.78409830, 1.70568847);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.29300296, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.78221261, 9.80399135, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 18.94510363, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.78409830, 1.70568847, 
  ...
  CoincidentCon(p.Ln46.End, 30.29300296, 10.00000000, 
                p.Cr50.Base, 30.29300296, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.78221261, 9.80399135, 
                p.Cr50.End, 29.78221261, 9.80399135);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 18.94510363, 1.00000000, 
                p.Cr52.Base, 18.94510363, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.78409830, 1.70568847, 
                p.Cr52.End, 20.78409830, 1.70568847);
}
