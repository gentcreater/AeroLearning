...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head35_body15_cd1.0030815.js
//         On: 06/27/19, 19:47:51
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 34.15054128, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.84945872, 10.00000000);
  p.Ln49 = Line(44.36860231, 9.43174208, 35.63139769, 1.56825792);
  p.Cr50 = ArcCtrEdge(
              45.84945872, 7.78634607,
              45.84945872, 10.00000000,
              44.36860231, 9.43174208);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.15054128, 3.21365393,
              34.15054128, 1.00000000,
              35.63139769, 1.56825792);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.84945872, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.36860231, 9.43174208, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.15054128, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.63139769, 1.56825792, 
  ...
  CoincidentCon(p.Ln46.End, 45.84945872, 10.00000000, 
                p.Cr50.Base, 45.84945872, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.36860231, 9.43174208, 
                p.Cr50.End, 44.36860231, 9.43174208);
  CoincidentCon(p.Pt114, 35.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.15054128, 1.00000000, 
                p.Cr52.Base, 34.15054128, 1.00000000);
  CoincidentCon(p.Ln49.End, 35.63139769, 1.56825792, 
                p.Cr52.End, 35.63139769, 1.56825792);
}
