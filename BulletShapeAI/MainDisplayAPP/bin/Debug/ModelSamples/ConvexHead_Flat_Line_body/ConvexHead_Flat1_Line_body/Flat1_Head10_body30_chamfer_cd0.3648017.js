...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body30_cd0.36305267.js
//         On: 06/27/19, 20:06:26
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 9.40996583, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.16388506, 10.00000000);
  p.Ln49 = Line(29.85054969, 9.93274736, 10.53806485, 1.24212918);
  p.Cr50 = ArcCtrEdge(
              30.16388506, 9.23644652,
              30.16388506, 10.00000000,
              29.85054969, 9.93274736);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.40996583, 3.74901587,
              9.40996583, 1.00000000,
              10.53806485, 1.24212918);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.16388506, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.85054969, 9.93274736, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.40996583, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.53806485, 1.24212918, 
  ...
  CoincidentCon(p.Ln46.End, 30.16388506, 10.00000000, 
                p.Cr50.Base, 30.16388506, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.85054969, 9.93274736, 
                p.Cr50.End, 29.85054969, 9.93274736);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.40996583, 1.00000000, 
                p.Cr52.Base, 9.40996583, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.53806485, 1.24212918, 
                p.Cr52.End, 10.53806485, 1.24212918);
}
