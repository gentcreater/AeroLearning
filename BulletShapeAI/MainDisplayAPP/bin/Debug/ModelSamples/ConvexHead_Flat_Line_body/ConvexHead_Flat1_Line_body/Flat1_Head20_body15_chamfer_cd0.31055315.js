...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body15_cd0.32327737.js
//         On: 06/27/19, 19:54:46
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 19.61367791, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.38632209, 10.00000000);
  p.Ln49 = Line(44.63651441, 9.86914519, 20.36348559, 1.13085481);
  p.Cr50 = ArcCtrEdge(
              45.38632209, 7.78634607,
              45.38632209, 10.00000000,
              44.63651441, 9.86914519);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.61367791, 3.21365393,
              19.61367791, 1.00000000,
              20.36348559, 1.13085481);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.38632209, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.63651441, 9.86914519, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.61367791, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.36348559, 1.13085481, 
  ...
  CoincidentCon(p.Ln46.End, 45.38632209, 10.00000000, 
                p.Cr50.Base, 45.38632209, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.63651441, 9.86914519, 
                p.Cr50.End, 44.63651441, 9.86914519);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.61367791, 1.00000000, 
                p.Cr52.Base, 19.61367791, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.36348559, 1.13085481, 
                p.Cr52.End, 20.36348559, 1.13085481);
}
