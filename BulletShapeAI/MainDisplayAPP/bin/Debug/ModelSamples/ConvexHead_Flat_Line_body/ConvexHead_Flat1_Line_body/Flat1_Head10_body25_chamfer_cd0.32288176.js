...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body25_cd0.3266996.js
//         On: 06/27/19, 20:03:17
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 9.57550864, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.18690701, 10.00000000);
  p.Ln49 = Line(34.82414154, 9.93669096, 10.39939857, 1.14378349);
  p.Cr50 = ArcCtrEdge(
              35.18690701, 8.92900910,
              35.18690701, 10.00000000,
              34.82414154, 9.93669096);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.57550864, 3.43236663,
              9.57550864, 1.00000000,
              10.39939857, 1.14378349);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.18690701, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.82414154, 9.93669096, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.57550864, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.39939857, 1.14378349, 
  ...
  CoincidentCon(p.Ln46.End, 35.18690701, 10.00000000, 
                p.Cr50.Base, 35.18690701, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.82414154, 9.93669096, 
                p.Cr50.End, 34.82414154, 9.93669096);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.57550864, 1.00000000, 
                p.Cr52.Base, 9.57550864, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.39939857, 1.14378349, 
                p.Cr52.End, 10.39939857, 1.14378349);
}
