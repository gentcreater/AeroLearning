...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body35_cd0.46609209.js
//         On: 06/27/19, 20:08:39
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(10.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 9.16547911, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.15865285, 10.00000000);
  p.Ln49 = Line(24.86395631, 9.91837378, 10.71559576, 1.42935746);
  p.Cr50 = ArcCtrEdge(
              25.15865285, 9.42721289,
              25.15865285, 10.00000000,
              24.86395631, 9.91837378);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.16547911, 4.01288521,
              9.16547911, 1.00000000,
              10.71559576, 1.42935746);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 10.00000000, 1.00000000, 
    6.50238402, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.15865285, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.86395631, 9.91837378, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.16547911, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.71559576, 1.42935746, 
  ...
  CoincidentCon(p.Ln46.End, 25.15865285, 10.00000000, 
                p.Cr50.Base, 25.15865285, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.86395631, 9.91837378, 
                p.Cr50.End, 24.86395631, 9.91837378);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.16547911, 1.00000000, 
                p.Cr52.Base, 9.16547911, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.71559576, 1.42935746, 
                p.Cr52.End, 10.71559576, 1.42935746);
}
