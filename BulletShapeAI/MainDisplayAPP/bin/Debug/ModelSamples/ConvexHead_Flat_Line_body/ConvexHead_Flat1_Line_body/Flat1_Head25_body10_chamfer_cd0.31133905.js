...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head25_body10_cd0.3352846.js
//         On: 06/27/19, 19:27:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 24.56370541, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.43629459, 10.00000000);
  p.Ln49 = Line(49.58949592, 9.85221853, 25.41050408, 1.14778147);
  p.Cr50 = ArcCtrEdge(
              50.43629459, 7.50000000,
              50.43629459, 10.00000000,
              49.58949592, 9.85221853);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.56370541, 3.50000000,
              24.56370541, 1.00000000,
              25.41050408, 1.14778147);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.43629459, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.58949592, 9.85221853, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.56370541, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.41050408, 1.14778147, 
  ...
  CoincidentCon(p.Ln46.End, 50.43629459, 10.00000000, 
                p.Cr50.Base, 50.43629459, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.58949592, 9.85221853, 
                p.Cr50.End, 49.58949592, 9.85221853);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.56370541, 1.00000000, 
                p.Cr52.Base, 24.56370541, 1.00000000);
  CoincidentCon(p.Ln49.End, 25.41050408, 1.14778147, 
                p.Cr52.End, 25.41050408, 1.14778147);
}
