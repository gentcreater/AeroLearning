...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body35_cd0.72643028.js
//         On: 06/27/19, 20:08:07
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 13.84384746, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.21979904, 10.00000000);
  p.Ln49 = Line(24.83662466, 9.85296220, 15.85936141, 1.77342527);
  p.Cr50 = ArcCtrEdge(
              25.21979904, 9.42721289,
              25.21979904, 10.00000000,
              24.83662466, 9.85296220);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              13.84384746, 4.01288521,
              13.84384746, 1.00000000,
              15.85936141, 1.77342527);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.21979904, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.83662466, 9.85296220, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 13.84384746, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.85936141, 1.77342527, 
  ...
  CoincidentCon(p.Ln46.End, 25.21979904, 10.00000000, 
                p.Cr50.Base, 25.21979904, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.83662466, 9.85296220, 
                p.Cr50.End, 24.83662466, 9.85296220);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 13.84384746, 1.00000000, 
                p.Cr52.Base, 13.84384746, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.85936141, 1.77342527, 
                p.Cr52.End, 15.85936141, 1.77342527);
}
