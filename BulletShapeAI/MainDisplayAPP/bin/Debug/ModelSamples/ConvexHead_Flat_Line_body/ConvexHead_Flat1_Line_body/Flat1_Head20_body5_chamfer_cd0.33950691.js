...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body5_cd0.34199435.js
//         On: 06/27/19, 19:19:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 19.68371611, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.31628389, 10.00000000);
  p.Ln49 = Line(54.69368129, 9.92123233, 20.30631871, 1.07876767);
  p.Cr50 = ArcCtrEdge(
              55.31628389, 7.50000000,
              55.31628389, 10.00000000,
              54.69368129, 9.92123233);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.68371611, 3.50000000,
              19.68371611, 1.00000000,
              20.30631871, 1.07876767);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.31628389, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.69368129, 9.92123233, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.68371611, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.30631871, 1.07876767, 
  ...
  CoincidentCon(p.Ln46.End, 55.31628389, 10.00000000, 
                p.Cr50.Base, 55.31628389, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.69368129, 9.92123233, 
                p.Cr50.End, 54.69368129, 9.92123233);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.68371611, 1.00000000, 
                p.Cr52.Base, 19.68371611, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.30631871, 1.07876767, 
                p.Cr52.End, 20.30631871, 1.07876767);
}
