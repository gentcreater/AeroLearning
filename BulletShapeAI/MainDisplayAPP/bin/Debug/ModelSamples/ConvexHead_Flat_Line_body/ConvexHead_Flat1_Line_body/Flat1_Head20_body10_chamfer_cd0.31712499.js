...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body10_cd0.32097536.js
//         On: 06/27/19, 19:44:02
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 19.63307791, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.36692209, 10.00000000);
  p.Ln49 = Line(49.64855238, 9.89456571, 20.35144762, 1.10543429);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.63307791, 3.50000000,
              19.63307791, 1.00000000,
              20.35144762, 1.10543429);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 19.63307791, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.35144762, 1.10543429, 
  ...
  CoincidentCon(p.Ln43.End, 19.63307791, 1.00000000, 
                p.Cr52.Base, 19.63307791, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.35144762, 1.10543429, 
                p.Cr52.End, 20.35144762, 1.10543429);
}
