...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body15_cd0.30882993.js
//         On: 06/27/19, 19:55:59
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 9.71994277, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.28005723, 10.00000000);
  p.Ln49 = Line(44.72876655, 9.93025426, 10.27123345, 1.06974574);
  p.Cr50 = ArcCtrEdge(
              45.28005723, 7.78634607,
              45.28005723, 10.00000000,
              44.72876655, 9.93025426);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.71994277, 3.21365393,
              9.71994277, 1.00000000,
              10.27123345, 1.06974574);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.28005723, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.72876655, 9.93025426, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.71994277, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.27123345, 1.06974574, 
  ...
  CoincidentCon(p.Ln46.End, 45.28005723, 10.00000000, 
                p.Cr50.Base, 45.28005723, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.72876655, 9.93025426, 
                p.Cr50.End, 44.72876655, 9.93025426);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.71994277, 1.00000000, 
                p.Cr52.Base, 9.71994277, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.27123345, 1.06974574, 
                p.Cr52.End, 10.27123345, 1.06974574);
}
