...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body25_cd0.48441761.js
//         On: 06/27/19, 20:02:10
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 19.32627345, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.29664731, 10.00000000);
  p.Ln49 = Line(34.74562703, 9.84737622, 20.57771575, 1.34662945);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.32627345, 3.43236663,
              19.32627345, 1.00000000,
              20.57771575, 1.34662945);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 19.32627345, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.57771575, 1.34662945, 
  ...
  CoincidentCon(p.Ln43.End, 19.32627345, 1.00000000, 
                p.Cr52.Base, 19.32627345, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.57771575, 1.34662945, 
                p.Cr52.End, 20.57771575, 1.34662945);
}
