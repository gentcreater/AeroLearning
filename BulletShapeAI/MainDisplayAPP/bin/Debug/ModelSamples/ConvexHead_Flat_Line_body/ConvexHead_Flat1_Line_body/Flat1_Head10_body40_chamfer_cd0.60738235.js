...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head10_body40_cd0.73321805.js
//         On: 06/27/19, 20:10:17
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 8.76435283, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.17217520, 10.00000000);
  p.Ln49 = Line(19.87202318, 9.88482086, 10.91844931, 1.82660438);
  p.Cr50 = ArcCtrEdge(
              20.17217520, 9.55131861,
              20.17217520, 10.00000000,
              19.87202318, 9.88482086);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              8.76435283, 4.22004490,
              8.76435283, 1.00000000,
              10.91844931, 1.82660438);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.17217520, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.87202318, 9.88482086, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 8.76435283, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.91844931, 1.82660438, 
  ...
  CoincidentCon(p.Ln46.End, 20.17217520, 10.00000000, 
                p.Cr50.Base, 20.17217520, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.87202318, 9.88482086, 
                p.Cr50.End, 19.87202318, 9.88482086);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 8.76435283, 1.00000000, 
                p.Cr52.Base, 8.76435283, 1.00000000);
  CoincidentCon(p.Ln49.End, 10.91844931, 1.82660438, 
                p.Cr52.End, 10.91844931, 1.82660438);
}
