...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head30_body25_cd1.0076019.js
//         On: 06/27/19, 20:01:07
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 28.56878733, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.63017463, 10.00000000);
  p.Ln49 = Line(34.69396014, 9.44912826, 30.69505832, 2.25110497);
  p.Cr50 = ArcCtrEdge(
              35.63017463, 8.92900910,
              35.63017463, 10.00000000,
              34.69396014, 9.44912826);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              28.56878733, 3.43236663,
              28.56878733, 1.00000000,
              30.69505832, 2.25110497);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.63017463, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.69396014, 9.44912826, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 28.56878733, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.69505832, 2.25110497, 
  ...
  CoincidentCon(p.Ln46.End, 35.63017463, 10.00000000, 
                p.Cr50.Base, 35.63017463, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.69396014, 9.44912826, 
                p.Cr50.End, 34.69396014, 9.44912826);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 28.56878733, 1.00000000, 
                p.Cr52.Base, 28.56878733, 1.00000000);
  CoincidentCon(p.Ln49.End, 30.69505832, 2.25110497, 
                p.Cr52.End, 30.69505832, 2.25110497);
}
