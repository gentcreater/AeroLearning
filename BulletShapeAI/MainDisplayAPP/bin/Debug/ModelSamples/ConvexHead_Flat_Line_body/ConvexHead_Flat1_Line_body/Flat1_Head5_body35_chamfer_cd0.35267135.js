...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body35_cd0.36735268.js
//         On: 06/27/19, 20:09:05
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.35333032, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.12293998, 10.00000000);
  p.Ln49 = Line(24.88788839, 9.94954977, 5.58971199, 1.26537039);
  p.Cr50 = ArcCtrEdge(
              25.12293998, 9.42721289,
              25.12293998, 10.00000000,
              24.88788839, 9.94954977);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.35333032, 4.01288521,
              4.35333032, 1.00000000,
              5.58971199, 1.26537039);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.12293998, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.88788839, 9.94954977, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.35333032, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.58971199, 1.26537039, 
  ...
  CoincidentCon(p.Ln46.End, 25.12293998, 10.00000000, 
                p.Cr50.Base, 25.12293998, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.88788839, 9.94954977, 
                p.Cr50.End, 24.88788839, 9.94954977);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.35333032, 1.00000000, 
                p.Cr52.Base, 4.35333032, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.58971199, 1.26537039, 
                p.Cr52.End, 5.58971199, 1.26537039);
}
