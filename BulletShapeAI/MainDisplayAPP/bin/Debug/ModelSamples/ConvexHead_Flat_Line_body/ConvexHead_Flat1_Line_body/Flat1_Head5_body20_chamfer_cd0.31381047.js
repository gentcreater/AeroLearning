...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body20_cd0.31325883.js
//         On: 06/27/19, 20:00:28
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.72780700, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.19836128, 10.00000000);
  p.Ln49 = Line(39.80788850, 9.95059990, 5.26361700, 1.06778723);
  p.Cr50 = ArcCtrEdge(
              40.19836128, 8.43209465,
              40.19836128, 10.00000000,
              39.80788850, 9.95059990);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.72780700, 3.15149279,
              4.72780700, 1.00000000,
              5.26361700, 1.06778723);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.19836128, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.80788850, 9.95059990, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.72780700, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.26361700, 1.06778723, 
  ...
  CoincidentCon(p.Ln46.End, 40.19836128, 10.00000000, 
                p.Cr50.Base, 40.19836128, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.80788850, 9.95059990, 
                p.Cr50.End, 39.80788850, 9.95059990);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.72780700, 1.00000000, 
                p.Cr52.Base, 4.72780700, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.26361700, 1.06778723, 
                p.Cr52.End, 5.26361700, 1.06778723);
}
