...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body30_cd0.33410006.js
//         On: 06/27/19, 20:06:57
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.52024770, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.13325370, 10.00000000);
  p.Ln49 = Line(29.87462327, 9.95486438, 5.45139290, 1.16250144);
  p.Cr50 = ArcCtrEdge(
              30.13325370, 9.23644652,
              30.13325370, 10.00000000,
              29.87462327, 9.95486438);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.52024770, 3.74901587,
              4.52024770, 1.00000000,
              5.45139290, 1.16250144);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.13325370, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.87462327, 9.95486438, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.52024770, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.45139290, 1.16250144, 
  ...
  CoincidentCon(p.Ln46.End, 30.13325370, 10.00000000, 
                p.Cr50.Base, 30.13325370, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.87462327, 9.95486438, 
                p.Cr50.End, 29.87462327, 9.95486438);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.52024770, 1.00000000, 
                p.Cr52.Base, 4.52024770, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.45139290, 1.16250144, 
                p.Cr52.End, 5.45139290, 1.16250144);
}
