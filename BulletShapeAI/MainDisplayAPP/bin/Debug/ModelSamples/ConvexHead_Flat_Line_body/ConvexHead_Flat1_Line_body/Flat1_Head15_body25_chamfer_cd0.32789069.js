...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head15_body25_cd0.35553807.js
//         On: 06/27/19, 20:02:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(15.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.47792974, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.22987180, 10.00000000);
  p.Ln49 = Line(34.79037496, 9.90566873, 15.47608709, 1.21423919);
  p.Cr50 = ArcCtrEdge(
              35.22987180, 8.92900910,
              35.22987180, 10.00000000,
              34.79037496, 9.90566873);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.47792974, 3.43236663,
              14.47792974, 1.00000000,
              15.47608709, 1.21423919);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 15.00000000, 1.00000000, 
    9.75357603, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.22987180, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.79037496, 9.90566873, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.47792974, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.47608709, 1.21423919, 
  ...
  CoincidentCon(p.Ln46.End, 35.22987180, 10.00000000, 
                p.Cr50.Base, 35.22987180, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.79037496, 9.90566873, 
                p.Cr50.End, 34.79037496, 9.90566873);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.47792974, 1.00000000, 
                p.Cr52.Base, 14.47792974, 1.00000000);
  CoincidentCon(p.Ln49.End, 15.47608709, 1.21423919, 
                p.Cr52.End, 15.47608709, 1.21423919);
}
