...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head5_body15_cd0.31052242.js
//         On: 06/27/19, 19:56:26
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 4.75403845, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.24596155, 10.00000000);
  p.Ln49 = Line(44.76003751, 9.94600844, 5.23996249, 1.05399156);
  p.Cr50 = ArcCtrEdge(
              45.24596155, 7.78634607,
              45.24596155, 10.00000000,
              44.76003751, 9.94600844);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.75403845, 3.21365393,
              4.75403845, 1.00000000,
              5.23996249, 1.05399156);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.24596155, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.76003751, 9.94600844, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.75403845, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.23996249, 1.05399156, 
  ...
  CoincidentCon(p.Ln46.End, 45.24596155, 10.00000000, 
                p.Cr50.Base, 45.24596155, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.76003751, 9.94600844, 
                p.Cr50.End, 44.76003751, 9.94600844);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.75403845, 1.00000000, 
                p.Cr52.Base, 4.75403845, 1.00000000);
  CoincidentCon(p.Ln49.End, 5.23996249, 1.05399156, 
                p.Cr52.End, 5.23996249, 1.05399156);
}
