...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head20_body35_cd0.93116408.js
//         On: 06/27/19, 20:07:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(20.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 18.22720825, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.33702986, 10.00000000);
  p.Ln49 = Line(24.83632383, 9.70538290, 20.86094378, 2.54969881);
  p.Cr50 = ArcCtrEdge(
              25.33702986, 9.42721289,
              25.33702986, 10.00000000,
              24.83632383, 9.70538290);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              18.22720825, 4.01288521,
              18.22720825, 1.00000000,
              20.86094378, 2.54969881);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt114, 20.00000000, 1.00000000, 
    13.00476804, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.33702986, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.83632383, 9.70538290, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 18.22720825, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.86094378, 2.54969881, 
  ...
  CoincidentCon(p.Ln46.End, 25.33702986, 10.00000000, 
                p.Cr50.Base, 25.33702986, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.83632383, 9.70538290, 
                p.Cr50.End, 24.83632383, 9.70538290);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 18.22720825, 1.00000000, 
                p.Cr52.Base, 18.22720825, 1.00000000);
  CoincidentCon(p.Ln49.End, 20.86094378, 2.54969881, 
                p.Cr52.End, 20.86094378, 2.54969881);
}
