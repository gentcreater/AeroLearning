...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head30_body15_cd0.47071302.js
//         On: 06/27/19, 19:48:31
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 29.38685336, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.61314664, 10.00000000);
  p.Ln49 = Line(44.47423109, 9.68453865, 30.52576891, 1.31546135);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.38685336, 3.21365393,
              29.38685336, 1.00000000,
              30.52576891, 1.31546135);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 29.38685336, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.52576891, 1.31546135, 
  ...
  CoincidentCon(p.Ln43.End, 29.38685336, 1.00000000, 
                p.Cr52.Base, 29.38685336, 1.00000000);
  CoincidentCon(p.Ln49.End, 30.52576891, 1.31546135, 
                p.Cr52.End, 30.52576891, 1.31546135);
}
