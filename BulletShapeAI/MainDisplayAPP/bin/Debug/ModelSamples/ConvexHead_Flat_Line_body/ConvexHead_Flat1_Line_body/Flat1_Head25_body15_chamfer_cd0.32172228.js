...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat1_Line_body\Flat1_Head25_body15_cd0.35661145.js
//         On: 06/27/19, 19:49:01
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 24.52487308, 1.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.47512692, 10.00000000);
  p.Ln49 = Line(44.56672154, 9.80502469, 25.43327846, 1.19497531);
  p.Cr50 = ArcCtrEdge(
              45.47512692, 7.78634607,
              45.47512692, 10.00000000,
              44.56672154, 9.80502469);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.52487308, 3.21365393,
              24.52487308, 1.00000000,
              25.43327846, 1.19497531);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.47512692, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.56672154, 9.80502469, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.52487308, 1.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.43327846, 1.19497531, 
  ...
  CoincidentCon(p.Ln46.End, 45.47512692, 10.00000000, 
                p.Cr50.Base, 45.47512692, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.56672154, 9.80502469, 
                p.Cr50.End, 44.56672154, 9.80502469);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 1.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.52487308, 1.00000000, 
                p.Cr52.Base, 24.52487308, 1.00000000);
  CoincidentCon(p.Ln49.End, 25.43327846, 1.19497531, 
                p.Cr52.End, 25.43327846, 1.19497531);
}
