...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body25_chamfer_cd0.67213941.js
//         On: 07/01/19, 17:19:34
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.42579613, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.25282666, 10.00000000);
  p.Ln49 = Line(34.77386496, 9.88693248, 25.51358356, 5.25679178);
  p.Cr50 = ArcCtrEdge(
              35.25282666, 8.92900910,
              35.25282666, 10.00000000,
              34.77386496, 9.88693248);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.42579613, 7.43236663,
              24.42579613, 5.00000000,
              25.51358356, 5.25679178);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.25282666, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.77386496, 9.88693248, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.42579613, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.51358356, 5.25679178, 
  ...
  CoincidentCon(p.Ln46.End, 35.25282666, 10.00000000, 
                p.Cr50.Base, 35.25282666, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.77386496, 9.88693248, 
                p.Cr50.End, 34.77386496, 9.88693248);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.42579613, 5.00000000, 
                p.Cr52.Base, 24.42579613, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.51358356, 5.25679178, 
                p.Cr52.End, 25.51358356, 5.25679178);
}
