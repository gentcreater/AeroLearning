...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body30_chamfer_cd0.54885021.js
//         On: 07/01/19, 18:35:31
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.77271447, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.03697790, 10.00000000);
  p.Ln49 = Line(29.96412617, 9.99103154, 10.22049935, 5.05512484);
  p.Cr50 = ArcCtrEdge(
              30.03697790, 9.69962465,
              30.03697790, 10.00000000,
              29.96412617, 9.99103154);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.77271447, 6.84626436,
              9.77271447, 5.00000000,
              10.22049935, 5.05512484);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.03697790, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.96412617, 9.99103154, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.77271447, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.22049935, 5.05512484, 
  ...
  CoincidentCon(p.Ln46.End, 30.03697790, 10.00000000, 
                p.Cr50.Base, 30.03697790, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.96412617, 9.99103154, 
                p.Cr50.End, 29.96412617, 9.99103154);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.77271447, 5.00000000, 
                p.Cr52.Base, 9.77271447, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.22049935, 5.05512484, 
                p.Cr52.End, 10.22049935, 5.05512484);
}
