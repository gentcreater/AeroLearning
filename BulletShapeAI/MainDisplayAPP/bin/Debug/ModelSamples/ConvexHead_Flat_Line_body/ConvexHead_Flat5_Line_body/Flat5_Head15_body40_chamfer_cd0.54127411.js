...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body40_chamfer_cd0.54127411.js
//         On: 07/01/19, 18:39:30
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.15755643, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.06914687, 10.00000000);
  p.Ln49 = Line(19.95110578, 9.95110578, 15.59569756, 5.59569756);
  p.Cr50 = ArcCtrEdge(
              20.06914687, 9.83306469,
              20.06914687, 10.00000000,
              19.95110578, 9.95110578);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.15755643, 7.03383869,
              14.15755643, 5.00000000,
              15.59569756, 5.59569756);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.06914687, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.95110578, 9.95110578, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.15755643, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.59569756, 5.59569756, 
  ...
  CoincidentCon(p.Ln46.End, 20.06914687, 10.00000000, 
                p.Cr50.Base, 20.06914687, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.95110578, 9.95110578, 
                p.Cr50.End, 19.95110578, 9.95110578);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.15755643, 5.00000000, 
                p.Cr52.Base, 14.15755643, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.59569756, 5.59569756, 
                p.Cr52.End, 15.59569756, 5.59569756);
}
