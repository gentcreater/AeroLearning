...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body10_chamfer_cd0.64858034.js
//         On: 07/01/19, 17:06:31
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.79309367, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.20690633, 10.00000000);
  p.Ln49 = Line(49.79590886, 9.96598481, 20.20409114, 5.03401519);
  p.Cr50 = ArcCtrEdge(
              50.20690633, 7.50000000,
              50.20690633, 10.00000000,
              49.79590886, 9.96598481);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.79309367, 7.50000000,
              19.79309367, 5.00000000,
              20.20409114, 5.03401519);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.20690633, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.79590886, 9.96598481, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.79309367, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.20409114, 5.03401519, 
  ...
  CoincidentCon(p.Ln46.End, 50.20690633, 10.00000000, 
                p.Cr50.Base, 50.20690633, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.79590886, 9.96598481, 
                p.Cr50.End, 49.79590886, 9.96598481);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.79309367, 5.00000000, 
                p.Cr52.Base, 19.79309367, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.20409114, 5.03401519, 
                p.Cr52.End, 20.20409114, 5.03401519);
}
