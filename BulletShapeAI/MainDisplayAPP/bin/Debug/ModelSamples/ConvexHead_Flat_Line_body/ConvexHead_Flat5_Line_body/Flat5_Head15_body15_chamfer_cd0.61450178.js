...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body15_chamfer_cd0.61450178.js
//         On: 07/01/19, 17:14:01
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.86624611, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.13375389, 10.00000000);
  p.Ln49 = Line(44.86806597, 9.97801100, 15.13193403, 5.02198900);
  p.Cr50 = ArcCtrEdge(
              45.13375389, 8.38388348,
              45.13375389, 10.00000000,
              44.86806597, 9.97801100);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.86624611, 6.61611652,
              14.86624611, 5.00000000,
              15.13193403, 5.02198900);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.13375389, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.86806597, 9.97801100, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.86624611, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.13193403, 5.02198900, 
  ...
  CoincidentCon(p.Ln46.End, 45.13375389, 10.00000000, 
                p.Cr50.Base, 45.13375389, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.86806597, 9.97801100, 
                p.Cr50.End, 44.86806597, 9.97801100);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.86624611, 5.00000000, 
                p.Cr52.Base, 14.86624611, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.13193403, 5.02198900, 
                p.Cr52.End, 15.13193403, 5.02198900);
}
