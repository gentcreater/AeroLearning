...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body35_chamfer_cd0.52491549.js
//         On: 07/01/19, 18:38:31
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.68286555, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.03523557, 10.00000000);
  p.Ln49 = Line(24.96657260, 9.98885753, 10.30086016, 5.10028672);
  p.Cr50 = ArcCtrEdge(
              25.03523557, 9.78286865,
              25.03523557, 10.00000000,
              24.96657260, 9.98885753);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.68286555, 6.95427054,
              9.68286555, 5.00000000,
              10.30086016, 5.10028672);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.03523557, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.96657260, 9.98885753, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.68286555, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.30086016, 5.10028672, 
  ...
  CoincidentCon(p.Ln46.End, 25.03523557, 10.00000000, 
                p.Cr50.Base, 25.03523557, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.96657260, 9.98885753, 
                p.Cr50.End, 24.96657260, 9.98885753);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.68286555, 5.00000000, 
                p.Cr52.Base, 9.68286555, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.30086016, 5.10028672, 
                p.Cr52.End, 10.30086016, 5.10028672);
}
