...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body20_chamfer_cd0.67751092.js
//         On: 07/01/19, 17:16:41
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.75237992, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.12833157, 10.00000000);
  p.Ln49 = Line(39.87825399, 9.95941800, 25.23491303, 5.07830434);
  p.Cr50 = ArcCtrEdge(
              40.12833157, 9.20918525,
              40.12833157, 10.00000000,
              39.87825399, 9.95941800);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.75237992, 6.52590368,
              24.75237992, 5.00000000,
              25.23491303, 5.07830434);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.12833157, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.87825399, 9.95941800, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.75237992, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.23491303, 5.07830434, 
  ...
  CoincidentCon(p.Ln46.End, 40.12833157, 10.00000000, 
                p.Cr50.Base, 40.12833157, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.87825399, 9.95941800, 
                p.Cr50.End, 39.87825399, 9.95941800);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.75237992, 5.00000000, 
                p.Cr52.Base, 24.75237992, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.23491303, 5.07830434, 
                p.Cr52.End, 25.23491303, 5.07830434);
}
