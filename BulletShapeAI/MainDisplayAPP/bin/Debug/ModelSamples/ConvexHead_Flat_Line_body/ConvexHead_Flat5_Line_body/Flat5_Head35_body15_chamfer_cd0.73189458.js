...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body15_chamfer_cd0.73189458.js
//         On: 07/01/19, 17:09:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 34.47742719, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.52257281, 10.00000000);
  p.Ln49 = Line(44.53259667, 9.76629834, 35.46740333, 5.23370166);
  p.Cr50 = ArcCtrEdge(
              45.52257281, 7.78634607,
              45.52257281, 10.00000000,
              44.53259667, 9.76629834);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.47742719, 7.21365393,
              34.47742719, 5.00000000,
              35.46740333, 5.23370166);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.52257281, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.53259667, 9.76629834, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.47742719, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.46740333, 5.23370166, 
  ...
  CoincidentCon(p.Ln46.End, 45.52257281, 10.00000000, 
                p.Cr50.Base, 45.52257281, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.53259667, 9.76629834, 
                p.Cr50.End, 44.53259667, 9.76629834);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.47742719, 5.00000000, 
                p.Cr52.Base, 34.47742719, 5.00000000);
  CoincidentCon(p.Ln49.End, 35.46740333, 5.23370166, 
                p.Cr52.End, 35.46740333, 5.23370166);
}
