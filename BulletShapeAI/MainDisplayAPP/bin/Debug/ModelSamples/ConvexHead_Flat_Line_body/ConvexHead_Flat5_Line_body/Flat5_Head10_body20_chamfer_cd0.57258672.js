...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body20_chamfer_cd0.57258672.js
//         On: 07/01/19, 17:18:10
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.87371235, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.06544983, 10.00000000);
  p.Ln49 = Line(39.93544069, 9.98924011, 10.12456937, 5.02076156);
  p.Cr50 = ArcCtrEdge(
              40.06544983, 9.20918525,
              40.06544983, 10.00000000,
              39.93544069, 9.98924011);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.87371235, 6.52590368,
              9.87371235, 5.00000000,
              10.12456937, 5.02076156);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.06544983, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.93544069, 9.98924011, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.87371235, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.12456937, 5.02076156, 
  ...
  CoincidentCon(p.Ln46.End, 40.06544983, 10.00000000, 
                p.Cr50.Base, 40.06544983, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.93544069, 9.98924011, 
                p.Cr50.End, 39.93544069, 9.98924011);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.87371235, 5.00000000, 
                p.Cr52.Base, 9.87371235, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.12456937, 5.02076156, 
                p.Cr52.End, 10.12456937, 5.02076156);
}
