...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body50_chamfer_cd0.53385576.js
//         On: 07/01/19, 18:42:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.11318748, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 10.04606003, 10.00000000);
  p.Ln49 = Line(9.96743064, 9.96743064, 5.62707115, 5.62707115);
  p.Cr50 = ArcCtrEdge(
              10.04606003, 9.88880124,
              10.04606003, 10.00000000,
              9.96743064, 9.96743064);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.11318748, 7.14095481,
              4.11318748, 5.00000000,
              5.62707115, 5.62707115);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 10.04606003, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 9.96743064, 9.96743064, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.11318748, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.62707115, 5.62707115, 
  ...
  CoincidentCon(p.Ln46.End, 10.04606003, 10.00000000, 
                p.Cr50.Base, 10.04606003, 10.00000000);
  CoincidentCon(p.Ln49.Base, 9.96743064, 9.96743064, 
                p.Cr50.End, 9.96743064, 9.96743064);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.11318748, 5.00000000, 
                p.Cr52.Base, 4.11318748, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.62707115, 5.62707115, 
                p.Cr52.End, 5.62707115, 5.62707115);
}
