...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body40_chamfer_cd0.49987584.js
//         On: 07/01/19, 18:40:20
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(10.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.51987581, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.03940808, 10.00000000);
  p.Ln49 = Line(19.96475234, 9.98237617, 10.42943613, 5.21471806);
  p.Cr50 = ArcCtrEdge(
              20.03940808, 9.83306469,
              20.03940808, 10.00000000,
              19.96475234, 9.98237617);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.51987581, 7.03383869,
              9.51987581, 5.00000000,
              10.42943613, 5.21471806);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 10.00000000, 5.00000000, 
    6.50238402, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.03940808, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.96475234, 9.98237617, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.51987581, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.42943613, 5.21471806, 
  ...
  CoincidentCon(p.Ln46.End, 20.03940808, 10.00000000, 
                p.Cr50.Base, 20.03940808, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.96475234, 9.98237617, 
                p.Cr50.End, 19.96475234, 9.98237617);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.51987581, 5.00000000, 
                p.Cr52.Base, 9.51987581, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.42943613, 5.21471806, 
                p.Cr52.End, 10.42943613, 5.21471806);
}
