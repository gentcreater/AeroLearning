...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body10_chamfer_cd0.61689822.js
//         On: 07/01/19, 17:07:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.82233047, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.17766953, 10.00000000);
  p.Ln49 = Line(49.82411614, 9.97487373, 15.17588386, 5.02512627);
  p.Cr50 = ArcCtrEdge(
              50.17766953, 7.50000000,
              50.17766953, 10.00000000,
              49.82411614, 9.97487373);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.82233047, 7.50000000,
              14.82233047, 5.00000000,
              15.17588386, 5.02512627);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.17766953, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.82411614, 9.97487373, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.82233047, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.17588386, 5.02512627, 
  ...
  CoincidentCon(p.Ln46.End, 50.17766953, 10.00000000, 
                p.Cr50.Base, 50.17766953, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.82411614, 9.97487373, 
                p.Cr50.End, 49.82411614, 9.97487373);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.82233047, 5.00000000, 
                p.Cr52.Base, 14.82233047, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.17588386, 5.02512627, 
                p.Cr52.End, 15.17588386, 5.02512627);
}
