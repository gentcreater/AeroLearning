...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body45_chamfer_cd0.49003978.js
//         On: 07/01/19, 18:41:14
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(15.00000000, 10.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.13260751, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.05553391, 10.00000000);
  p.Ln49 = Line(14.96073160, 9.96073160, 10.61333911, 5.61333911);
  p.Cr50 = ArcCtrEdge(
              15.05553391, 9.86592929,
              15.05553391, 10.00000000,
              14.96073160, 9.96073160);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.13260751, 7.09407071,
              9.13260751, 5.00000000,
              10.61333911, 5.61333911);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 15.00000000, 10.00000000, 
    45.58020847, 11.09884475);
  if(dim) dim.Name = "H21";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.05553391, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.96073160, 9.96073160, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.13260751, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.61333911, 5.61333911, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 15.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 15.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 15.05553391, 10.00000000, 
                p.Cr50.Base, 15.05553391, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.96073160, 9.96073160, 
                p.Cr50.End, 14.96073160, 9.96073160);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.13260751, 5.00000000, 
                p.Cr52.Base, 9.13260751, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.61333911, 5.61333911, 
                p.Cr52.End, 10.61333911, 5.61333911);
}
