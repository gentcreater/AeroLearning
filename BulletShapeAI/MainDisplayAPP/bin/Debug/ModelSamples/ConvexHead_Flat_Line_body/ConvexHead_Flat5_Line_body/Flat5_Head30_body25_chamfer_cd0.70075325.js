...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body25_chamfer_cd0.70075325.js
//         On: 07/01/19, 17:19:08
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 28.99248075, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.44361896, 10.00000000);
  p.Ln49 = Line(34.68631403, 9.68631403, 30.71242369, 5.71242369);
  p.Cr50 = ArcCtrEdge(
              35.44361896, 8.92900910,
              35.44361896, 10.00000000,
              34.68631403, 9.68631403);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              28.99248075, 7.43236663,
              28.99248075, 5.00000000,
              30.71242369, 5.71242369);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.44361896, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.68631403, 9.68631403, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 28.99248075, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.71242369, 5.71242369, 
  ...
  CoincidentCon(p.Ln46.End, 35.44361896, 10.00000000, 
                p.Cr50.Base, 35.44361896, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.68631403, 9.68631403, 
                p.Cr50.End, 34.68631403, 9.68631403);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 28.99248075, 5.00000000, 
                p.Cr52.Base, 28.99248075, 5.00000000);
  CoincidentCon(p.Ln49.End, 30.71242369, 5.71242369, 
                p.Cr52.End, 30.71242369, 5.71242369);
}
