...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body10_chamfer_cd0.58926982.js
//         On: 07/01/19, 17:07:39
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.84435563, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.15564437, 10.00000000);
  p.Ln49 = Line(49.84555753, 9.98069469, 10.15444247, 5.01930531);
  p.Cr50 = ArcCtrEdge(
              50.15564437, 7.50000000,
              50.15564437, 10.00000000,
              49.84555753, 9.98069469);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.84435563, 7.50000000,
              9.84435563, 5.00000000,
              10.15444247, 5.01930531);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.15564437, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.84555753, 9.98069469, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.84435563, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.15444247, 5.01930531, 
  ...
  CoincidentCon(p.Ln46.End, 50.15564437, 10.00000000, 
                p.Cr50.Base, 50.15564437, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.84555753, 9.98069469, 
                p.Cr50.End, 49.84555753, 9.98069469);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.84435563, 5.00000000, 
                p.Cr52.Base, 9.84435563, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.15444247, 5.01930531, 
                p.Cr52.End, 10.15444247, 5.01930531);
}
