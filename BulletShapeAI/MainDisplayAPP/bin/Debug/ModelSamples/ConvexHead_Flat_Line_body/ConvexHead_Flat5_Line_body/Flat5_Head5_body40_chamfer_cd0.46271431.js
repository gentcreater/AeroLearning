...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body40_chamfer_cd0.46271431.js
//         On: 07/01/19, 18:40:45
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.66995342, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.02708987, 10.00000000);
  p.Ln49 = Line(19.97430029, 9.99143343, 5.31310968, 5.10436989);
  p.Cr50 = ArcCtrEdge(
              20.02708987, 9.83306469,
              20.02708987, 10.00000000,
              19.97430029, 9.99143343);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.66995342, 7.03383869,
              4.66995342, 5.00000000,
              5.31310968, 5.10436989);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.02708987, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.97430029, 9.99143343, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.66995342, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.31310968, 5.10436989, 
  ...
  CoincidentCon(p.Ln46.End, 20.02708987, 10.00000000, 
                p.Cr50.Base, 20.02708987, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.97430029, 9.99143343, 
                p.Cr50.End, 19.97430029, 9.99143343);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.66995342, 5.00000000, 
                p.Cr52.Base, 4.66995342, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.31310968, 5.10436989, 
                p.Cr52.End, 5.31310968, 5.10436989);
}
