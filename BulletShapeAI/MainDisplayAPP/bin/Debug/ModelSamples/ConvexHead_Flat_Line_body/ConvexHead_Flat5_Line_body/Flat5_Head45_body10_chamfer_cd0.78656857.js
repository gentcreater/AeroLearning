...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head45_body10_chamfer_cd0.78656857.js
//         On: 07/01/19, 17:03:51
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(45.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 43.96446609, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 51.03553391, 10.00000000);
  p.Ln49 = Line(49.26776695, 9.26776695, 45.73223305, 5.73223305);
  p.Cr50 = ArcCtrEdge(
              51.03553391, 7.50000000,
              51.03553391, 10.00000000,
              49.26776695, 9.26776695);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              43.96446609, 7.50000000,
              43.96446609, 5.00000000,
              45.73223305, 5.73223305);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 45.00000000, 5.00000000, 
    29.26072809, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 51.03553391, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.26776695, 9.26776695, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 43.96446609, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 45.73223305, 5.73223305, 
  ...
  CoincidentCon(p.Ln46.End, 51.03553391, 10.00000000, 
                p.Cr50.Base, 51.03553391, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.26776695, 9.26776695, 
                p.Cr50.End, 49.26776695, 9.26776695);
  CoincidentCon(p.Pt114, 45.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 45.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 43.96446609, 5.00000000, 
                p.Cr52.Base, 43.96446609, 5.00000000);
  CoincidentCon(p.Ln49.End, 45.73223305, 5.73223305, 
                p.Cr52.End, 45.73223305, 5.73223305);
}
