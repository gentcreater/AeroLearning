...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body10_chamfer_cd0.72423334.js
//         On: 07/01/19, 17:04:59
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(35.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 34.59430585, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.40569415, 10.00000000);
  p.Ln49 = Line(49.61512474, 9.87170825, 35.38487526, 5.12829175);
  p.Cr50 = ArcCtrEdge(
              50.40569415, 7.50000000,
              50.40569415, 10.00000000,
              49.61512474, 9.87170825);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.59430585, 7.50000000,
              34.59430585, 5.00000000,
              35.38487526, 5.12829175);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 35.00000000, 5.00000000, 
    22.75834407, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.40569415, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.61512474, 9.87170825, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.59430585, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.38487526, 5.12829175, 
  ...
  CoincidentCon(p.Ln46.End, 50.40569415, 10.00000000, 
                p.Cr50.Base, 50.40569415, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.61512474, 9.87170825, 
                p.Cr50.End, 49.61512474, 9.87170825);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.59430585, 5.00000000, 
                p.Cr52.Base, 34.59430585, 5.00000000);
  CoincidentCon(p.Ln49.End, 35.38487526, 5.12829175, 
                p.Cr52.End, 35.38487526, 5.12829175);
}
