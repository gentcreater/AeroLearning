...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body35_chamfer_cd0.59146075.js
//         On: 07/01/19, 18:36:32
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(25.00000000, 10.00000000);
  p.Pt114 = ConstructionPoint(20.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.19051464, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.08993875, 10.00000000);
  p.Ln49 = Line(24.93640370, 9.93640370, 20.57239259, 5.57239259);
  p.Cr50 = ArcCtrEdge(
              25.08993875, 9.78286865,
              25.08993875, 10.00000000,
              24.93640370, 9.93640370);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.19051464, 6.95427054,
              19.19051464, 5.00000000,
              20.57239259, 5.57239259);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 25.00000000, 10.00000000, 
    48.78460659, 11.09884475);
  if(dim) dim.Name = "H21";
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 20.00000000, 5.00000000, 
    13.00476804, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.08993875, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.93640370, 9.93640370, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.19051464, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.57239259, 5.57239259, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 25.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 25.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 25.08993875, 10.00000000, 
                p.Cr50.Base, 25.08993875, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.93640370, 9.93640370, 
                p.Cr50.End, 24.93640370, 9.93640370);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.19051464, 5.00000000, 
                p.Cr52.Base, 19.19051464, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.57239259, 5.57239259, 
                p.Cr52.End, 20.57239259, 5.57239259);
}
