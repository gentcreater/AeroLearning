...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body5_chamfer_cd0.72914437.js
//         On: 07/01/19, 16:59:49
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 34.69223594, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.30776406, 10.00000000);
  p.Ln49 = Line(54.70142500, 9.92535625, 35.29857500, 5.07464375);
  p.Cr50 = ArcCtrEdge(
              55.30776406, 7.50000000,
              55.30776406, 10.00000000,
              54.70142500, 9.92535625);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.69223594, 7.50000000,
              34.69223594, 5.00000000,
              35.29857500, 5.07464375);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.30776406, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.70142500, 9.92535625, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.69223594, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.29857500, 5.07464375, 
  ...
  CoincidentCon(p.Ln46.End, 55.30776406, 10.00000000, 
                p.Cr50.Base, 55.30776406, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.70142500, 9.92535625, 
                p.Cr50.End, 54.70142500, 9.92535625);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.69223594, 5.00000000, 
                p.Cr52.Base, 34.69223594, 5.00000000);
  CoincidentCon(p.Ln49.End, 35.29857500, 5.07464375, 
                p.Cr52.End, 35.29857500, 5.07464375);
}
