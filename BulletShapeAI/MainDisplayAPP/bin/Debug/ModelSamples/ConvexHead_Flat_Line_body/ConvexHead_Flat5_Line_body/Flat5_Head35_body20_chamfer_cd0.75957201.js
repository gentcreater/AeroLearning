...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat5_Line_body\Flat5_Head35_body20_chamfer_cd0.75957201.js
//         On: 07/02/19, 22:54:27
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 34.36795000, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.32756619, 10.00000000);
  p.Ln49 = Line(39.76837572, 9.76837572, 35.44692684, 5.44692684);
  p.Cr50 = ArcCtrEdge(
              40.32756619, 9.20918525,
              40.32756619, 10.00000000,
              39.76837572, 9.76837572);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.36795000, 6.52590368,
              34.36795000, 5.00000000,
              35.44692684, 5.44692684);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.32756619, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.76837572, 9.76837572, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.36795000, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.44692684, 5.44692684, 
  ...
  CoincidentCon(p.Ln46.End, 40.32756619, 10.00000000, 
                p.Cr50.Base, 40.32756619, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.76837572, 9.76837572, 
                p.Cr50.End, 39.76837572, 9.76837572);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.36795000, 5.00000000, 
                p.Cr52.Base, 34.36795000, 5.00000000);
  CoincidentCon(p.Ln49.End, 35.44692684, 5.44692684, 
                p.Cr52.End, 35.44692684, 5.44692684);
}
