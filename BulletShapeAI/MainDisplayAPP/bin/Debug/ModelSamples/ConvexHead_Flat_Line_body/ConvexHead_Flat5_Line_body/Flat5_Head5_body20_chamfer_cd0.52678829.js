...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body20_chamfer_cd0.52678829.js
//         On: 07/01/19, 17:18:35
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.89155736, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.05620147, 10.00000000);
  p.Ln49 = Line(39.94436338, 9.99205191, 5.10735273, 5.01533610);
  p.Cr50 = ArcCtrEdge(
              40.05620147, 9.20918525,
              40.05620147, 10.00000000,
              39.94436338, 9.99205191);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.89155736, 6.52590368,
              4.89155736, 5.00000000,
              5.10735273, 5.01533610);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.05620147, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.94436338, 9.99205191, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.89155736, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.10735273, 5.01533610, 
  ...
  CoincidentCon(p.Ln46.End, 40.05620147, 10.00000000, 
                p.Cr50.Base, 40.05620147, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.94436338, 9.99205191, 
                p.Cr50.End, 39.94436338, 9.99205191);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.89155736, 5.00000000, 
                p.Cr52.Base, 4.89155736, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.10735273, 5.01533610, 
                p.Cr52.End, 5.10735273, 5.01533610);
}
