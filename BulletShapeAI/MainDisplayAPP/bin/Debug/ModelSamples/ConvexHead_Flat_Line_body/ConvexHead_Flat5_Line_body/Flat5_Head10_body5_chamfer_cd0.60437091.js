...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body5_chamfer_cd0.60437091.js
//         On: 07/01/19, 17:02:35
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.86153715, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.13846285, 10.00000000);
  p.Ln49 = Line(54.86238403, 9.98470934, 10.13761597, 5.01529066);
  p.Cr50 = ArcCtrEdge(
              55.13846285, 7.50000000,
              55.13846285, 10.00000000,
              54.86238403, 9.98470934);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.86153715, 7.50000000,
              9.86153715, 5.00000000,
              10.13761597, 5.01529066);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.13846285, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.86238403, 9.98470934, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.86153715, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.13761597, 5.01529066, 
  ...
  CoincidentCon(p.Ln46.End, 55.13846285, 10.00000000, 
                p.Cr50.Base, 55.13846285, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.86238403, 9.98470934, 
                p.Cr50.End, 54.86238403, 9.98470934);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.86153715, 5.00000000, 
                p.Cr52.Base, 9.86153715, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.13761597, 5.01529066, 
                p.Cr52.End, 10.13761597, 5.01529066);
}
