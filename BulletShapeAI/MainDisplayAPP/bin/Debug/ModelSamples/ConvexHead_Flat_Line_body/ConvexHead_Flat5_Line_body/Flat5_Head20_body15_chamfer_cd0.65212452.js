...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body15_chamfer_cd0.65212452.js
//         On: 07/01/19, 17:13:19
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.83997293, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.16002707, 10.00000000);
  p.Ln49 = Line(44.84308055, 9.96861611, 20.15691945, 5.03138389);
  p.Cr50 = ArcCtrEdge(
              45.16002707, 8.38388348,
              45.16002707, 10.00000000,
              44.84308055, 9.96861611);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.83997293, 6.61611652,
              19.83997293, 5.00000000,
              20.15691945, 5.03138389);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.16002707, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.84308055, 9.96861611, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.83997293, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.15691945, 5.03138389, 
  ...
  CoincidentCon(p.Ln46.End, 45.16002707, 10.00000000, 
                p.Cr50.Base, 45.16002707, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.84308055, 9.96861611, 
                p.Cr50.End, 44.84308055, 9.96861611);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.83997293, 5.00000000, 
                p.Cr52.Base, 19.83997293, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.15691945, 5.03138389, 
                p.Cr52.End, 20.15691945, 5.03138389);
}
