...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body5_chamfer_cd0.63190459.js
//         On: 07/01/19, 17:01:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.84435563, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.15564437, 10.00000000);
  p.Ln49 = Line(54.84555753, 9.98069469, 15.15444247, 5.01930531);
  p.Cr50 = ArcCtrEdge(
              55.15564437, 7.50000000,
              55.15564437, 10.00000000,
              54.84555753, 9.98069469);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.84435563, 7.50000000,
              14.84435563, 5.00000000,
              15.15444247, 5.01930531);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.15564437, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.84555753, 9.98069469, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.84435563, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.15444247, 5.01930531, 
  ...
  CoincidentCon(p.Ln46.End, 55.15564437, 10.00000000, 
                p.Cr50.Base, 55.15564437, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.84555753, 9.98069469, 
                p.Cr50.End, 54.84555753, 9.98069469);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.84435563, 5.00000000, 
                p.Cr52.Base, 14.84435563, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.15444247, 5.01930531, 
                p.Cr52.End, 15.15444247, 5.01930531);
}
