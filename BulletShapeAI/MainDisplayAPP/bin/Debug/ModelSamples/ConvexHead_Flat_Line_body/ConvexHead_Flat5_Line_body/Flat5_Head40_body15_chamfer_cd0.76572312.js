...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body15_chamfer_cd0.76572312.js
//         On: 07/01/19, 17:08:56
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 39.08307452, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.91692548, 10.00000000);
  p.Ln49 = Line(44.35163577, 9.35163577, 40.64836423, 5.64836423);
  p.Cr50 = ArcCtrEdge(
              45.91692548, 7.78634607,
              45.91692548, 10.00000000,
              44.35163577, 9.35163577);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.08307452, 7.21365393,
              39.08307452, 5.00000000,
              40.64836423, 5.64836423);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.91692548, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.35163577, 9.35163577, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.08307452, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.64836423, 5.64836423, 
  ...
  CoincidentCon(p.Ln46.End, 45.91692548, 10.00000000, 
                p.Cr50.Base, 45.91692548, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.35163577, 9.35163577, 
                p.Cr50.End, 44.35163577, 9.35163577);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.08307452, 5.00000000, 
                p.Cr52.Base, 39.08307452, 5.00000000);
  CoincidentCon(p.Ln49.End, 40.64836423, 5.64836423, 
                p.Cr52.End, 40.64836423, 5.64836423);
}
