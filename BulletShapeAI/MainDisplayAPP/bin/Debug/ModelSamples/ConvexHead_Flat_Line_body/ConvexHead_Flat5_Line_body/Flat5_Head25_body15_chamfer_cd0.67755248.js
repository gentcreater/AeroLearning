...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body15_chamfer_cd0.67755248.js
//         On: 07/01/19, 17:10:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.80104696, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.19895304, 10.00000000);
  p.Ln49 = Line(44.80698720, 9.95174680, 25.19301280, 5.04825320);
  p.Cr50 = ArcCtrEdge(
              45.19895304, 8.38388348,
              45.19895304, 10.00000000,
              44.80698720, 9.95174680);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.80104696, 6.61611652,
              24.80104696, 5.00000000,
              25.19301280, 5.04825320);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.19895304, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.80698720, 9.95174680, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.80104696, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.19301280, 5.04825320, 
  ...
  CoincidentCon(p.Ln46.End, 45.19895304, 10.00000000, 
                p.Cr50.Base, 45.19895304, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.80698720, 9.95174680, 
                p.Cr50.End, 44.80698720, 9.95174680);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.80104696, 5.00000000, 
                p.Cr52.Base, 24.80104696, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.19301280, 5.04825320, 
                p.Cr52.End, 25.19301280, 5.04825320);
}
