...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body20_chamfer_cd0.64066308.js
//         On: 07/01/19, 17:17:15
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.81215267, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.09735374, 10.00000000);
  p.Ln49 = Line(39.90555300, 9.97638825, 20.18223868, 5.04555967);
  p.Cr50 = ArcCtrEdge(
              40.09735374, 9.20918525,
              40.09735374, 10.00000000,
              39.90555300, 9.97638825);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.81215267, 6.52590368,
              19.81215267, 5.00000000,
              20.18223868, 5.04555967);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.09735374, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.90555300, 9.97638825, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.81215267, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.18223868, 5.04555967, 
  ...
  CoincidentCon(p.Ln46.End, 40.09735374, 10.00000000, 
                p.Cr50.Base, 40.09735374, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.90555300, 9.97638825, 
                p.Cr50.End, 39.90555300, 9.97638825);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.81215267, 5.00000000, 
                p.Cr52.Base, 19.81215267, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.18223868, 5.04555967, 
                p.Cr52.End, 20.18223868, 5.04555967);
}
