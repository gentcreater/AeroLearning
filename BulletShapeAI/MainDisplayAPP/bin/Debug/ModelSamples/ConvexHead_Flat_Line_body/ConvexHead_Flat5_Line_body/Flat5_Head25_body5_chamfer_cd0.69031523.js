...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body5_chamfer_cd0.69031523.js
//         On: 07/01/19, 17:00:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.79309367, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.20690633, 10.00000000);
  p.Ln49 = Line(54.79590886, 9.96598481, 25.20409114, 5.03401519);
  p.Cr50 = ArcCtrEdge(
              55.20690633, 7.50000000,
              55.20690633, 10.00000000,
              54.79590886, 9.96598481);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.79309367, 7.50000000,
              24.79309367, 5.00000000,
              25.20409114, 5.03401519);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.20690633, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.79590886, 9.96598481, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.79309367, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.20409114, 5.03401519, 
  ...
  CoincidentCon(p.Ln46.End, 55.20690633, 10.00000000, 
                p.Cr50.Base, 55.20690633, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.79590886, 9.96598481, 
                p.Cr50.End, 54.79590886, 9.96598481);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.79309367, 5.00000000, 
                p.Cr52.Base, 24.79309367, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.20409114, 5.03401519, 
                p.Cr52.End, 25.20409114, 5.03401519);
}
