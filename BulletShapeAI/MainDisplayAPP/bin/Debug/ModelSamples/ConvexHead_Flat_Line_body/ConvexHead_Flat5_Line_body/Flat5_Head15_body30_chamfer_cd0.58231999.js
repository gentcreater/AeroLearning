...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body30_chamfer_cd0.58231999.js
//         On: 07/01/19, 18:35:05
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.70039254, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.04874421, 10.00000000);
  p.Ln49 = Line(29.95375718, 9.98458573, 15.28423259, 5.09474420);
  p.Cr50 = ArcCtrEdge(
              30.04874421, 9.69962465,
              30.04874421, 10.00000000,
              29.95375718, 9.98458573);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.70039254, 6.84626436,
              14.70039254, 5.00000000,
              15.28423259, 5.09474420);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.04874421, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.95375718, 9.98458573, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.70039254, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.28423259, 5.09474420, 
  ...
  CoincidentCon(p.Ln46.End, 30.04874421, 10.00000000, 
                p.Cr50.Base, 30.04874421, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.95375718, 9.98458573, 
                p.Cr50.End, 29.95375718, 9.98458573);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.70039254, 5.00000000, 
                p.Cr52.Base, 14.70039254, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.28423259, 5.09474420, 
                p.Cr52.End, 15.28423259, 5.09474420);
}
