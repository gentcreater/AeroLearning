...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body20_chamfer_cd0.60217433.js
//         On: 07/01/19, 17:17:44
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.84890576, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.07830609, 10.00000000);
  p.Ln49 = Line(39.92321456, 9.98464291, 15.14816009, 5.02963202);
  p.Cr50 = ArcCtrEdge(
              40.07830609, 9.20918525,
              40.07830609, 10.00000000,
              39.92321456, 9.98464291);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.84890576, 6.52590368,
              14.84890576, 5.00000000,
              15.14816009, 5.02963202);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.07830609, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.92321456, 9.98464291, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.84890576, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.14816009, 5.02963202, 
  ...
  CoincidentCon(p.Ln46.End, 40.07830609, 10.00000000, 
                p.Cr50.Base, 40.07830609, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.92321456, 9.98464291, 
                p.Cr50.End, 39.92321456, 9.98464291);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.84890576, 5.00000000, 
                p.Cr52.Base, 14.84890576, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.14816009, 5.02963202, 
                p.Cr52.End, 15.14816009, 5.02963202);
}
