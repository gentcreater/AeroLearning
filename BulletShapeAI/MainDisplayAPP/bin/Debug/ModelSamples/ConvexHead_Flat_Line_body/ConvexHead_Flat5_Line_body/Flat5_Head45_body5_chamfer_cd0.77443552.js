...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head45_body5_chamfer_cd0.77443552.js
//         On: 07/01/19, 16:57:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 44.40983006, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.59016994, 10.00000000);
  p.Ln49 = Line(54.47213595, 9.73606798, 45.52786405, 5.26393202);
  p.Cr50 = ArcCtrEdge(
              55.59016994, 7.50000000,
              55.59016994, 10.00000000,
              54.47213595, 9.73606798);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              44.40983006, 7.50000000,
              44.40983006, 5.00000000,
              45.52786405, 5.26393202);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.59016994, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.47213595, 9.73606798, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 44.40983006, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 45.52786405, 5.26393202, 
  ...
  CoincidentCon(p.Ln46.End, 55.59016994, 10.00000000, 
                p.Cr50.Base, 55.59016994, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.47213595, 9.73606798, 
                p.Cr50.End, 54.47213595, 9.73606798);
  CoincidentCon(p.Pt114, 45.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 45.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.40983006, 5.00000000, 
                p.Cr52.Base, 44.40983006, 5.00000000);
  CoincidentCon(p.Ln49.End, 45.52786405, 5.26393202, 
                p.Cr52.End, 45.52786405, 5.26393202);
}
