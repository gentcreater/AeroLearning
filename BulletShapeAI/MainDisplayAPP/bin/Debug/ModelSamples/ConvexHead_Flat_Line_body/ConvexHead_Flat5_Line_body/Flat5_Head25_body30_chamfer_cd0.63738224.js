...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body30_chamfer_cd0.63738224.js
//         On: 07/01/19, 17:22:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 23.86132034, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.31627421, 10.00000000);
  p.Ln49 = Line(29.77636036, 9.77636036, 25.80516811, 5.80516811);
  p.Cr50 = ArcCtrEdge(
              30.31627421, 9.23644652,
              30.31627421, 10.00000000,
              29.77636036, 9.77636036);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              23.86132034, 7.74901587,
              23.86132034, 5.00000000,
              25.80516811, 5.80516811);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.31627421, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.77636036, 9.77636036, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 23.86132034, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.80516811, 5.80516811, 
  ...
  CoincidentCon(p.Ln46.End, 30.31627421, 10.00000000, 
                p.Cr50.Base, 30.31627421, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.77636036, 9.77636036, 
                p.Cr50.End, 29.77636036, 9.77636036);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 23.86132034, 5.00000000, 
                p.Cr52.Base, 23.86132034, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.80516811, 5.80516811, 
                p.Cr52.End, 25.80516811, 5.80516811);
}
