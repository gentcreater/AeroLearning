...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body10_chamfer_cd0.67648019.js
//         On: 07/01/19, 17:06:04
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(25.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.75245122, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.24754878, 10.00000000);
  p.Ln49 = Line(49.75725845, 9.95145169, 25.24274155, 5.04854831);
  p.Cr50 = ArcCtrEdge(
              50.24754878, 7.50000000,
              50.24754878, 10.00000000,
              49.75725845, 9.95145169);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.75245122, 7.50000000,
              24.75245122, 5.00000000,
              25.24274155, 5.04854831);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 25.00000000, 5.00000000, 
    16.25596005, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.24754878, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.75725845, 9.95145169, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.75245122, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.24274155, 5.04854831, 
  ...
  CoincidentCon(p.Ln46.End, 50.24754878, 10.00000000, 
                p.Cr50.Base, 50.24754878, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.75725845, 9.95145169, 
                p.Cr50.End, 49.75725845, 9.95145169);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.75245122, 5.00000000, 
                p.Cr52.Base, 24.75245122, 5.00000000);
  CoincidentCon(p.Ln49.End, 25.24274155, 5.04854831, 
                p.Cr52.End, 25.24274155, 5.04854831);
}
