...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body50_chamfer_cd0.82945373.js
//         On: 07/01/19, 16:37:35
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(50.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 48.96446609, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 56.03553391, 10.00000000);
  p.Ln49 = Line(54.26776695, 9.26776695, 50.73223305, 5.73223305);
  p.Cr50 = ArcCtrEdge(
              56.03553391, 7.50000000,
              56.03553391, 10.00000000,
              54.26776695, 9.26776695);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              48.96446609, 7.50000000,
              48.96446609, 5.00000000,
              50.73223305, 5.73223305);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 50.00000000, 5.00000000, 
    32.51192010, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 56.03553391, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.26776695, 9.26776695, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 48.96446609, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 50.73223305, 5.73223305, 
  ...
  CoincidentCon(p.Ln46.End, 56.03553391, 10.00000000, 
                p.Cr50.Base, 56.03553391, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.26776695, 9.26776695, 
                p.Cr50.End, 54.26776695, 9.26776695);
  CoincidentCon(p.Pt114, 50.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 50.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 48.96446609, 5.00000000, 
                p.Cr52.Base, 48.96446609, 5.00000000);
  CoincidentCon(p.Ln49.End, 50.73223305, 5.73223305, 
                p.Cr52.End, 50.73223305, 5.73223305);
}
