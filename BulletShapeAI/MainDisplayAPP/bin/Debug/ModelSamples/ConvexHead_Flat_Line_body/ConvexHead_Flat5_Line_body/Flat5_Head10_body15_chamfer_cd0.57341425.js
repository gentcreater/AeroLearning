...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body15_chamfer_cd0.57341425.js
//         On: 07/01/19, 17:14:36
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.88514613, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.11485387, 10.00000000);
  p.Ln49 = Line(44.88630047, 9.98375721, 10.11369953, 5.01624279);
  p.Cr50 = ArcCtrEdge(
              45.11485387, 8.38388348,
              45.11485387, 10.00000000,
              44.88630047, 9.98375721);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.88514613, 6.61611652,
              9.88514613, 5.00000000,
              10.11369953, 5.01624279);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.11485387, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.88630047, 9.98375721, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.88514613, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.11369953, 5.01624279, 
  ...
  CoincidentCon(p.Ln46.End, 45.11485387, 10.00000000, 
                p.Cr50.Base, 45.11485387, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.88630047, 9.98375721, 
                p.Cr50.End, 44.88630047, 9.98375721);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.88514613, 5.00000000, 
                p.Cr52.Base, 9.88514613, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.11369953, 5.01624279, 
                p.Cr52.End, 10.11369953, 5.01624279);
}
