...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body25_chamfer_cd0.5504193.js
//         On: 07/01/19, 17:21:43
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.83177973, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.04506282, 10.00000000);
  p.Ln49 = Line(34.95581226, 9.99116245, 10.16495354, 5.03299071);
  p.Cr50 = ArcCtrEdge(
              35.04506282, 9.54490965,
              35.04506282, 10.00000000,
              34.95581226, 9.99116245);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.83177973, 6.69885976,
              9.83177973, 5.00000000,
              10.16495354, 5.03299071);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.04506282, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.95581226, 9.99116245, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.83177973, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.16495354, 5.03299071, 
  ...
  CoincidentCon(p.Ln46.End, 35.04506282, 10.00000000, 
                p.Cr50.Base, 35.04506282, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.95581226, 9.99116245, 
                p.Cr50.End, 34.95581226, 9.99116245);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.83177973, 5.00000000, 
                p.Cr52.Base, 9.83177973, 5.00000000);
  CoincidentCon(p.Ln49.End, 10.16495354, 5.03299071, 
                p.Cr52.End, 10.16495354, 5.03299071);
}
