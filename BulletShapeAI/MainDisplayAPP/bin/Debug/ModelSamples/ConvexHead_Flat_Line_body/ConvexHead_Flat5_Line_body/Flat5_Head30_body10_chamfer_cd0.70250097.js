...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body10_chamfer_cd0.70250097.js
//         On: 07/01/19, 17:05:29
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(30.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 29.69223594, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.30776406, 10.00000000);
  p.Ln49 = Line(49.70142500, 9.92535625, 30.29857500, 5.07464375);
  p.Cr50 = ArcCtrEdge(
              50.30776406, 7.50000000,
              50.30776406, 10.00000000,
              49.70142500, 9.92535625);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.69223594, 7.50000000,
              29.69223594, 5.00000000,
              30.29857500, 5.07464375);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 30.00000000, 5.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.30776406, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.70142500, 9.92535625, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.69223594, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.29857500, 5.07464375, 
  ...
  CoincidentCon(p.Ln46.End, 50.30776406, 10.00000000, 
                p.Cr50.Base, 50.30776406, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.70142500, 9.92535625, 
                p.Cr50.End, 49.70142500, 9.92535625);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.69223594, 5.00000000, 
                p.Cr52.Base, 29.69223594, 5.00000000);
  CoincidentCon(p.Ln49.End, 30.29857500, 5.07464375, 
                p.Cr52.End, 30.29857500, 5.07464375);
}
