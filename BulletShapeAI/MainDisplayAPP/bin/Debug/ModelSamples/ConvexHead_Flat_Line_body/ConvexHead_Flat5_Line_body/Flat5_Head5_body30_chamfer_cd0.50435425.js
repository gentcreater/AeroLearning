...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body30_chamfer_cd0.50435425.js
//         On: 07/01/19, 18:35:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.81718380, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.02974302, 10.00000000);
  p.Ln49 = Line(29.97083457, 9.99416691, 5.17926603, 5.03585321);
  p.Cr50 = ArcCtrEdge(
              30.02974302, 9.69962465,
              30.02974302, 10.00000000,
              29.97083457, 9.99416691);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.81718380, 6.84626436,
              4.81718380, 5.00000000,
              5.17926603, 5.03585321);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.02974302, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.97083457, 9.99416691, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.81718380, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.17926603, 5.03585321, 
  ...
  CoincidentCon(p.Ln46.End, 30.02974302, 10.00000000, 
                p.Cr50.Base, 30.02974302, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.97083457, 9.99416691, 
                p.Cr50.End, 29.97083457, 9.99416691);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.81718380, 5.00000000, 
                p.Cr52.Base, 4.81718380, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.17926603, 5.03585321, 
                p.Cr52.End, 5.17926603, 5.03585321);
}
