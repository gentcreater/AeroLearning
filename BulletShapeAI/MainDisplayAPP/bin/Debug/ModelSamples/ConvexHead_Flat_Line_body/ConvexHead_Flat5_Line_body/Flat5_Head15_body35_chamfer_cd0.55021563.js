...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body35_chamfer_cd0.55021563.js
//         On: 07/01/19, 18:38:07
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(15.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.53865931, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.05125776, 10.00000000);
  p.Ln49 = Line(24.95415367, 9.97707683, 15.41263566, 5.20631783);
  p.Cr50 = ArcCtrEdge(
              25.05125776, 9.78286865,
              25.05125776, 10.00000000,
              24.95415367, 9.97707683);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.53865931, 6.95427054,
              14.53865931, 5.00000000,
              15.41263566, 5.20631783);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 15.00000000, 5.00000000, 
    9.75357603, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.05125776, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.95415367, 9.97707683, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.53865931, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.41263566, 5.20631783, 
  ...
  CoincidentCon(p.Ln46.End, 25.05125776, 10.00000000, 
                p.Cr50.Base, 25.05125776, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.95415367, 9.97707683, 
                p.Cr50.End, 24.95415367, 9.97707683);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.53865931, 5.00000000, 
                p.Cr52.Base, 14.53865931, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.41263566, 5.20631783, 
                p.Cr52.End, 15.41263566, 5.20631783);
}
