...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body25_chamfer_cd0.62908099.js
//         On: 07/01/19, 17:20:30
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(35.00000000, 10.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.72431301, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.07385100, 10.00000000);
  p.Ln49 = Line(34.92993879, 9.97664626, 20.26153964, 5.08717988);
  p.Cr50 = ArcCtrEdge(
              35.07385100, 9.54490965,
              35.07385100, 10.00000000,
              34.92993879, 9.97664626);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.72431301, 6.69885976,
              19.72431301, 5.00000000,
              20.26153964, 5.08717988);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 35.00000000, 10.00000000, 
    51.98900470, 11.09884475);
  if(dim) dim.Name = "H21";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.07385100, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.92993879, 9.97664626, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.72431301, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.26153964, 5.08717988, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 35.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 35.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 35.07385100, 10.00000000, 
                p.Cr50.Base, 35.07385100, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.92993879, 9.97664626, 
                p.Cr50.End, 34.92993879, 9.97664626);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.72431301, 5.00000000, 
                p.Cr52.Base, 19.72431301, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.26153964, 5.08717988, 
                p.Cr52.End, 20.26153964, 5.08717988);
}
