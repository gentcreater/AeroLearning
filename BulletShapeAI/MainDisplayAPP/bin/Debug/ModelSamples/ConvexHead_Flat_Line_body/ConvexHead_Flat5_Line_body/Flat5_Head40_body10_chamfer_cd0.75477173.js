...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body10_chamfer_cd0.75477173.js
//         On: 07/01/19, 17:04:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(40.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 39.40983006, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.59016994, 10.00000000);
  p.Ln49 = Line(49.47213595, 9.73606798, 40.52786405, 5.26393202);
  p.Cr50 = ArcCtrEdge(
              50.59016994, 7.50000000,
              50.59016994, 10.00000000,
              49.47213595, 9.73606798);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.40983006, 7.50000000,
              39.40983006, 5.00000000,
              40.52786405, 5.26393202);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt114, 40.00000000, 5.00000000, 
    26.00953608, 6.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.59016994, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.47213595, 9.73606798, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.40983006, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.52786405, 5.26393202, 
  ...
  CoincidentCon(p.Ln46.End, 50.59016994, 10.00000000, 
                p.Cr50.Base, 50.59016994, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.47213595, 9.73606798, 
                p.Cr50.End, 49.47213595, 9.73606798);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.40983006, 5.00000000, 
                p.Cr52.Base, 39.40983006, 5.00000000);
  CoincidentCon(p.Ln49.End, 40.52786405, 5.26393202, 
                p.Cr52.End, 40.52786405, 5.26393202);
}
