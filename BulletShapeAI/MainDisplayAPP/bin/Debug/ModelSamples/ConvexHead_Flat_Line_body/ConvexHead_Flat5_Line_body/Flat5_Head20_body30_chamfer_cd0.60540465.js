...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body30_chamfer_cd0.60540465.js
//         On: 07/01/19, 18:34:33
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.56415611, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.07090900, 10.00000000);
  p.Ln49 = Line(29.93657706, 9.96828853, 20.38983063, 5.19491531);
  p.Cr50 = ArcCtrEdge(
              30.07090900, 9.69962465,
              30.07090900, 10.00000000,
              29.93657706, 9.96828853);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.56415611, 6.84626436,
              19.56415611, 5.00000000,
              20.38983063, 5.19491531);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.07090900, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.93657706, 9.96828853, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.56415611, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.38983063, 5.19491531, 
  ...
  CoincidentCon(p.Ln46.End, 30.07090900, 10.00000000, 
                p.Cr50.Base, 30.07090900, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.93657706, 9.96828853, 
                p.Cr50.End, 29.93657706, 9.96828853);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.56415611, 5.00000000, 
                p.Cr52.Base, 19.56415611, 5.00000000);
  CoincidentCon(p.Ln49.End, 20.38983063, 5.19491531, 
                p.Cr52.End, 20.38983063, 5.19491531);
}
