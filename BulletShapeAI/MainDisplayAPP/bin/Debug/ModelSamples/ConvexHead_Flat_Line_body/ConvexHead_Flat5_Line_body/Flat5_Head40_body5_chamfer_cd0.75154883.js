...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body5_chamfer_cd0.75154883.js
//         On: 07/01/19, 16:59:18
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 39.59430585, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.40569415, 10.00000000);
  p.Ln49 = Line(54.61512474, 9.87170825, 40.38487526, 5.12829175);
  p.Cr50 = ArcCtrEdge(
              55.40569415, 7.50000000,
              55.40569415, 10.00000000,
              54.61512474, 9.87170825);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.59430585, 7.50000000,
              39.59430585, 5.00000000,
              40.38487526, 5.12829175);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.40569415, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.61512474, 9.87170825, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.59430585, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.38487526, 5.12829175, 
  ...
  CoincidentCon(p.Ln46.End, 55.40569415, 10.00000000, 
                p.Cr50.Base, 55.40569415, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.61512474, 9.87170825, 
                p.Cr50.End, 54.61512474, 9.87170825);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.59430585, 5.00000000, 
                p.Cr52.Base, 39.59430585, 5.00000000);
  CoincidentCon(p.Ln49.End, 40.38487526, 5.12829175, 
                p.Cr52.End, 40.38487526, 5.12829175);
}
