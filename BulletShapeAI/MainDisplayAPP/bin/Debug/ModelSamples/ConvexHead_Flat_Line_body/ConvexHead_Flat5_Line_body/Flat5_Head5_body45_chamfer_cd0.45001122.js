...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body45_chamfer_cd0.45001122.js
//         On: 07/01/19, 18:41:41
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.50565696, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.03164980, 10.00000000);
  p.Ln49 = Line(14.97169156, 9.98584578, 5.44215385, 5.22107693);
  p.Cr50 = ArcCtrEdge(
              15.03164980, 9.86592929,
              15.03164980, 10.00000000,
              14.97169156, 9.98584578);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.50565696, 7.09407071,
              4.50565696, 5.00000000,
              5.44215385, 5.22107693);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.03164980, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.97169156, 9.98584578, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.50565696, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.44215385, 5.22107693, 
  ...
  CoincidentCon(p.Ln46.End, 15.03164980, 10.00000000, 
                p.Cr50.Base, 15.03164980, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.97169156, 9.98584578, 
                p.Cr50.End, 14.97169156, 9.98584578);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.50565696, 5.00000000, 
                p.Cr52.Base, 4.50565696, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.44215385, 5.22107693, 
                p.Cr52.End, 5.44215385, 5.22107693);
}
