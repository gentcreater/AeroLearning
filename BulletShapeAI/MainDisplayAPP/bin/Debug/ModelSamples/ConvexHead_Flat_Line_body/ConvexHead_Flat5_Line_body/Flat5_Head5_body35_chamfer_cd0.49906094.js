...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body35_chamfer_cd0.49906094.js
//         On: 07/01/19, 18:38:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.75941830, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.02673009, 10.00000000);
  p.Ln49 = Line(24.97406800, 9.99351700, 5.23339853, 5.05834963);
  p.Cr50 = ArcCtrEdge(
              25.02673009, 9.78286865,
              25.02673009, 10.00000000,
              24.97406800, 9.99351700);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.75941830, 6.95427054,
              4.75941830, 5.00000000,
              5.23339853, 5.05834963);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.02673009, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.97406800, 9.99351700, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.75941830, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.23339853, 5.05834963, 
  ...
  CoincidentCon(p.Ln46.End, 25.02673009, 10.00000000, 
                p.Cr50.Base, 25.02673009, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.97406800, 9.99351700, 
                p.Cr50.End, 24.97406800, 9.99351700);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.75941830, 5.00000000, 
                p.Cr52.Base, 4.75941830, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.23339853, 5.05834963, 
                p.Cr52.End, 5.23339853, 5.05834963);
}
