...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body25_chamfer_cd0.52276523.js
//         On: 07/01/19, 17:22:19
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 4.85939807, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.03766443, 10.00000000);
  p.Ln49 = Line(34.96284804, 9.99380801, 5.13868889, 5.02311482);
  p.Cr50 = ArcCtrEdge(
              35.03766443, 9.54490965,
              35.03766443, 10.00000000,
              34.96284804, 9.99380801);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.85939807, 6.69885976,
              4.85939807, 5.00000000,
              5.13868889, 5.02311482);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.03766443, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.96284804, 9.99380801, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.85939807, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.13868889, 5.02311482, 
  ...
  CoincidentCon(p.Ln46.End, 35.03766443, 10.00000000, 
                p.Cr50.Base, 35.03766443, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.96284804, 9.99380801, 
                p.Cr50.End, 34.96284804, 9.99380801);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.85939807, 5.00000000, 
                p.Cr52.Base, 4.85939807, 5.00000000);
  CoincidentCon(p.Ln49.End, 5.13868889, 5.02311482, 
                p.Cr52.End, 5.13868889, 5.02311482);
}
