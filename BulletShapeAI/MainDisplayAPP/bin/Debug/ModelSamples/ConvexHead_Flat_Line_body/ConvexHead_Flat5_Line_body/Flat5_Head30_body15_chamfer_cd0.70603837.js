...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body15_chamfer_cd0.70603837.js
//         On: 07/01/19, 17:09:54
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 29.73774039, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.26225961, 10.00000000);
  p.Ln49 = Line(44.75119869, 9.91706623, 30.24880131, 5.08293377);
  p.Cr50 = ArcCtrEdge(
              45.26225961, 8.38388348,
              45.26225961, 10.00000000,
              44.75119869, 9.91706623);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.73774039, 6.61611652,
              29.73774039, 5.00000000,
              30.24880131, 5.08293377);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.26225961, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.75119869, 9.91706623, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.73774039, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.24880131, 5.08293377, 
  ...
  CoincidentCon(p.Ln46.End, 45.26225961, 10.00000000, 
                p.Cr50.Base, 45.26225961, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.75119869, 9.91706623, 
                p.Cr50.End, 44.75119869, 9.91706623);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.73774039, 5.00000000, 
                p.Cr52.Base, 29.73774039, 5.00000000);
  CoincidentCon(p.Ln49.End, 30.24880131, 5.08293377, 
                p.Cr52.End, 30.24880131, 5.08293377);
}
