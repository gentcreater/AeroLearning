...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body25_chamfer_cd0.5866895.js
//         On: 07/01/19, 17:21:15
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.79086081, 5.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.05602418, 10.00000000);
  p.Ln49 = Line(34.94564856, 9.98641214, 15.20289482, 5.05072370);
  p.Cr50 = ArcCtrEdge(
              35.05602418, 9.54490965,
              35.05602418, 10.00000000,
              34.94564856, 9.98641214);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.79086081, 6.69885976,
              14.79086081, 5.00000000,
              15.20289482, 5.05072370);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.05602418, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.94564856, 9.98641214, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.79086081, 5.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.20289482, 5.05072370, 
  ...
  CoincidentCon(p.Ln46.End, 35.05602418, 10.00000000, 
                p.Cr50.Base, 35.05602418, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.94564856, 9.98641214, 
                p.Cr50.End, 34.94564856, 9.98641214);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 5.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.79086081, 5.00000000, 
                p.Cr52.Base, 14.79086081, 5.00000000);
  CoincidentCon(p.Ln49.End, 15.20289482, 5.05072370, 
                p.Cr52.End, 15.20289482, 5.05072370);
}
