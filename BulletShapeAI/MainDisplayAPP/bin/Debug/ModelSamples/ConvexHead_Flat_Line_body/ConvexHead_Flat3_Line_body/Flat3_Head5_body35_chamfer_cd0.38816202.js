...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body35_chamfer_cd0.38816202.js
//         On: 06/30/19, 21:10:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.56567736, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.06551680, 10.00000000);
  p.Ln49 = Line(24.93816142, 9.97835650, 5.40993906, 3.14347867);
  p.Cr50 = ArcCtrEdge(
              25.06551680, 9.61448400,
              25.06551680, 10.00000000,
              24.93816142, 9.97835650);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.56567736, 5.55565495,
              4.56567736, 3.00000000,
              5.40993906, 3.14347867);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.06551680, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.93816142, 9.97835650, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.56567736, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.40993906, 3.14347867, 
  ...
  CoincidentCon(p.Ln46.End, 25.06551680, 10.00000000, 
                p.Cr50.Base, 25.06551680, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.93816142, 9.97835650, 
                p.Cr50.End, 24.93816142, 9.97835650);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.56567736, 3.00000000, 
                p.Cr52.Base, 4.56567736, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.40993906, 3.14347867, 
                p.Cr52.End, 5.40993906, 3.14347867);
}
