...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body25_chamfer_cd0.46633899.js
//         On: 06/30/19, 21:03:34
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 14.63508772, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.13030797, 10.00000000);
  p.Ln49 = Line(34.87700773, 9.95695271, 15.34442550, 3.12054893);
  p.Cr50 = ArcCtrEdge(
              35.13030797, 9.23323773,
              35.13030797, 10.00000000,
              34.87700773, 9.95695271);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.63508772, 5.14722829,
              14.63508772, 3.00000000,
              15.34442550, 3.12054893);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.13030797, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.87700773, 9.95695271, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.63508772, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.34442550, 3.12054893, 
  ...
  CoincidentCon(p.Ln46.End, 35.13030797, 10.00000000, 
                p.Cr50.Base, 35.13030797, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.87700773, 9.95695271, 
                p.Cr50.End, 34.87700773, 9.95695271);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.63508772, 3.00000000, 
                p.Cr52.Base, 14.63508772, 3.00000000);
  CoincidentCon(p.Ln49.End, 15.34442550, 3.12054893, 
                p.Cr52.End, 15.34442550, 3.12054893);
}
