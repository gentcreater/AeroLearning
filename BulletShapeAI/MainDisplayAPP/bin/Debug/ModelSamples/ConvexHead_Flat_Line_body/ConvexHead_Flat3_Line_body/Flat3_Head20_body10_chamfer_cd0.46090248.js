...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body10_chamfer_cd0.46090248.js
//         On: 06/30/19, 20:43:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(20.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.71219871, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.28780129, 10.00000000);
  p.Ln49 = Line(49.71972725, 9.93460302, 20.28027275, 3.06539698);
  p.Cr50 = ArcCtrEdge(
              50.28780129, 7.50000000,
              50.28780129, 10.00000000,
              49.71972725, 9.93460302);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.71219871, 5.50000000,
              19.71219871, 3.00000000,
              20.28027275, 3.06539698);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 20.00000000, 3.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.28780129, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.71972725, 9.93460302, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.71219871, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.28027275, 3.06539698, 
  ...
  CoincidentCon(p.Ln46.End, 50.28780129, 10.00000000, 
                p.Cr50.Base, 50.28780129, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.71972725, 9.93460302, 
                p.Cr50.End, 49.71972725, 9.93460302);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.71219871, 3.00000000, 
                p.Cr52.Base, 19.71219871, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.28027275, 3.06539698, 
                p.Cr52.End, 20.28027275, 3.06539698);
}
