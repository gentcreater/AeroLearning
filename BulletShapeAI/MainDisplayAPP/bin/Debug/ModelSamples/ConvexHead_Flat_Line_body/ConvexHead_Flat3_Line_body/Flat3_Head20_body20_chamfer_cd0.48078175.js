...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body20_chamfer_cd0.48078175.js
//         On: 06/30/19, 20:54:20
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.67455989, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.20756790, 10.00000000);
  p.Ln49 = Line(39.80408530, 9.93142986, 20.30716937, 3.10750928);
  p.Cr50 = ArcCtrEdge(
              40.20756790, 8.77862243,
              40.20756790, 10.00000000,
              39.80408530, 9.93142986);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.67455989, 4.91496495,
              19.67455989, 3.00000000,
              20.30716937, 3.10750928);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.20756790, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.80408530, 9.93142986, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.67455989, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.30716937, 3.10750928, 
  ...
  CoincidentCon(p.Ln46.End, 40.20756790, 10.00000000, 
                p.Cr50.Base, 40.20756790, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.80408530, 9.93142986, 
                p.Cr50.End, 39.80408530, 9.93142986);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.67455989, 3.00000000, 
                p.Cr52.Base, 19.67455989, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.30716937, 3.10750928, 
                p.Cr52.End, 20.30716937, 3.10750928);
}
