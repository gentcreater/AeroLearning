...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body30_chamfer_cd0.38661341.js
//         On: 06/30/19, 21:07:40
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.67351595, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.07206673, 10.00000000);
  p.Ln49 = Line(29.93060233, 9.98056865, 5.31439240, 3.08802987);
  p.Cr50 = ArcCtrEdge(
              30.07206673, 9.47533866,
              30.07206673, 10.00000000,
              29.93060233, 9.98056865);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.67351595, 5.37687434,
              4.67351595, 3.00000000,
              5.31439240, 3.08802987);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.07206673, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.93060233, 9.98056865, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.67351595, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.31439240, 3.08802987, 
  ...
  CoincidentCon(p.Ln46.End, 30.07206673, 10.00000000, 
                p.Cr50.Base, 30.07206673, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.93060233, 9.98056865, 
                p.Cr50.End, 29.93060233, 9.98056865);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.67351595, 3.00000000, 
                p.Cr52.Base, 4.67351595, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.31439240, 3.08802987, 
                p.Cr52.End, 5.31439240, 3.08802987);
}
