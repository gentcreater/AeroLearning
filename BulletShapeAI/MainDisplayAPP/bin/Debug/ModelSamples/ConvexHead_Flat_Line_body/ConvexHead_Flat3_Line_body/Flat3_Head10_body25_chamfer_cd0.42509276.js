...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body25_chamfer_cd0.42509276.js
//         On: 06/30/19, 21:04:00
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.70505980, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.10532137, 10.00000000);
  p.Ln49 = Line(34.89857931, 9.97160221, 10.28401680, 3.07952470);
  p.Cr50 = ArcCtrEdge(
              35.10532137, 9.23323773,
              35.10532137, 10.00000000,
              34.89857931, 9.97160221);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.70505980, 5.14722829,
              9.70505980, 3.00000000,
              10.28401680, 3.07952470);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.10532137, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.89857931, 9.97160221, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.70505980, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.28401680, 3.07952470, 
  ...
  CoincidentCon(p.Ln46.End, 35.10532137, 10.00000000, 
                p.Cr50.Base, 35.10532137, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.89857931, 9.97160221, 
                p.Cr50.End, 34.89857931, 9.97160221);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.70505980, 3.00000000, 
                p.Cr52.Base, 9.70505980, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.28401680, 3.07952470, 
                p.Cr52.End, 10.28401680, 3.07952470);
}
