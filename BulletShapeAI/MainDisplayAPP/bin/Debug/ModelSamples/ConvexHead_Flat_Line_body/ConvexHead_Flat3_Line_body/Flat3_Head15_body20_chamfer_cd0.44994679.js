...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body20_chamfer_cd0.44994679.js
//         On: 06/30/19, 20:56:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 14.73696316, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.16776667, 10.00000000);
  p.Ln49 = Line(39.83844673, 9.95476508, 15.25329501, 3.07092260);
  p.Cr50 = ArcCtrEdge(
              40.16776667, 8.77862243,
              40.16776667, 10.00000000,
              39.83844673, 9.95476508);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.73696316, 4.91496495,
              14.73696316, 3.00000000,
              15.25329501, 3.07092260);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.16776667, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.83844673, 9.95476508, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.73696316, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.25329501, 3.07092260, 
  ...
  CoincidentCon(p.Ln46.End, 40.16776667, 10.00000000, 
                p.Cr50.Base, 40.16776667, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.83844673, 9.95476508, 
                p.Cr50.End, 39.83844673, 9.95476508);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.73696316, 3.00000000, 
                p.Cr52.Base, 14.73696316, 3.00000000);
  CoincidentCon(p.Ln49.End, 15.25329501, 3.07092260, 
                p.Cr52.End, 15.25329501, 3.07092260);
}
