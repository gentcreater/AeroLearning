...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body20_chamfer_cd0.60841725.js
//         On: 07/03/19, 09:42:27
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 34.01452477, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.62854275, 10.00000000);
  p.Ln49 = Line(39.63466694, 9.48853372, 35.57279584, 3.80191418);
  p.Cr50 = ArcCtrEdge(
              40.62854275, 8.77862243,
              40.62854275, 10.00000000,
              39.63466694, 9.48853372);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.01452477, 4.91496495,
              34.01452477, 3.00000000,
              35.57279584, 3.80191418);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.62854275, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.63466694, 9.48853372, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.01452477, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.57279584, 3.80191418, 
  ...
  CoincidentCon(p.Ln46.End, 40.62854275, 10.00000000, 
                p.Cr50.Base, 40.62854275, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.63466694, 9.48853372, 
                p.Cr50.End, 39.63466694, 9.48853372);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.01452477, 3.00000000, 
                p.Cr52.Base, 34.01452477, 3.00000000);
  CoincidentCon(p.Ln49.End, 35.57279584, 3.80191418, 
                p.Cr52.End, 35.57279584, 3.80191418);
}
