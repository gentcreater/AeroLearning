...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body15_chamfer_cd0.46219983.js
//         On: 06/30/19, 20:50:19
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.72403436, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.27596564, 10.00000000);
  p.Ln49 = Line(44.73425502, 9.92559141, 20.26574498, 3.07440859);
  p.Cr50 = ArcCtrEdge(
              45.27596564, 7.99091064,
              45.27596564, 10.00000000,
              44.73425502, 9.92559141);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.72403436, 5.00908936,
              19.72403436, 3.00000000,
              20.26574498, 3.07440859);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.27596564, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.73425502, 9.92559141, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.72403436, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.26574498, 3.07440859, 
  ...
  CoincidentCon(p.Ln46.End, 45.27596564, 10.00000000, 
                p.Cr50.Base, 45.27596564, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.73425502, 9.92559141, 
                p.Cr50.End, 44.73425502, 9.92559141);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.72403436, 3.00000000, 
                p.Cr52.Base, 19.72403436, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.26574498, 3.07440859, 
                p.Cr52.End, 20.26574498, 3.07440859);
}
