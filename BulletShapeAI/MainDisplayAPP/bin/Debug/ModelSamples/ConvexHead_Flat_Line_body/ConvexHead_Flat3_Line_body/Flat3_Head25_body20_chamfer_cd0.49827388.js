...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body20_chamfer_cd0.49827388.js
//         On: 06/30/19, 20:53:30
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 24.57516630, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.27096180, 10.00000000);
  p.Ln49 = Line(39.75445898, 9.88541419, 25.38497714, 3.17965600);
  p.Cr50 = ArcCtrEdge(
              40.27096180, 8.77862243,
              40.27096180, 10.00000000,
              39.75445898, 9.88541419);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.57516630, 4.91496495,
              24.57516630, 3.00000000,
              25.38497714, 3.17965600);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.27096180, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.75445898, 9.88541419, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.57516630, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.38497714, 3.17965600, 
  ...
  CoincidentCon(p.Ln46.End, 40.27096180, 10.00000000, 
                p.Cr50.Base, 40.27096180, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.75445898, 9.88541419, 
                p.Cr50.End, 39.75445898, 9.88541419);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.57516630, 3.00000000, 
                p.Cr52.Base, 24.57516630, 3.00000000);
  CoincidentCon(p.Ln49.End, 25.38497714, 3.17965600, 
                p.Cr52.End, 25.38497714, 3.17965600);
}
