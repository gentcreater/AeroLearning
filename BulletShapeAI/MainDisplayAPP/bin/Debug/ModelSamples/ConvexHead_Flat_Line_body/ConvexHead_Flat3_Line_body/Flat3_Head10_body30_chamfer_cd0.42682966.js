...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body30_chamfer_cd0.42682966.js
//         On: 06/30/19, 21:06:45
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.59606036, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.08916395, 10.00000000);
  p.Ln49 = Line(29.91584186, 9.97054465, 10.38126181, 3.13344163);
  p.Cr50 = ArcCtrEdge(
              30.08916395, 9.47533866,
              30.08916395, 10.00000000,
              29.91584186, 9.97054465);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.59606036, 5.37687434,
              9.59606036, 3.00000000,
              10.38126181, 3.13344163);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.08916395, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.91584186, 9.97054465, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.59606036, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.38126181, 3.13344163, 
  ...
  CoincidentCon(p.Ln46.End, 30.08916395, 10.00000000, 
                p.Cr50.Base, 30.08916395, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.91584186, 9.97054465, 
                p.Cr50.End, 29.91584186, 9.97054465);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.59606036, 3.00000000, 
                p.Cr52.Base, 9.59606036, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.38126181, 3.13344163, 
                p.Cr52.End, 10.38126181, 3.13344163);
}
