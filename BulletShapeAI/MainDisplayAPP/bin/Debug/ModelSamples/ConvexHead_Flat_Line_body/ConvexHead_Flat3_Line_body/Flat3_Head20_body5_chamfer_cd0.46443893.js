...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body5_cd0.46443893.js
//         On: 06/30/19, 20:09:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.75245122, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.24754878, 10.00000000);
  p.Ln49 = Line(54.75725845, 9.95145169, 20.24274155, 3.04854831);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.75245122, 5.50000000,
              19.75245122, 3.00000000,
              20.24274155, 3.04854831);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  TangentCon(p.Cr52, 19.75245122, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.24274155, 3.04854831, 
  ...
  CoincidentCon(p.Ln43.End, 19.75245122, 3.00000000, 
                p.Cr52.Base, 19.75245122, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.24274155, 3.04854831, 
                p.Cr52.End, 20.24274155, 3.04854831);
}
