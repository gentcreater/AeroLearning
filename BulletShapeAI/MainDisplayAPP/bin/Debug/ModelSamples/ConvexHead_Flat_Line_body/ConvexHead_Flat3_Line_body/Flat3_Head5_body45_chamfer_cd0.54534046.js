...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body45_chamfer_cd0.54534046.js
//         On: 06/30/19, 21:15:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.11892269, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.07590498, 10.00000000);
  p.Ln49 = Line(14.93781622, 9.95647135, 5.72180666, 3.50526466);
  p.Cr50 = ArcCtrEdge(
              15.07590498, 9.75920169,
              15.07590498, 10.00000000,
              14.93781622, 9.95647135);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.11892269, 5.79509890,
              4.11892269, 3.00000000,
              5.72180666, 3.50526466);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.07590498, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.93781622, 9.95647135, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.11892269, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.72180666, 3.50526466, 
  ...
  CoincidentCon(p.Ln46.End, 15.07590498, 10.00000000, 
                p.Cr50.Base, 15.07590498, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.93781622, 9.95647135, 
                p.Cr50.End, 14.93781622, 9.95647135);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.11892269, 3.00000000, 
                p.Cr52.Base, 4.11892269, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.72180666, 3.50526466, 
                p.Cr52.End, 5.72180666, 3.50526466);
}
