...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body5_cd0.46696972.js
//         On: 06/30/19, 20:08:42
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 29.65660358, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.34339642, 10.00000000);
  p.Ln49 = Line(54.66932160, 9.90741005, 30.33067840, 3.09258995);
  p.Cr50 = ArcCtrEdge(
              55.34339642, 7.50000000,
              55.34339642, 10.00000000,
              54.66932160, 9.90741005);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.65660358, 5.50000000,
              29.65660358, 3.00000000,
              30.33067840, 3.09258995);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.34339642, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.66932160, 9.90741005, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.65660358, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.33067840, 3.09258995, 
  ...
  CoincidentCon(p.Ln46.End, 55.34339642, 10.00000000, 
                p.Cr50.Base, 55.34339642, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.66932160, 9.90741005, 
                p.Cr50.End, 54.66932160, 9.90741005);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.65660358, 3.00000000, 
                p.Cr52.Base, 29.65660358, 3.00000000);
  CoincidentCon(p.Ln49.End, 30.33067840, 3.09258995, 
                p.Cr52.End, 30.33067840, 3.09258995);
}
