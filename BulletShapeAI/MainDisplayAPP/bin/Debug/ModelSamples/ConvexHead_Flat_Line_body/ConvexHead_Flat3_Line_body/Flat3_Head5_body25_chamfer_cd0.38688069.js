...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body25_chamfer_cd0.38688069.js
//         On: 06/30/19, 21:04:55
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.75280997, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.08827007, 10.00000000);
  p.Ln49 = Line(34.91403897, 9.97994243, 5.24072383, 3.05616889);
  p.Cr50 = ArcCtrEdge(
              35.08827007, 9.23323773,
              35.08827007, 10.00000000,
              34.91403897, 9.97994243);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.75280997, 5.14722829,
              4.75280997, 3.00000000,
              5.24072383, 3.05616889);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.08827007, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.91403897, 9.97994243, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.75280997, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.24072383, 3.05616889, 
  ...
  CoincidentCon(p.Ln46.End, 35.08827007, 10.00000000, 
                p.Cr50.Base, 35.08827007, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.91403897, 9.97994243, 
                p.Cr50.End, 34.91403897, 9.97994243);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.75280997, 3.00000000, 
                p.Cr52.Base, 4.75280997, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.24072383, 3.05616889, 
                p.Cr52.End, 5.24072383, 3.05616889);
}
