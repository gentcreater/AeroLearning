...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body5_cd0.50973726.js
//         On: 06/30/19, 20:07:54
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 39.44537666, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.55462334, 10.00000000);
  p.Ln49 = Line(54.49740968, 9.76545785, 40.50259032, 3.23454215);
  p.Cr50 = ArcCtrEdge(
              55.55462334, 7.50000000,
              55.55462334, 10.00000000,
              54.49740968, 9.76545785);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.44537666, 5.50000000,
              39.44537666, 3.00000000,
              40.50259032, 3.23454215);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.55462334, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.49740968, 9.76545785, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.44537666, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.50259032, 3.23454215, 
  ...
  CoincidentCon(p.Ln46.End, 55.55462334, 10.00000000, 
                p.Cr50.Base, 55.55462334, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.49740968, 9.76545785, 
                p.Cr50.End, 54.49740968, 9.76545785);
  CoincidentCon(p.Pt114, 40.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.44537666, 3.00000000, 
                p.Cr52.Base, 39.44537666, 3.00000000);
  CoincidentCon(p.Ln49.End, 40.50259032, 3.23454215, 
                p.Cr52.End, 40.50259032, 3.23454215);
}
