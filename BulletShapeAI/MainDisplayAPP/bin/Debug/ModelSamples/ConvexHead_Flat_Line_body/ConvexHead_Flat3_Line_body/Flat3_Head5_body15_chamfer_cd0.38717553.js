...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body15_chamfer_cd0.38717553.js
//         On: 06/30/19, 20:51:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.82553039, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.17446961, 10.00000000);
  p.Ln49 = Line(44.82814212, 9.96992487, 5.17185788, 3.03007513);
  p.Cr50 = ArcCtrEdge(
              45.17446961, 7.99091064,
              45.17446961, 10.00000000,
              44.82814212, 9.96992487);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.82553039, 5.00908936,
              4.82553039, 3.00000000,
              5.17185788, 3.03007513);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.17446961, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.82814212, 9.96992487, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.82553039, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.17185788, 3.03007513, 
  ...
  CoincidentCon(p.Ln46.End, 45.17446961, 10.00000000, 
                p.Cr50.Base, 45.17446961, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.82814212, 9.96992487, 
                p.Cr50.End, 44.82814212, 9.96992487);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.82553039, 3.00000000, 
                p.Cr52.Base, 4.82553039, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.17185788, 3.03007513, 
                p.Cr52.End, 5.17185788, 3.03007513);
}
