...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body45_chamfer_cd0.62832743.js
//         On: 06/30/19, 21:14:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 8.56159209, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.12391912, 10.00000000);
  p.Ln49 = Line(14.92797347, 9.89916286, 10.83605762, 4.17048066);
  p.Cr50 = ArcCtrEdge(
              15.12391912, 9.75920169,
              15.12391912, 10.00000000,
              14.92797347, 9.89916286);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              8.56159209, 5.79509890,
              8.56159209, 3.00000000,
              10.83605762, 4.17048066);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.12391912, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.92797347, 9.89916286, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 8.56159209, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.83605762, 4.17048066, 
  ...
  CoincidentCon(p.Ln46.End, 15.12391912, 10.00000000, 
                p.Cr50.Base, 15.12391912, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.92797347, 9.89916286, 
                p.Cr50.End, 14.92797347, 9.89916286);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 8.56159209, 3.00000000, 
                p.Cr52.Base, 8.56159209, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.83605762, 4.17048066, 
                p.Cr52.End, 10.83605762, 4.17048066);
}
