...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body5_cd0.47129376.js
//         On: 06/30/19, 20:09:12
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 24.71219871, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.28780129, 10.00000000);
  p.Ln49 = Line(54.71972725, 9.93460302, 25.28027275, 3.06539698);
  p.Cr50 = ArcCtrEdge(
              55.28780129, 7.50000000,
              55.28780129, 10.00000000,
              54.71972725, 9.93460302);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.71219871, 5.50000000,
              24.71219871, 3.00000000,
              25.28027275, 3.06539698);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.28780129, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.71972725, 9.93460302, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.71219871, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.28027275, 3.06539698, 
  ...
  CoincidentCon(p.Ln46.End, 55.28780129, 10.00000000, 
                p.Cr50.Base, 55.28780129, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.71972725, 9.93460302, 
                p.Cr50.End, 54.71972725, 9.93460302);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.71219871, 3.00000000, 
                p.Cr52.Base, 24.71219871, 3.00000000);
  CoincidentCon(p.Ln49.End, 25.28027275, 3.06539698, 
                p.Cr52.End, 25.28027275, 3.06539698);
}
