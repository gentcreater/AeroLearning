...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body5_cd0.4380667.js
//         On: 06/30/19, 20:10:29
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.80671780, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.19328220, 10.00000000);
  p.Ln49 = Line(54.80901468, 9.97029117, 10.19098532, 3.02970883);
  p.Cr50 = ArcCtrEdge(
              55.19328220, 7.50000000,
              55.19328220, 10.00000000,
              54.80901468, 9.97029117);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.80671780, 5.50000000,
              9.80671780, 3.00000000,
              10.19098532, 3.02970883);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.19328220, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.80901468, 9.97029117, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.80671780, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.19098532, 3.02970883, 
  ...
  CoincidentCon(p.Ln46.End, 55.19328220, 10.00000000, 
                p.Cr50.Base, 55.19328220, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.80901468, 9.97029117, 
                p.Cr50.End, 54.80901468, 9.97029117);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.80671780, 3.00000000, 
                p.Cr52.Base, 9.80671780, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.19098532, 3.02970883, 
                p.Cr52.End, 10.19098532, 3.02970883);
}
