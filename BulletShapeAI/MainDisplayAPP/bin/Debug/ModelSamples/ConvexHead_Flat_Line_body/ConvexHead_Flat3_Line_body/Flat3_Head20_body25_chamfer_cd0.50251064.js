...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body25_chamfer_cd0.50251064.js
//         On: 06/30/19, 20:58:55
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.52363883, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.17010570, 10.00000000);
  p.Ln49 = Line(34.84585308, 9.92806477, 20.43167046, 3.20144622);
  p.Cr50 = ArcCtrEdge(
              35.17010570, 9.23323773,
              35.17010570, 10.00000000,
              34.84585308, 9.92806477);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.52363883, 5.14722829,
              19.52363883, 3.00000000,
              20.43167046, 3.20144622);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.17010570, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.84585308, 9.92806477, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.52363883, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.43167046, 3.20144622, 
  ...
  CoincidentCon(p.Ln46.End, 35.17010570, 10.00000000, 
                p.Cr50.Base, 35.17010570, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.84585308, 9.92806477, 
                p.Cr50.End, 34.84585308, 9.92806477);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.52363883, 3.00000000, 
                p.Cr52.Base, 19.52363883, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.43167046, 3.20144622, 
                p.Cr52.End, 20.43167046, 3.20144622);
}
