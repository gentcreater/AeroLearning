...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body30_chamfer_cd0.59387912.js
//         On: 06/30/19, 21:05:21
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 23.58530724, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.39293828, 10.00000000);
  p.Ln49 = Line(29.77160926, 9.68025297, 25.82227347, 4.15118285);
  p.Cr50 = ArcCtrEdge(
              30.39293828, 9.23644652,
              30.39293828, 10.00000000,
              29.77160926, 9.68025297);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              23.58530724, 5.74901587,
              23.58530724, 3.00000000,
              25.82227347, 4.15118285);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.39293828, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.77160926, 9.68025297, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 23.58530724, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.82227347, 4.15118285, 
  ...
  CoincidentCon(p.Ln46.End, 30.39293828, 10.00000000, 
                p.Cr50.Base, 30.39293828, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.77160926, 9.68025297, 
                p.Cr50.End, 29.77160926, 9.68025297);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 23.58530724, 3.00000000, 
                p.Cr52.Base, 23.58530724, 3.00000000);
  CoincidentCon(p.Ln49.End, 25.82227347, 4.15118285, 
                p.Cr52.End, 25.82227347, 4.15118285);
}
