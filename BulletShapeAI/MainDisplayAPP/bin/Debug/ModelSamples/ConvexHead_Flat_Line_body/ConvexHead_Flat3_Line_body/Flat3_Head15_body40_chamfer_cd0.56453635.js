...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body40_chamfer_cd0.56453635.js
//         On: 06/30/19, 21:13:07
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 13.61510536, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.15372494, 10.00000000);
  p.Ln49 = Line(19.91064919, 9.87490887, 15.80495366, 4.12693512);
  p.Cr50 = ArcCtrEdge(
              20.15372494, 9.70128333,
              20.15372494, 10.00000000,
              19.91064919, 9.87490887);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              13.61510536, 5.69111248,
              13.61510536, 3.00000000,
              15.80495366, 4.12693512);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.15372494, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.91064919, 9.87490887, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 13.61510536, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.80495366, 4.12693512, 
  ...
  CoincidentCon(p.Ln46.End, 20.15372494, 10.00000000, 
                p.Cr50.Base, 20.15372494, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.91064919, 9.87490887, 
                p.Cr50.End, 19.91064919, 9.87490887);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 13.61510536, 3.00000000, 
                p.Cr52.Base, 13.61510536, 3.00000000);
  CoincidentCon(p.Ln49.End, 15.80495366, 4.12693512, 
                p.Cr52.End, 15.80495366, 4.12693512);
}
