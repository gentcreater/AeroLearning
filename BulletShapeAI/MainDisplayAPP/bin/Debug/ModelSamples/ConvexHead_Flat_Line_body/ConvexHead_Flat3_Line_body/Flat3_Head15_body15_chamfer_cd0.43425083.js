...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body15_chamfer_cd0.43425083.js
//         On: 06/30/19, 20:50:43
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 14.76871260, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.23128740, 10.00000000);
  p.Ln49 = Line(44.77476280, 9.94744465, 15.22523720, 3.05255535);
  p.Cr50 = ArcCtrEdge(
              45.23128740, 7.99091064,
              45.23128740, 10.00000000,
              44.77476280, 9.94744465);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.76871260, 5.00908936,
              14.76871260, 3.00000000,
              15.22523720, 3.05255535);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.23128740, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.77476280, 9.94744465, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.76871260, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.22523720, 3.05255535, 
  ...
  CoincidentCon(p.Ln46.End, 45.23128740, 10.00000000, 
                p.Cr50.Base, 45.23128740, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.77476280, 9.94744465, 
                p.Cr50.End, 44.77476280, 9.94744465);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.76871260, 3.00000000, 
                p.Cr52.Base, 14.76871260, 3.00000000);
  CoincidentCon(p.Ln49.End, 15.22523720, 3.05255535, 
                p.Cr52.End, 15.22523720, 3.05255535);
}
