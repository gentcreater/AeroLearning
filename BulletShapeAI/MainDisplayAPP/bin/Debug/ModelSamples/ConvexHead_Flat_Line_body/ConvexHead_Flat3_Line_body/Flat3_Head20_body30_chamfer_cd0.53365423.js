...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body30_chamfer_cd0.53365423.js
//         On: 06/30/19, 21:05:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.25075637, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.16538492, 10.00000000);
  p.Ln49 = Line(29.86451140, 9.90515798, 20.61380430, 3.42966301);
  p.Cr50 = ArcCtrEdge(
              30.16538492, 9.47533866,
              30.16538492, 10.00000000,
              29.86451140, 9.90515798);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.25075637, 5.37687434,
              19.25075637, 3.00000000,
              20.61380430, 3.42966301);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.16538492, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.86451140, 9.90515798, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.25075637, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.61380430, 3.42966301, 
  ...
  CoincidentCon(p.Ln46.End, 30.16538492, 10.00000000, 
                p.Cr50.Base, 30.16538492, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.86451140, 9.90515798, 
                p.Cr50.End, 29.86451140, 9.90515798);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.25075637, 3.00000000, 
                p.Cr52.Base, 19.25075637, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.61380430, 3.42966301, 
                p.Cr52.End, 20.61380430, 3.42966301);
}
