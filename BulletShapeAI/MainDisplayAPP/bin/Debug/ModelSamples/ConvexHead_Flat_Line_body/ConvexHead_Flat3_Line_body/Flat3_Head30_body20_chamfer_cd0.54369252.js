...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body20_chamfer_cd0.54369252.js
//         On: 06/30/19, 20:52:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 29.32180164, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.49423862, 10.00000000);
  p.Ln49 = Line(39.59510395, 9.71657276, 30.55560174, 3.38892122);
  p.Cr50 = ArcCtrEdge(
              40.49423862, 8.43209465,
              40.49423862, 10.00000000,
              39.59510395, 9.71657276);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.32180164, 5.15149279,
              29.32180164, 3.00000000,
              30.55560174, 3.38892122);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.49423862, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.59510395, 9.71657276, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.32180164, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.55560174, 3.38892122, 
  ...
  CoincidentCon(p.Ln46.End, 40.49423862, 10.00000000, 
                p.Cr50.Base, 40.49423862, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.59510395, 9.71657276, 
                p.Cr50.End, 39.59510395, 9.71657276);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.32180164, 3.00000000, 
                p.Cr52.Base, 29.32180164, 3.00000000);
  CoincidentCon(p.Ln49.End, 30.55560174, 3.38892122, 
                p.Cr52.End, 30.55560174, 3.38892122);
}
