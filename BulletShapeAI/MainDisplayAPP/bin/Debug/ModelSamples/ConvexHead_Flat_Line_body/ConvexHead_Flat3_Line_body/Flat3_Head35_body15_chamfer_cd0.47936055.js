...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body15_chamfer_cd0.47936055.js
//         On: 06/30/19, 20:48:26
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 34.30220707, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.69779293, 10.00000000);
  p.Ln49 = Line(44.42834576, 9.59984203, 35.57165424, 3.40015797);
  p.Cr50 = ArcCtrEdge(
              45.69779293, 7.78634607,
              45.69779293, 10.00000000,
              44.42834576, 9.59984203);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.30220707, 5.21365393,
              34.30220707, 3.00000000,
              35.57165424, 3.40015797);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.69779293, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.42834576, 9.59984203, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.30220707, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.57165424, 3.40015797, 
  ...
  CoincidentCon(p.Ln46.End, 45.69779293, 10.00000000, 
                p.Cr50.Base, 45.69779293, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.42834576, 9.59984203, 
                p.Cr50.End, 44.42834576, 9.59984203);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.30220707, 3.00000000, 
                p.Cr52.Base, 34.30220707, 3.00000000);
  CoincidentCon(p.Ln49.End, 35.57165424, 3.40015797, 
                p.Cr52.End, 35.57165424, 3.40015797);
}
