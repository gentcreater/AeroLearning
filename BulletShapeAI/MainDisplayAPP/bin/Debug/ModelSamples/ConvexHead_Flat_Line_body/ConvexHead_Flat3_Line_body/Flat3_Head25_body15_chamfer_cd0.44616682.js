...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body15_chamfer_cd0.44616682.js
//         On: 06/30/19, 20:49:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 24.65856384, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.34143616, 10.00000000);
  p.Ln49 = Line(44.67773263, 9.88720642, 25.32226737, 3.11279358);
  p.Cr50 = ArcCtrEdge(
              45.34143616, 7.99091064,
              45.34143616, 10.00000000,
              44.67773263, 9.88720642);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.65856384, 5.00908936,
              24.65856384, 3.00000000,
              25.32226737, 3.11279358);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.34143616, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.67773263, 9.88720642, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.65856384, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.32226737, 3.11279358, 
  ...
  CoincidentCon(p.Ln46.End, 45.34143616, 10.00000000, 
                p.Cr50.Base, 45.34143616, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.67773263, 9.88720642, 
                p.Cr50.End, 44.67773263, 9.88720642);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.65856384, 3.00000000, 
                p.Cr52.Base, 24.65856384, 3.00000000);
  CoincidentCon(p.Ln49.End, 25.32226737, 3.11279358, 
                p.Cr52.End, 25.32226737, 3.11279358);
}
