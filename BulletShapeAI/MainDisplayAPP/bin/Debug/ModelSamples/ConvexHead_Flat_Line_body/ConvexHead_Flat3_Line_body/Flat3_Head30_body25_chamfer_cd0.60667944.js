...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body25_chamfer_cd0.60667944.js
//         On: 06/30/19, 20:58:00
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 28.74826060, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.55115108, 10.00000000);
  p.Ln49 = Line(34.67964994, 9.55150992, 30.72755875, 4.01858224);
  p.Cr50 = ArcCtrEdge(
              35.55115108, 8.92900910,
              35.55115108, 10.00000000,
              34.67964994, 9.55150992);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              28.74826060, 5.43236663,
              28.74826060, 3.00000000,
              30.72755875, 4.01858224);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.55115108, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.67964994, 9.55150992, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 28.74826060, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.72755875, 4.01858224, 
  ...
  CoincidentCon(p.Ln46.End, 35.55115108, 10.00000000, 
                p.Cr50.Base, 35.55115108, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.67964994, 9.55150992, 
                p.Cr50.End, 34.67964994, 9.55150992);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 28.74826060, 3.00000000, 
                p.Cr52.Base, 28.74826060, 3.00000000);
  CoincidentCon(p.Ln49.End, 30.72755875, 4.01858224, 
                p.Cr52.End, 30.72755875, 4.01858224);
}
