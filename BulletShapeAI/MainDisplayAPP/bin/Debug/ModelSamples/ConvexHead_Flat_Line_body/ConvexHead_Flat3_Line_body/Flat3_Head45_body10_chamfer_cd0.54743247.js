...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body10_cd0.54743247.js
//         On: 06/30/19, 20:11:27
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(45.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 43.71345526, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 51.28654474, 10.00000000);
  p.Ln49 = Line(49.25221106, 8.95309548, 45.74778894, 4.04690452);
  p.Cr50 = ArcCtrEdge(
              51.28654474, 7.50000000,
              51.28654474, 10.00000000,
              49.25221106, 8.95309548);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              43.71345526, 5.50000000,
              43.71345526, 3.00000000,
              45.74778894, 4.04690452);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 45.00000000, 3.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 51.28654474, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.25221106, 8.95309548, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 43.71345526, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 45.74778894, 4.04690452, 
  ...
  CoincidentCon(p.Ln46.End, 51.28654474, 10.00000000, 
                p.Cr50.Base, 51.28654474, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.25221106, 8.95309548, 
                p.Cr50.End, 49.25221106, 8.95309548);
  CoincidentCon(p.Pt114, 45.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 45.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 43.71345526, 3.00000000, 
                p.Cr52.Base, 43.71345526, 3.00000000);
  CoincidentCon(p.Ln49.End, 45.74778894, 4.04690452, 
                p.Cr52.End, 45.74778894, 4.04690452);
}
