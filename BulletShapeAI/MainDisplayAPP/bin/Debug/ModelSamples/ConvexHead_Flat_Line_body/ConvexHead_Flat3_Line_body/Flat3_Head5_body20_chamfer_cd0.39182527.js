...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body20_chamfer_cd0.39182527.js
//         On: 06/30/19, 20:57:17
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.81038110, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.12094021, 10.00000000);
  p.Ln49 = Line(39.88140836, 9.97628167, 5.18593663, 3.03718733);
  p.Cr50 = ArcCtrEdge(
              40.12094021, 8.77862243,
              40.12094021, 10.00000000,
              39.88140836, 9.97628167);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.81038110, 4.91496495,
              4.81038110, 3.00000000,
              5.18593663, 3.03718733);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.12094021, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.88140836, 9.97628167, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.81038110, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.18593663, 3.03718733, 
  ...
  CoincidentCon(p.Ln46.End, 40.12094021, 10.00000000, 
                p.Cr50.Base, 40.12094021, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.88140836, 9.97628167, 
                p.Cr50.End, 39.88140836, 9.97628167);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.81038110, 3.00000000, 
                p.Cr52.Base, 4.81038110, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.18593663, 3.03718733, 
                p.Cr52.End, 5.18593663, 3.03718733);
}
