...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body10_chamfer_cd0.44763.js
//         On: 06/30/19, 20:17:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(35.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 34.44537666, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.55462334, 10.00000000);
  p.Ln49 = Line(49.49740968, 9.76545785, 35.50259032, 3.23454215);
  p.Cr50 = ArcCtrEdge(
              50.55462334, 7.50000000,
              50.55462334, 10.00000000,
              49.49740968, 9.76545785);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.44537666, 5.50000000,
              34.44537666, 3.00000000,
              35.50259032, 3.23454215);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 35.00000000, 3.00000000, 
    22.75834407, 4.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.55462334, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.49740968, 9.76545785, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.44537666, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.50259032, 3.23454215, 
  ...
  CoincidentCon(p.Ln46.End, 50.55462334, 10.00000000, 
                p.Cr50.Base, 50.55462334, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.49740968, 9.76545785, 
                p.Cr50.End, 49.49740968, 9.76545785);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.44537666, 3.00000000, 
                p.Cr52.Base, 34.44537666, 3.00000000);
  CoincidentCon(p.Ln49.End, 35.50259032, 3.23454215, 
                p.Cr52.End, 35.50259032, 3.23454215);
}
