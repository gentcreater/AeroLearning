...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body35_chamfer_cd0.43206683.js
//         On: 06/30/19, 21:10:30
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(10.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.43302964, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.08552647, 10.00000000);
  p.Ln49 = Line(24.92249736, 9.96383210, 10.51377898, 3.23976352);
  p.Cr50 = ArcCtrEdge(
              25.08552647, 9.61448400,
              25.08552647, 10.00000000,
              24.92249736, 9.96383210);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.43302964, 5.55565495,
              9.43302964, 3.00000000,
              10.51377898, 3.23976352);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 10.00000000, 3.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.08552647, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.92249736, 9.96383210, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.43302964, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.51377898, 3.23976352, 
  ...
  CoincidentCon(p.Ln46.End, 25.08552647, 10.00000000, 
                p.Cr50.Base, 25.08552647, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.92249736, 9.96383210, 
                p.Cr50.End, 24.92249736, 9.96383210);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.43302964, 3.00000000, 
                p.Cr52.Base, 9.43302964, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.51377898, 3.23976352, 
                p.Cr52.End, 10.51377898, 3.23976352);
}
