...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head25_body25_chamfer_cd0.52108214.js
//         On: 06/30/19, 20:58:28
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(25.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 24.23326396, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.33760014, 10.00000000);
  p.Ln49 = Line(34.72342719, 9.80639903, 25.62813464, 3.43969424);
  p.Cr50 = ArcCtrEdge(
              35.33760014, 8.92900910,
              35.33760014, 10.00000000,
              34.72342719, 9.80639903);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.23326396, 5.43236663,
              24.23326396, 3.00000000,
              25.62813464, 3.43969424);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 25.00000000, 3.00000000, 
    16.25596005, 4.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.33760014, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.72342719, 9.80639903, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.23326396, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.62813464, 3.43969424, 
  ...
  CoincidentCon(p.Ln46.End, 35.33760014, 10.00000000, 
                p.Cr50.Base, 35.33760014, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.72342719, 9.80639903, 
                p.Cr50.End, 34.72342719, 9.80639903);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.23326396, 3.00000000, 
                p.Cr52.Base, 24.23326396, 3.00000000);
  CoincidentCon(p.Ln49.End, 25.62813464, 3.43969424, 
                p.Cr52.End, 25.62813464, 3.43969424);
}
