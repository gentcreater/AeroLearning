...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body15_chamfer_cd0.47348171.js
//         On: 06/30/19, 20:48:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 29.55428486, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.44571514, 10.00000000);
  p.Ln49 = Line(44.59610045, 9.81151354, 30.40389955, 3.18848646);
  p.Cr50 = ArcCtrEdge(
              45.44571514, 7.99091064,
              45.44571514, 10.00000000,
              44.59610045, 9.81151354);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.55428486, 5.00908936,
              29.55428486, 3.00000000,
              30.40389955, 3.18848646);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.44571514, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.59610045, 9.81151354, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.55428486, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.40389955, 3.18848646, 
  ...
  CoincidentCon(p.Ln46.End, 45.44571514, 10.00000000, 
                p.Cr50.Base, 45.44571514, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.59610045, 9.81151354, 
                p.Cr50.End, 44.59610045, 9.81151354);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.55428486, 3.00000000, 
                p.Cr52.Base, 29.55428486, 3.00000000);
  CoincidentCon(p.Ln49.End, 30.40389955, 3.18848646, 
                p.Cr52.End, 30.40389955, 3.18848646);
}
