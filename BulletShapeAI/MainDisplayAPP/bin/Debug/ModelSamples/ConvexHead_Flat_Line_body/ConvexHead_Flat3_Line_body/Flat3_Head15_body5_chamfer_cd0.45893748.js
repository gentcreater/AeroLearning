...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head15_body5_cd0.45893748.js
//         On: 06/30/19, 20:10:04
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 14.78289964, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.21710036, 10.00000000);
  p.Ln49 = Line(54.78614953, 9.96257617, 15.21385047, 3.03742383);
  p.Cr50 = ArcCtrEdge(
              55.21710036, 7.50000000,
              55.21710036, 10.00000000,
              54.78614953, 9.96257617);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.78289964, 5.50000000,
              14.78289964, 3.00000000,
              15.21385047, 3.03742383);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.21710036, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.78614953, 9.96257617, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.78289964, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.21385047, 3.03742383, 
  ...
  CoincidentCon(p.Ln46.End, 55.21710036, 10.00000000, 
                p.Cr50.Base, 55.21710036, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.78614953, 9.96257617, 
                p.Cr50.End, 54.78614953, 9.96257617);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.78289964, 3.00000000, 
                p.Cr52.Base, 14.78289964, 3.00000000);
  CoincidentCon(p.Ln49.End, 15.21385047, 3.03742383, 
                p.Cr52.End, 15.21385047, 3.03742383);
}
