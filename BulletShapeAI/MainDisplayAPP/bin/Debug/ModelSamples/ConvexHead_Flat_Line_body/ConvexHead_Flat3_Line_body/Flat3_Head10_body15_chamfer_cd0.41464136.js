...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body15_chamfer_cd0.41464136.js
//         On: 06/30/19, 20:51:15
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.80106095, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.19893905, 10.00000000);
  p.Ln49 = Line(44.80492421, 9.96098484, 10.19507579, 3.03901516);
  p.Cr50 = ArcCtrEdge(
              45.19893905, 7.99091064,
              45.19893905, 10.00000000,
              44.80492421, 9.96098484);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.80106095, 5.00908936,
              9.80106095, 3.00000000,
              10.19507579, 3.03901516);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.19893905, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.80492421, 9.96098484, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.80106095, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.19507579, 3.03901516, 
  ...
  CoincidentCon(p.Ln46.End, 45.19893905, 10.00000000, 
                p.Cr50.Base, 45.19893905, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.80492421, 9.96098484, 
                p.Cr50.End, 44.80492421, 9.96098484);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.80106095, 3.00000000, 
                p.Cr52.Base, 9.80106095, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.19507579, 3.03901516, 
                p.Cr52.End, 10.19507579, 3.03901516);
}
