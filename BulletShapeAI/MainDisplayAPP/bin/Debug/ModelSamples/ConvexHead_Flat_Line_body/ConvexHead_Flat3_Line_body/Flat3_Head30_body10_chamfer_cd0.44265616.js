...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head30_body10_chamfer_cd0.44265616.js
//         On: 06/30/19, 20:18:15
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(30.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 29.57513568, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.42486432, 10.00000000);
  p.Ln49 = Line(49.59898826, 9.85964589, 30.40101174, 3.14035411);
  p.Cr50 = ArcCtrEdge(
              50.42486432, 7.50000000,
              50.42486432, 10.00000000,
              49.59898826, 9.85964589);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.57513568, 5.50000000,
              29.57513568, 3.00000000,
              30.40101174, 3.14035411);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 30.00000000, 3.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.42486432, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.59898826, 9.85964589, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.57513568, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.40101174, 3.14035411, 
  ...
  CoincidentCon(p.Ln46.End, 50.42486432, 10.00000000, 
                p.Cr50.Base, 50.42486432, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.59898826, 9.85964589, 
                p.Cr50.End, 49.59898826, 9.85964589);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.57513568, 3.00000000, 
                p.Cr52.Base, 29.57513568, 3.00000000);
  CoincidentCon(p.Ln49.End, 30.40101174, 3.14035411, 
                p.Cr52.End, 30.40101174, 3.14035411);
}
