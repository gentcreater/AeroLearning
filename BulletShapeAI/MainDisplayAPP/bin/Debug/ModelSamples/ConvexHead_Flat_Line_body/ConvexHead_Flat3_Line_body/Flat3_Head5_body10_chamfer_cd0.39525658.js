...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body10_chamfer_cd0.39525658.js
//         On: 06/30/19, 20:47:05
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(5.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.80671780, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.19328220, 10.00000000);
  p.Ln49 = Line(49.80901468, 9.97029117, 5.19098532, 3.02970883);
  p.Cr50 = ArcCtrEdge(
              50.19328220, 7.50000000,
              50.19328220, 10.00000000,
              49.80901468, 9.97029117);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.80671780, 5.50000000,
              4.80671780, 3.00000000,
              5.19098532, 3.02970883);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt114, 5.00000000, 3.00000000, 
    3.25119201, 4.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.19328220, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.80901468, 9.97029117, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.80671780, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.19098532, 3.02970883, 
  ...
  CoincidentCon(p.Ln46.End, 50.19328220, 10.00000000, 
                p.Cr50.Base, 50.19328220, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.80901468, 9.97029117, 
                p.Cr50.End, 49.80901468, 9.97029117);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.80671780, 3.00000000, 
                p.Cr52.Base, 4.80671780, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.19098532, 3.02970883, 
                p.Cr52.End, 5.19098532, 3.02970883);
}
