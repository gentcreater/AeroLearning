...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body5_cd0.40870262.js
//         On: 06/30/19, 20:10:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 4.82584920, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.17415080, 10.00000000);
  p.Ln49 = Line(54.82753119, 9.97585437, 5.17246881, 3.02414563);
  p.Cr50 = ArcCtrEdge(
              55.17415080, 7.50000000,
              55.17415080, 10.00000000,
              54.82753119, 9.97585437);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.82584920, 5.50000000,
              4.82584920, 3.00000000,
              5.17246881, 3.02414563);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.17415080, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.82753119, 9.97585437, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.82584920, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.17246881, 3.02414563, 
  ...
  CoincidentCon(p.Ln46.End, 55.17415080, 10.00000000, 
                p.Cr50.Base, 55.17415080, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.82753119, 9.97585437, 
                p.Cr50.End, 54.82753119, 9.97585437);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.82584920, 3.00000000, 
                p.Cr52.Base, 4.82584920, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.17246881, 3.02414563, 
                p.Cr52.End, 5.17246881, 3.02414563);
}
