...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body20_chamfer_cd0.4195736.js
//         On: 06/30/19, 20:56:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.77954825, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.14060561, 10.00000000);
  p.Ln49 = Line(39.86307246, 9.96805024, 10.21468500, 3.05009317);
  p.Cr50 = ArcCtrEdge(
              40.14060561, 8.77862243,
              40.14060561, 10.00000000,
              39.86307246, 9.96805024);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.77954825, 4.91496495,
              9.77954825, 3.00000000,
              10.21468500, 3.05009317);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.14060561, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.86307246, 9.96805024, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.77954825, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.21468500, 3.05009317, 
  ...
  CoincidentCon(p.Ln46.End, 40.14060561, 10.00000000, 
                p.Cr50.Base, 40.14060561, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.86307246, 9.96805024, 
                p.Cr50.End, 39.86307246, 9.96805024);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.77954825, 3.00000000, 
                p.Cr52.Base, 9.77954825, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.21468500, 3.05009317, 
                p.Cr52.End, 10.21468500, 3.05009317);
}
