...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head20_body35_chamfer_cd0.83767644.js
//         On: 06/30/19, 21:09:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 18.68481423, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.19839343, 10.00000000);
  p.Ln49 = Line(24.88468616, 9.83856062, 20.76443620, 4.07021068);
  p.Cr50 = ArcCtrEdge(
              25.19839343, 9.61448400,
              25.19839343, 10.00000000,
              24.88468616, 9.83856062);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              18.68481423, 5.55565495,
              18.68481423, 3.00000000,
              20.76443620, 4.07021068);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.19839343, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.88468616, 9.83856062, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 18.68481423, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.76443620, 4.07021068, 
  ...
  CoincidentCon(p.Ln46.End, 25.19839343, 10.00000000, 
                p.Cr50.Base, 25.19839343, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.88468616, 9.83856062, 
                p.Cr50.End, 24.88468616, 9.83856062);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 18.68481423, 3.00000000, 
                p.Cr52.Base, 18.68481423, 3.00000000);
  CoincidentCon(p.Ln49.End, 20.76443620, 4.07021068, 
                p.Cr52.End, 20.76443620, 4.07021068);
}
