...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head40_body10_chamfer_cd0.49634276.js
//         On: 06/30/19, 20:16:47
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 39.21194442, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.78805558, 10.00000000);
  p.Ln49 = Line(49.35439972, 9.54807980, 40.64560028, 3.45192020);
  p.Cr50 = ArcCtrEdge(
              50.78805558, 7.50000000,
              50.78805558, 10.00000000,
              49.35439972, 9.54807980);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.21194442, 5.50000000,
              39.21194442, 3.00000000,
              40.64560028, 3.45192020);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.78805558, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.35439972, 9.54807980, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.21194442, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.64560028, 3.45192020, 
  ...
  CoincidentCon(p.Ln46.End, 50.78805558, 10.00000000, 
                p.Cr50.Base, 50.78805558, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.35439972, 9.54807980, 
                p.Cr50.End, 49.35439972, 9.54807980);
  CoincidentCon(p.Pt114, 40.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.21194442, 3.00000000, 
                p.Cr52.Base, 39.21194442, 3.00000000);
  CoincidentCon(p.Ln49.End, 40.64560028, 3.45192020, 
                p.Cr52.End, 40.64560028, 3.45192020);
}
