...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head5_body50_chamfer_cd0.83114199.js
//         On: 06/30/19, 21:15:30
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 3.51963508, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 10.10294201, 10.00000000);
  p.Ln49 = Line(9.94016617, 9.91623264, 5.86044463, 4.20462248);
  p.Cr50 = ArcCtrEdge(
              10.10294201, 9.79996418,
              10.10294201, 10.00000000,
              9.94016617, 9.91623264);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              3.51963508, 5.87662931,
              3.51963508, 3.00000000,
              5.86044463, 4.20462248);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 10.10294201, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 9.94016617, 9.91623264, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 3.51963508, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.86044463, 4.20462248, 
  ...
  CoincidentCon(p.Ln46.End, 10.10294201, 10.00000000, 
                p.Cr50.Base, 10.10294201, 10.00000000);
  CoincidentCon(p.Ln49.Base, 9.94016617, 9.91623264, 
                p.Cr50.End, 9.94016617, 9.91623264);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 3.51963508, 3.00000000, 
                p.Cr52.Base, 3.51963508, 3.00000000);
  CoincidentCon(p.Ln49.End, 5.86044463, 4.20462248, 
                p.Cr52.End, 5.86044463, 4.20462248);
}
