...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head10_body40_chamfer_cd0.48113042.js
//         On: 06/30/19, 21:13:32
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 9.15170152, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.09416213, 10.00000000);
  p.Ln49 = Line(19.92285937, 9.94600156, 10.69495319, 3.48646723);
  p.Cr50 = ArcCtrEdge(
              20.09416213, 9.70128333,
              20.09416213, 10.00000000,
              19.92285937, 9.94600156);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.15170152, 5.69111248,
              9.15170152, 3.00000000,
              10.69495319, 3.48646723);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.09416213, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.92285937, 9.94600156, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.15170152, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.69495319, 3.48646723, 
  ...
  CoincidentCon(p.Ln46.End, 20.09416213, 10.00000000, 
                p.Cr50.Base, 20.09416213, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.92285937, 9.94600156, 
                p.Cr50.End, 19.92285937, 9.94600156);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.15170152, 3.00000000, 
                p.Cr52.Base, 9.15170152, 3.00000000);
  CoincidentCon(p.Ln49.End, 10.69495319, 3.48646723, 
                p.Cr52.End, 10.69495319, 3.48646723);
}
