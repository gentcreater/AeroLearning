...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat3_Line_body\Flat3_Head35_body5_cd0.46983904.js
//         On: 06/30/19, 20:08:18
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 34.57513568, 3.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.42486432, 10.00000000);
  p.Ln49 = Line(54.59898826, 9.85964589, 35.40101174, 3.14035411);
  p.Cr50 = ArcCtrEdge(
              55.42486432, 7.50000000,
              55.42486432, 10.00000000,
              54.59898826, 9.85964589);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.57513568, 5.50000000,
              34.57513568, 3.00000000,
              35.40101174, 3.14035411);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.42486432, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.59898826, 9.85964589, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.57513568, 3.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.40101174, 3.14035411, 
  ...
  CoincidentCon(p.Ln46.End, 55.42486432, 10.00000000, 
                p.Cr50.Base, 55.42486432, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.59898826, 9.85964589, 
                p.Cr50.End, 54.59898826, 9.85964589);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 3.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.57513568, 3.00000000, 
                p.Cr52.Base, 34.57513568, 3.00000000);
  CoincidentCon(p.Ln49.End, 35.40101174, 3.14035411, 
                p.Cr52.End, 35.40101174, 3.14035411);
}
