...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head35_body10_chamfer_cd0.94955561.js
//         On: 07/04/19, 19:17:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(35.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 34.75245122, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.24754878, 10.00000000);
  p.Ln49 = Line(49.75725845, 9.95145169, 35.24274155, 7.04854831);
  p.Cr50 = ArcCtrEdge(
  ...
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.75245122, 9.50000000,
              34.75245122, 7.00000000,
              35.24274155, 7.04854831);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 35.00000000, 7.00000000, 
    22.75834407, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  TangentCon(p.Cr52, 34.75245122, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.24274155, 7.04854831, 
  ...
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.75245122, 7.00000000, 
                p.Cr52.Base, 34.75245122, 7.00000000);
  CoincidentCon(p.Ln49.End, 35.24274155, 7.04854831, 
                p.Cr52.End, 35.24274155, 7.04854831);
}
