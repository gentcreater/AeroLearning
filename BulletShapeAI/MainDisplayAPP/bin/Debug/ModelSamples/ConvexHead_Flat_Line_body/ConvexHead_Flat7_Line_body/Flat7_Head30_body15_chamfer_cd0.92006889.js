...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head30_body15_chamfer_cd0.92006889.js
//         On: 07/04/19, 19:21:47
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 29.90853308, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.09146692, 10.00000000);
  p.Ln49 = Line(44.91030930, 9.98206186, 30.08969070, 7.01793814);
  p.Cr50 = ArcCtrEdge(
              45.09146692, 9.07627376,
              45.09146692, 10.00000000,
              44.91030930, 9.98206186);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.90853308, 7.92372624,
              29.90853308, 7.00000000,
              30.08969070, 7.01793814);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.09146692, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.91030930, 9.98206186, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.90853308, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.08969070, 7.01793814, 
  ...
  CoincidentCon(p.Ln46.End, 45.09146692, 10.00000000, 
                p.Cr50.Base, 45.09146692, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.91030930, 9.98206186, 
                p.Cr50.End, 44.91030930, 9.98206186);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.90853308, 7.00000000, 
                p.Cr52.Base, 29.90853308, 7.00000000);
  CoincidentCon(p.Ln49.End, 30.08969070, 7.01793814, 
                p.Cr52.End, 30.08969070, 7.01793814);
}
