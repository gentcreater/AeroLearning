...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body5_chamfer_cd0.87870108.js
//         On: 07/04/19, 19:15:14
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.90638147, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.09361853, 10.00000000);
  p.Ln49 = Line(54.90664366, 9.99299827, 15.09335634, 7.00700173);
  p.Cr50 = ArcCtrEdge(
              55.09361853, 7.50000000,
              55.09361853, 10.00000000,
              54.90664366, 9.99299827);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.90638147, 9.50000000,
              14.90638147, 7.00000000,
              15.09335634, 7.00700173);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.09361853, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.90664366, 9.99299827, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.90638147, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.09335634, 7.00700173, 
  ...
  CoincidentCon(p.Ln46.End, 55.09361853, 10.00000000, 
                p.Cr50.Base, 55.09361853, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.90664366, 9.99299827, 
                p.Cr50.End, 54.90664366, 9.99299827);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.90638147, 7.00000000, 
                p.Cr52.Base, 14.90638147, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.09335634, 7.00700173, 
                p.Cr52.End, 15.09335634, 7.00700173);
}
