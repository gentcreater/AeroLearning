...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body25_chamfer_cd0.80833294.js
//         On: 07/04/19, 19:29:18
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.91965111, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.01378171, 10.00000000);
  p.Ln49 = Line(34.98637076, 9.99795561, 15.07945993, 7.01191899);
  p.Cr50 = ArcCtrEdge(
              35.01378171, 9.81521593,
              35.01378171, 10.00000000,
              34.98637076, 9.99795561);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.91965111, 8.07731112,
              14.91965111, 7.00000000,
              15.07945993, 7.01191899);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.01378171, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.98637076, 9.99795561, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.91965111, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.07945993, 7.01191899, 
  ...
  CoincidentCon(p.Ln46.End, 35.01378171, 10.00000000, 
                p.Cr50.Base, 35.01378171, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.98637076, 9.99795561, 
                p.Cr50.End, 34.98637076, 9.99795561);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.91965111, 7.00000000, 
                p.Cr52.Base, 14.91965111, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.07945993, 7.01191899, 
                p.Cr52.End, 15.07945993, 7.01191899);
}
