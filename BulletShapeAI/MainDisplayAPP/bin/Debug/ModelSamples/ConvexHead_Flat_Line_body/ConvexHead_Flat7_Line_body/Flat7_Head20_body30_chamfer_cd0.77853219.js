...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body30_chamfer_cd0.77853219.js
//         On: 07/04/19, 19:31:21
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.82933814, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.01743132, 10.00000000);
  p.Ln49 = Line(29.98330382, 9.99499115, 20.16346442, 7.04903933);
  p.Cr50 = ArcCtrEdge(
              30.01743132, 9.88123279,
              30.01743132, 10.00000000,
              29.98330382, 9.99499115);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.82933814, 8.16279359,
              19.82933814, 7.00000000,
              20.16346442, 7.04903933);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.01743132, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.98330382, 9.99499115, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.82933814, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.16346442, 7.04903933, 
  ...
  CoincidentCon(p.Ln46.End, 30.01743132, 10.00000000, 
                p.Cr50.Base, 30.01743132, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.98330382, 9.99499115, 
                p.Cr50.End, 29.98330382, 9.99499115);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.82933814, 7.00000000, 
                p.Cr52.Base, 19.82933814, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.16346442, 7.04903933, 
                p.Cr52.End, 20.16346442, 7.04903933);
}
