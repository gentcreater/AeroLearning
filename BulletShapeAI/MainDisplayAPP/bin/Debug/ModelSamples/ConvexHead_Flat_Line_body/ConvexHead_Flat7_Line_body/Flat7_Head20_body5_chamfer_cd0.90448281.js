...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body5_chamfer_cd0.90448281.js
//         On: 07/04/19, 19:14:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.89305322, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.10694678, 10.00000000);
  p.Ln49 = Line(54.89344393, 9.99086662, 20.10655607, 7.00913338);
  p.Cr50 = ArcCtrEdge(
              55.10694678, 7.50000000,
              55.10694678, 10.00000000,
              54.89344393, 9.99086662);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.89305322, 9.50000000,
              19.89305322, 7.00000000,
              20.10655607, 7.00913338);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.10694678, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.89344393, 9.99086662, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.89305322, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.10655607, 7.00913338, 
  ...
  CoincidentCon(p.Ln46.End, 55.10694678, 10.00000000, 
                p.Cr50.Base, 55.10694678, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.89344393, 9.99086662, 
                p.Cr50.End, 54.89344393, 9.99086662);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.89305322, 7.00000000, 
                p.Cr52.Base, 19.89305322, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.10655607, 7.00913338, 
                p.Cr52.End, 20.10655607, 7.00913338);
}
