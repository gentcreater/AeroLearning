...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body15_chamfer_cd0.90272916.js
//         On: 07/04/19, 19:22:11
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.93110591, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.06889409, 10.00000000);
  p.Ln49 = Line(44.93186813, 9.98978022, 25.06813187, 7.01021978);
  p.Cr50 = ArcCtrEdge(
              45.06889409, 9.07627376,
              45.06889409, 10.00000000,
              44.93186813, 9.98978022);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.93110591, 7.92372624,
              24.93110591, 7.00000000,
              25.06813187, 7.01021978);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.06889409, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.93186813, 9.98978022, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.93110591, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.06813187, 7.01021978, 
  ...
  CoincidentCon(p.Ln46.End, 45.06889409, 10.00000000, 
                p.Cr50.Base, 45.06889409, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.93186813, 9.98978022, 
                p.Cr50.End, 44.93186813, 9.98978022);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.93110591, 7.00000000, 
                p.Cr52.Base, 24.93110591, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.06813187, 7.01021978, 
                p.Cr52.End, 25.06813187, 7.01021978);
}
