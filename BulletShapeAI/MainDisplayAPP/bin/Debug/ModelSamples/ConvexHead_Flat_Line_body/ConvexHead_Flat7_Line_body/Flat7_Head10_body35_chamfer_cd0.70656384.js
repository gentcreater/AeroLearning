...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body35_chamfer_cd0.70656384.js
//         On: 07/04/19, 19:34:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(10.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.87907685, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.00840998, 10.00000000);
  p.Ln49 = Line(24.99175333, 9.99835067, 10.11857490, 7.02371498);
  p.Cr50 = ArcCtrEdge(
              25.00840998, 9.91506743,
              25.00840998, 10.00000000,
              24.99175333, 9.99835067);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.87907685, 8.22120522,
              9.87907685, 7.00000000,
              10.11857490, 7.02371498);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 10.00000000, 7.00000000, 
    6.50238402, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.00840998, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.99175333, 9.99835067, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.87907685, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.11857490, 7.02371498, 
  ...
  CoincidentCon(p.Ln46.End, 25.00840998, 10.00000000, 
                p.Cr50.Base, 25.00840998, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.99175333, 9.99835067, 
                p.Cr50.End, 24.99175333, 9.99835067);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.87907685, 7.00000000, 
                p.Cr52.Base, 9.87907685, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.11857490, 7.02371498, 
                p.Cr52.End, 10.11857490, 7.02371498);
}
