...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body30_chamfer_cd0.77135527.js
//         On: 07/04/19, 19:31:45
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.88486074, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.01176027, 10.00000000);
  p.Ln49 = Line(29.98846811, 9.99769362, 15.11290333, 7.02258067);
  p.Cr50 = ArcCtrEdge(
              30.01176027, 9.88123279,
              30.01176027, 10.00000000,
              29.98846811, 9.99769362);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.88486074, 8.16279359,
              14.88486074, 7.00000000,
              15.11290333, 7.02258067);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.01176027, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.98846811, 9.99769362, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.88486074, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.11290333, 7.02258067, 
  ...
  CoincidentCon(p.Ln46.End, 30.01176027, 10.00000000, 
                p.Cr50.Base, 30.01176027, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.98846811, 9.99769362, 
                p.Cr50.End, 29.98846811, 9.99769362);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.88486074, 7.00000000, 
                p.Cr52.Base, 14.88486074, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.11290333, 7.02258067, 
                p.Cr52.End, 15.11290333, 7.02258067);
}
