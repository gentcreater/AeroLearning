...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head30_body25_chamfer_cd0.88027093.js
//         On: 07/04/19, 19:27:54
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(30.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 29.32627345, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.29664731, 10.00000000);
  p.Ln49 = Line(34.74562703, 9.84737622, 30.57771575, 7.34662945);
  p.Cr50 = ArcCtrEdge(
              35.29664731, 8.92900910,
              35.29664731, 10.00000000,
              34.74562703, 9.84737622);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.32627345, 9.43236663,
              29.32627345, 7.00000000,
              30.57771575, 7.34662945);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 30.00000000, 7.00000000, 
    19.50715206, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.29664731, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.74562703, 9.84737622, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.32627345, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.57771575, 7.34662945, 
  ...
  CoincidentCon(p.Ln46.End, 35.29664731, 10.00000000, 
                p.Cr50.Base, 35.29664731, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.74562703, 9.84737622, 
                p.Cr50.End, 34.74562703, 9.84737622);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.32627345, 7.00000000, 
                p.Cr52.Base, 29.32627345, 7.00000000);
  CoincidentCon(p.Ln49.End, 30.57771575, 7.34662945, 
                p.Cr52.End, 30.57771575, 7.34662945);
}
