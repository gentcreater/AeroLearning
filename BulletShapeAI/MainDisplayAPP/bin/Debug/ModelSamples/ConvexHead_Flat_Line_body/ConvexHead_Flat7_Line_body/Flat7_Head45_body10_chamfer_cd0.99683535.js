...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head45_body10_chamfer_cd0.99683535.js
//         On: 07/04/19, 19:16:44
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(45.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 44.30754009, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.69245991, 10.00000000);
  p.Ln49 = Line(49.40622052, 9.64373231, 45.59377948, 7.35626769);
  p.Cr50 = ArcCtrEdge(
              50.69245991, 7.50000000,
              50.69245991, 10.00000000,
              49.40622052, 9.64373231);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              44.30754009, 9.50000000,
              44.30754009, 7.00000000,
              45.59377948, 7.35626769);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 45.00000000, 7.00000000, 
    29.26072809, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.69245991, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.40622052, 9.64373231, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 44.30754009, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 45.59377948, 7.35626769, 
  ...
  CoincidentCon(p.Ln46.End, 50.69245991, 10.00000000, 
                p.Cr50.Base, 50.69245991, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.40622052, 9.64373231, 
                p.Cr50.End, 49.40622052, 9.64373231);
  CoincidentCon(p.Pt114, 45.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 45.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.30754009, 7.00000000, 
                p.Cr52.Base, 44.30754009, 7.00000000);
  CoincidentCon(p.Ln49.End, 45.59377948, 7.35626769, 
                p.Cr52.End, 45.59377948, 7.35626769);
}
