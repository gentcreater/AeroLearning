...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body5_chamfer_cd0.84095395.js
//         On: 07/04/19, 19:16:13
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.92506738, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.07493262, 10.00000000);
  p.Ln49 = Line(54.92520189, 9.99551211, 5.07479811, 7.00448789);
  p.Cr50 = ArcCtrEdge(
              55.07493262, 7.50000000,
              55.07493262, 10.00000000,
              54.92520189, 9.99551211);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.92506738, 9.50000000,
              4.92506738, 7.00000000,
              5.07479811, 7.00448789);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.07493262, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.92520189, 9.99551211, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.92506738, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.07479811, 7.00448789, 
  ...
  CoincidentCon(p.Ln46.End, 55.07493262, 10.00000000, 
                p.Cr50.Base, 55.07493262, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.92520189, 9.99551211, 
                p.Cr50.End, 54.92520189, 9.99551211);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.92506738, 7.00000000, 
                p.Cr52.Base, 4.92506738, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.07479811, 7.00448789, 
                p.Cr52.End, 5.07479811, 7.00448789);
}
