...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body30_chamfer_cd0.74166109.js
//         On: 07/04/19, 19:32:11
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.91327559, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.00885799, 10.00000000);
  p.Ln49 = Line(29.99124001, 9.99868600, 10.08576492, 7.01286474);
  p.Cr50 = ArcCtrEdge(
              30.00885799, 9.88123279,
              30.00885799, 10.00000000,
              29.99124001, 9.99868600);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.91327559, 8.16279359,
              9.91327559, 7.00000000,
              10.08576492, 7.01286474);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.00885799, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.99124001, 9.99868600, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.91327559, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.08576492, 7.01286474, 
  ...
  CoincidentCon(p.Ln46.End, 30.00885799, 10.00000000, 
                p.Cr50.Base, 30.00885799, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.99124001, 9.99868600, 
                p.Cr50.End, 29.99124001, 9.99868600);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.91327559, 7.00000000, 
                p.Cr52.Base, 9.91327559, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.08576492, 7.01286474, 
                p.Cr52.End, 10.08576492, 7.01286474);
}
