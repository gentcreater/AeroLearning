...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body20_chamfer_cd0.82569989.js
//         On: 07/04/19, 19:26:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.94298710, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.02068939, 10.00000000);
  p.Ln49 = Line(39.97945798, 9.99753496, 15.05660679, 7.00679282);
  p.Cr50 = ArcCtrEdge(
              40.02068939, 9.65393983,
              40.02068939, 10.00000000,
              39.97945798, 9.99753496);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.94298710, 7.95362362,
              14.94298710, 7.00000000,
              15.05660679, 7.00679282);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.02068939, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.97945798, 9.99753496, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.94298710, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.05660679, 7.00679282, 
  ...
  CoincidentCon(p.Ln46.End, 40.02068939, 10.00000000, 
                p.Cr50.Base, 40.02068939, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.97945798, 9.99753496, 
                p.Cr50.End, 39.97945798, 9.99753496);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.94298710, 7.00000000, 
                p.Cr52.Base, 14.94298710, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.05660679, 7.00679282, 
                p.Cr52.End, 15.05660679, 7.00679282);
}
