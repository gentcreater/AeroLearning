...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body30_chamfer_cd0.79622397.js
//         On: 07/04/19, 19:30:53
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.23856668, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.21149207, 10.00000000);
  p.Ln49 = Line(29.81864705, 9.89118823, 25.65292368, 7.39175421);
  p.Cr50 = ArcCtrEdge(
              30.21149207, 9.23644652,
              30.21149207, 10.00000000,
              29.81864705, 9.89118823);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.23856668, 9.74901587,
              24.23856668, 7.00000000,
              25.65292368, 7.39175421);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.21149207, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.81864705, 9.89118823, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.23856668, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.65292368, 7.39175421, 
  ...
  CoincidentCon(p.Ln46.End, 30.21149207, 10.00000000, 
                p.Cr50.Base, 30.21149207, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.81864705, 9.89118823, 
                p.Cr50.End, 29.81864705, 9.89118823);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.23856668, 7.00000000, 
                p.Cr52.Base, 24.23856668, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.65292368, 7.39175421, 
                p.Cr52.End, 25.65292368, 7.39175421);
}
