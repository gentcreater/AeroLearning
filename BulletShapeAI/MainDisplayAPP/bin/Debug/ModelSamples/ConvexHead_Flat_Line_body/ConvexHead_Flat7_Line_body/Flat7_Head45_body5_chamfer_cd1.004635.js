...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head45_body5_chamfer_cd1.004635.js
//         On: 07/04/19, 19:12:29
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 44.63307791, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.36692209, 10.00000000);
  p.Ln49 = Line(54.64855238, 9.89456571, 45.35144762, 7.10543429);
  p.Cr50 = ArcCtrEdge(
              55.36692209, 7.50000000,
              55.36692209, 10.00000000,
              54.64855238, 9.89456571);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              44.63307791, 9.50000000,
              44.63307791, 7.00000000,
              45.35144762, 7.10543429);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.36692209, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.64855238, 9.89456571, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 44.63307791, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 45.35144762, 7.10543429, 
  ...
  CoincidentCon(p.Ln46.End, 55.36692209, 10.00000000, 
                p.Cr50.Base, 55.36692209, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.64855238, 9.89456571, 
                p.Cr50.End, 54.64855238, 9.89456571);
  CoincidentCon(p.Pt114, 45.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 45.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.63307791, 7.00000000, 
                p.Cr52.Base, 44.63307791, 7.00000000);
  CoincidentCon(p.Ln49.End, 45.35144762, 7.10543429, 
                p.Cr52.End, 45.35144762, 7.10543429);
}
