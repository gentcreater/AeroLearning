...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body5_chamfer_cd0.85787416.js
//         On: 07/04/19, 19:15:41
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.91675905, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.08324095, 10.00000000);
  p.Ln49 = Line(54.91694342, 9.99446289, 10.08305658, 7.00553711);
  p.Cr50 = ArcCtrEdge(
              55.08324095, 7.50000000,
              55.08324095, 10.00000000,
              54.91694342, 9.99446289);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.91675905, 9.50000000,
              9.91675905, 7.00000000,
              10.08305658, 7.00553711);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.08324095, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.91694342, 9.99446289, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.91675905, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.08305658, 7.00553711, 
  ...
  CoincidentCon(p.Ln46.End, 55.08324095, 10.00000000, 
                p.Cr50.Base, 55.08324095, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.91694342, 9.99446289, 
                p.Cr50.End, 54.91694342, 9.99446289);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.91675905, 7.00000000, 
                p.Cr52.Base, 9.91675905, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.08305658, 7.00553711, 
                p.Cr52.End, 10.08305658, 7.00553711);
}
