...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body45_chamfer_cd0.57009668.js
//         On: 07/04/19, 19:36:42
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.64157985, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.01443628, 10.00000000);
  p.Ln49 = Line(14.98762099, 9.99257260, 10.30734275, 7.18440565);
  p.Cr50 = ArcCtrEdge(
              15.01443628, 9.94788045,
              15.01443628, 10.00000000,
              14.98762099, 9.99257260);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.64157985, 8.29401048,
              9.64157985, 7.00000000,
              10.30734275, 7.18440565);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.01443628, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.98762099, 9.99257260, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.64157985, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.30734275, 7.18440565, 
  ...
  CoincidentCon(p.Ln46.End, 15.01443628, 10.00000000, 
                p.Cr50.Base, 15.01443628, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.98762099, 9.99257260, 
                p.Cr50.End, 14.98762099, 9.99257260);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.64157985, 7.00000000, 
                p.Cr52.Base, 9.64157985, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.30734275, 7.18440565, 
                p.Cr52.End, 10.30734275, 7.18440565);
}
