...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head30_body5_chamfer_cd0.95557164.js
//         On: 07/04/19, 19:13:52
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 29.85053615, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.14946385, 10.00000000);
  p.Ln49 = Line(54.85160080, 9.98219210, 30.14839920, 7.01780790);
  p.Cr50 = ArcCtrEdge(
              55.14946385, 7.50000000,
              55.14946385, 10.00000000,
              54.85160080, 9.98219210);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.85053615, 9.50000000,
              29.85053615, 7.00000000,
              30.14839920, 7.01780790);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.14946385, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.85160080, 9.98219210, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.85053615, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.14839920, 7.01780790, 
  ...
  CoincidentCon(p.Ln46.End, 55.14946385, 10.00000000, 
                p.Cr50.Base, 55.14946385, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.85160080, 9.98219210, 
                p.Cr50.End, 54.85160080, 9.98219210);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.85053615, 7.00000000, 
                p.Cr52.Base, 29.85053615, 7.00000000);
  CoincidentCon(p.Ln49.End, 30.14839920, 7.01780790, 
                p.Cr52.End, 30.14839920, 7.01780790);
}
