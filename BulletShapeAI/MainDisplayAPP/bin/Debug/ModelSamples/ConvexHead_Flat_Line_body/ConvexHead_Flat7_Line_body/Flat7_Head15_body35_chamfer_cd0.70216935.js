...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body35_chamfer_cd0.70216935.js
//         On: 07/04/19, 19:33:34
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(15.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.82076513, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.01246545, 10.00000000);
  p.Ln49 = Line(24.98806026, 9.99641808, 15.17167587, 7.05150276);
  p.Cr50 = ArcCtrEdge(
              25.01246545, 9.91506743,
              25.01246545, 10.00000000,
              24.98806026, 9.99641808);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.82076513, 8.22120522,
              14.82076513, 7.00000000,
              15.17167587, 7.05150276);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 15.00000000, 7.00000000, 
    9.75357603, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.01246545, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.98806026, 9.99641808, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.82076513, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.17167587, 7.05150276, 
  ...
  CoincidentCon(p.Ln46.End, 25.01246545, 10.00000000, 
                p.Cr50.Base, 25.01246545, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.98806026, 9.99641808, 
                p.Cr50.End, 24.98806026, 9.99641808);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.82076513, 7.00000000, 
                p.Cr52.Base, 14.82076513, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.17167587, 7.05150276, 
                p.Cr52.End, 15.17167587, 7.05150276);
}
