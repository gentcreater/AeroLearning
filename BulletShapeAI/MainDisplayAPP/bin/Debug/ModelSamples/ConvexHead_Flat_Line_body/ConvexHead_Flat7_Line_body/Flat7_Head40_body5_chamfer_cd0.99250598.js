...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head40_body5_chamfer_cd0.99250598.js
//         On: 07/04/19, 19:12:57
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(55.00000000, 10.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 39.75245122, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.24754878, 10.00000000);
  p.Ln49 = Line(54.75725845, 9.95145169, 40.24274155, 7.04854831);
  p.Cr50 = ArcCtrEdge(
              55.24754878, 7.50000000,
              55.24754878, 10.00000000,
              54.75725845, 9.95145169);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.75245122, 9.50000000,
              39.75245122, 7.00000000,
              40.24274155, 7.04854831);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 55.00000000, 10.00000000, 
    58.39780094, 11.09884475);
  if(dim) dim.Name = "H21";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.24754878, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.75725845, 9.95145169, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.75245122, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.24274155, 7.04854831, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 55.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 55.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 55.24754878, 10.00000000, 
                p.Cr50.Base, 55.24754878, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.75725845, 9.95145169, 
                p.Cr50.End, 54.75725845, 9.95145169);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.75245122, 7.00000000, 
                p.Cr52.Base, 39.75245122, 7.00000000);
  CoincidentCon(p.Ln49.End, 40.24274155, 7.04854831, 
                p.Cr52.End, 40.24274155, 7.04854831);
}
