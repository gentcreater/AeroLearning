...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head40_body10_chamfer_cd0.99388591.js
//         On: 07/04/19, 19:17:12
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(40.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 39.63307791, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.36692209, 10.00000000);
  p.Ln49 = Line(49.64855238, 9.89456571, 40.35144762, 7.10543429);
  p.Cr50 = ArcCtrEdge(
              50.36692209, 7.50000000,
              50.36692209, 10.00000000,
              49.64855238, 9.89456571);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.63307791, 9.50000000,
              39.63307791, 7.00000000,
              40.35144762, 7.10543429);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 40.00000000, 7.00000000, 
    26.00953608, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.36692209, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.64855238, 9.89456571, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.63307791, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.35144762, 7.10543429, 
  ...
  CoincidentCon(p.Ln46.End, 50.36692209, 10.00000000, 
                p.Cr50.Base, 50.36692209, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.64855238, 9.89456571, 
                p.Cr50.End, 49.64855238, 9.89456571);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.63307791, 7.00000000, 
                p.Cr52.Base, 39.63307791, 7.00000000);
  CoincidentCon(p.Ln49.End, 40.35144762, 7.10543429, 
                p.Cr52.End, 40.35144762, 7.10543429);
}
