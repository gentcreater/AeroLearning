...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body20_chamfer_cd0.77629016.js
//         On: 07/04/19, 19:27:19
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.95920521, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.01480401, 10.00000000);
  p.Ln49 = Line(39.98525008, 9.99873572, 5.04064575, 7.00348392);
  p.Cr50 = ArcCtrEdge(
              40.01480401, 9.65393983,
              40.01480401, 10.00000000,
              39.98525008, 9.99873572);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.95920521, 7.95362362,
              4.95920521, 7.00000000,
              5.04064575, 7.00348392);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.01480401, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.98525008, 9.99873572, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.95920521, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.04064575, 7.00348392, 
  ...
  CoincidentCon(p.Ln46.End, 40.01480401, 10.00000000, 
                p.Cr50.Base, 40.01480401, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.98525008, 9.99873572, 
                p.Cr50.End, 39.98525008, 9.99873572);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.95920521, 7.00000000, 
                p.Cr52.Base, 4.95920521, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.04064575, 7.00348392, 
                p.Cr52.End, 5.04064575, 7.00348392);
}
