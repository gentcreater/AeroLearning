...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body25_chamfer_cd0.77639242.js
//         On: 07/04/19, 19:29:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.93559237, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.01104742, 10.00000000);
  p.Ln49 = Line(34.98903128, 9.99868375, 10.06394884, 7.00767386);
  p.Cr50 = ArcCtrEdge(
              35.01104742, 9.81521593,
              35.01104742, 10.00000000,
              34.98903128, 9.99868375);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.93559237, 8.07731112,
              9.93559237, 7.00000000,
              10.06394884, 7.00767386);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.01104742, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.98903128, 9.99868375, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.93559237, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.06394884, 7.00767386, 
  ...
  CoincidentCon(p.Ln46.End, 35.01104742, 10.00000000, 
                p.Cr50.Base, 35.01104742, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.98903128, 9.99868375, 
                p.Cr50.End, 34.98903128, 9.99868375);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.93559237, 7.00000000, 
                p.Cr52.Base, 9.93559237, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.06394884, 7.00767386, 
                p.Cr52.End, 10.06394884, 7.00767386);
}
