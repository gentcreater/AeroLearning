...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head35_body15_chamfer_cd0.94910387.js
//         On: 07/04/19, 19:21:21
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 34.67510459, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.32489541, 10.00000000);
  p.Ln49 = Line(44.68880663, 9.90664199, 35.31119337, 7.09335801);
  p.Cr50 = ArcCtrEdge(
              45.32489541, 7.78634607,
              45.32489541, 10.00000000,
              44.68880663, 9.90664199);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.67510459, 9.21365393,
              34.67510459, 7.00000000,
              35.31119337, 7.09335801);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.32489541, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.68880663, 9.90664199, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.67510459, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.31119337, 7.09335801, 
  ...
  CoincidentCon(p.Ln46.End, 45.32489541, 10.00000000, 
                p.Cr50.Base, 45.32489541, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.68880663, 9.90664199, 
                p.Cr50.End, 44.68880663, 9.90664199);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.67510459, 7.00000000, 
                p.Cr52.Base, 34.67510459, 7.00000000);
  CoincidentCon(p.Ln49.End, 35.31119337, 7.09335801, 
                p.Cr52.End, 35.31119337, 7.09335801);
}
