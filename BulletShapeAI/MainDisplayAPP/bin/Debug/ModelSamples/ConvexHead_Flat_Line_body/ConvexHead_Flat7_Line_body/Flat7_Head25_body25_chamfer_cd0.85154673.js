...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body25_chamfer_cd0.85154673.js
//         On: 07/04/19, 19:28:23
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.64300438, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.15718809, 10.00000000);
  p.Ln49 = Line(34.84944112, 9.95483234, 25.34193979, 7.10258194);
  p.Cr50 = ArcCtrEdge(
              35.15718809, 8.92900910,
              35.15718809, 10.00000000,
              34.84944112, 9.95483234);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.64300438, 9.43236663,
              24.64300438, 7.00000000,
              25.34193979, 7.10258194);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.15718809, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.84944112, 9.95483234, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.64300438, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.34193979, 7.10258194, 
  ...
  CoincidentCon(p.Ln46.End, 35.15718809, 10.00000000, 
                p.Cr50.Base, 35.15718809, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.84944112, 9.95483234, 
                p.Cr50.End, 34.84944112, 9.95483234);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.64300438, 7.00000000, 
                p.Cr52.Base, 24.64300438, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.34193979, 7.10258194, 
                p.Cr52.End, 25.34193979, 7.10258194);
}
