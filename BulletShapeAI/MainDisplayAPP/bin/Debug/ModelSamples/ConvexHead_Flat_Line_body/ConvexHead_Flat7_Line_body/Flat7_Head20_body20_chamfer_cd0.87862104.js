...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body20_chamfer_cd0.87862104.js
//         On: 07/04/19, 19:25:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.92887608, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.02581014, 10.00000000);
  p.Ln49 = Line(39.97447542, 9.99617131, 20.07033703, 7.01055056);
  p.Cr50 = ArcCtrEdge(
              40.02581014, 9.65393983,
              40.02581014, 10.00000000,
              39.97447542, 9.99617131);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.92887608, 7.95362362,
              19.92887608, 7.00000000,
              20.07033703, 7.01055056);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.02581014, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.97447542, 9.99617131, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.92887608, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.07033703, 7.01055056, 
  ...
  CoincidentCon(p.Ln46.End, 40.02581014, 10.00000000, 
                p.Cr50.Base, 40.02581014, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.97447542, 9.99617131, 
                p.Cr50.End, 39.97447542, 9.99617131);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.92887608, 7.00000000, 
                p.Cr52.Base, 19.92887608, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.07033703, 7.01055056, 
                p.Cr52.End, 20.07033703, 7.01055056);
}
