...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body40_chamfer_cd0.63097942.js
//         On: 07/04/19, 19:36:14
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.87494581, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.00643673, 10.00000000);
  p.Ln49 = Line(19.99368827, 9.99873765, 5.12262572, 7.02452514);
  p.Cr50 = ArcCtrEdge(
              20.00643673, 9.93499537,
              20.00643673, 10.00000000,
              19.99368827, 9.99873765);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.87494581, 8.26292473,
              4.87494581, 7.00000000,
              5.12262572, 7.02452514);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.00643673, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.99368827, 9.99873765, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.87494581, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.12262572, 7.02452514, 
  ...
  CoincidentCon(p.Ln46.End, 20.00643673, 10.00000000, 
                p.Cr50.Base, 20.00643673, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.99368827, 9.99873765, 
                p.Cr50.End, 19.99368827, 9.99873765);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.87494581, 7.00000000, 
                p.Cr52.Base, 4.87494581, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.12262572, 7.02452514, 
                p.Cr52.End, 5.12262572, 7.02452514);
}
