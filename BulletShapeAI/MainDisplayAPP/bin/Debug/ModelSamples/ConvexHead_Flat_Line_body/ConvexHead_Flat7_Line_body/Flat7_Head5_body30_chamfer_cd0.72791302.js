...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body30_chamfer_cd0.72791302.js
//         On: 07/04/19, 19:32:39
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.93048176, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 30.00710056, 10.00000000);
  p.Ln49 = Line(29.99295002, 9.99915400, 5.06902305, 7.00828277);
  p.Cr50 = ArcCtrEdge(
              30.00710056, 9.88123279,
              30.00710056, 10.00000000,
              29.99295002, 9.99915400);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.93048176, 8.16279359,
              4.93048176, 7.00000000,
              5.06902305, 7.00828277);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 30.00710056, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 29.99295002, 9.99915400, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.93048176, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.06902305, 7.00828277, 
  ...
  CoincidentCon(p.Ln46.End, 30.00710056, 10.00000000, 
                p.Cr50.Base, 30.00710056, 10.00000000);
  CoincidentCon(p.Ln49.Base, 29.99295002, 9.99915400, 
                p.Cr50.End, 29.99295002, 9.99915400);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.93048176, 7.00000000, 
                p.Cr52.Base, 4.93048176, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.06902305, 7.00828277, 
                p.Cr52.End, 5.06902305, 7.00828277);
}
