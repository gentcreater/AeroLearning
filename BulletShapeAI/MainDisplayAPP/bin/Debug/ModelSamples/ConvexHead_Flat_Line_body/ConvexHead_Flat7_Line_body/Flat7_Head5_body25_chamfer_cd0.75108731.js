...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body25_chamfer_cd0.75108731.js
//         On: 07/04/19, 19:30:18
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.94626844, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.00921622, 10.00000000);
  p.Ln49 = Line(34.99082952, 9.99908295, 5.05346490, 7.00534649);
  p.Cr50 = ArcCtrEdge(
              35.00921622, 9.81521593,
              35.00921622, 10.00000000,
              34.99082952, 9.99908295);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.94626844, 8.07731112,
              4.94626844, 7.00000000,
              5.05346490, 7.00534649);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.00921622, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.99082952, 9.99908295, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.94626844, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.05346490, 7.00534649, 
  ...
  CoincidentCon(p.Ln46.End, 35.00921622, 10.00000000, 
                p.Cr50.Base, 35.00921622, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.99082952, 9.99908295, 
                p.Cr50.End, 34.99082952, 9.99908295);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.94626844, 7.00000000, 
                p.Cr52.Base, 4.94626844, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.05346490, 7.00534649, 
                p.Cr52.End, 5.05346490, 7.00534649);
}
