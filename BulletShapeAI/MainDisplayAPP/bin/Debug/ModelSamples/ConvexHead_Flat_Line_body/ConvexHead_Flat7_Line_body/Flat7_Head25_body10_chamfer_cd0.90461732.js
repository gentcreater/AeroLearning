...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body10_chamfer_cd0.90461732.js
//         On: 07/04/19, 19:18:29
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(50.00000000, 10.00000000);
  p.Pt114 = ConstructionPoint(25.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.85053615, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.14946385, 10.00000000);
  p.Ln49 = Line(49.85160080, 9.98219210, 25.14839920, 7.01780790);
  p.Cr50 = ArcCtrEdge(
              50.14946385, 7.50000000,
              50.14946385, 10.00000000,
              49.85160080, 9.98219210);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.85053615, 9.50000000,
              24.85053615, 7.00000000,
              25.14839920, 7.01780790);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 50.00000000, 10.00000000, 
    56.79560188, 11.09884475);
  if(dim) dim.Name = "H21";
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 25.00000000, 7.00000000, 
    16.25596005, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.14946385, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.85160080, 9.98219210, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.85053615, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.14839920, 7.01780790, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 50.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 50.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 50.14946385, 10.00000000, 
                p.Cr50.Base, 50.14946385, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.85160080, 9.98219210, 
                p.Cr50.End, 49.85160080, 9.98219210);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.85053615, 7.00000000, 
                p.Cr52.Base, 24.85053615, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.14839920, 7.01780790, 
                p.Cr52.End, 25.14839920, 7.01780790);
}
