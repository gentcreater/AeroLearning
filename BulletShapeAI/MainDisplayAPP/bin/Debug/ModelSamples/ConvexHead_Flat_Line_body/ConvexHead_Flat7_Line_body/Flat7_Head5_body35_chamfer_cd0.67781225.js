...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body35_chamfer_cd0.67781225.js
//         On: 07/04/19, 19:34:30
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.90891909, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.00633451, 10.00000000);
  p.Ln49 = Line(24.99373557, 9.99906034, 5.09007322, 7.01351098);
  p.Cr50 = ArcCtrEdge(
              25.00633451, 9.91506743,
              25.00633451, 10.00000000,
              24.99373557, 9.99906034);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.90891909, 8.22120522,
              4.90891909, 7.00000000,
              5.09007322, 7.01351098);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.00633451, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.99373557, 9.99906034, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.90891909, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.09007322, 7.01351098, 
  ...
  CoincidentCon(p.Ln46.End, 25.00633451, 10.00000000, 
                p.Cr50.Base, 25.00633451, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.99373557, 9.99906034, 
                p.Cr50.End, 24.99373557, 9.99906034);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.90891909, 7.00000000, 
                p.Cr52.Base, 4.90891909, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.09007322, 7.01351098, 
                p.Cr52.End, 5.09007322, 7.01351098);
}
