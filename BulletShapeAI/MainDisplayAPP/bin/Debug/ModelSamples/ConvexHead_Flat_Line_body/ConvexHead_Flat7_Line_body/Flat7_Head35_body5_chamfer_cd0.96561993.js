...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head35_body5_chamfer_cd0.96561993.js
//         On: 07/04/19, 19:13:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 34.81354299, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.18645701, 10.00000000);
  p.Ln49 = Line(54.81560588, 9.97234088, 35.18439412, 7.02765912);
  p.Cr50 = ArcCtrEdge(
              55.18645701, 7.50000000,
              55.18645701, 10.00000000,
              54.81560588, 9.97234088);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.81354299, 9.50000000,
              34.81354299, 7.00000000,
              35.18439412, 7.02765912);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.18645701, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.81560588, 9.97234088, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.81354299, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.18439412, 7.02765912, 
  ...
  CoincidentCon(p.Ln46.End, 55.18645701, 10.00000000, 
                p.Cr50.Base, 55.18645701, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.81560588, 9.97234088, 
                p.Cr50.End, 54.81560588, 9.97234088);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.81354299, 7.00000000, 
                p.Cr52.Base, 34.81354299, 7.00000000);
  CoincidentCon(p.Ln49.End, 35.18439412, 7.02765912, 
                p.Cr52.End, 35.18439412, 7.02765912);
}
