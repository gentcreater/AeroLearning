...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body40_chamfer_cd0.64337241.js
//         On: 07/04/19, 19:35:02
//Using:
...
with (p.Sk2)
{
  p.Pt108 = ConstructionPoint(20.00000000, 10.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.65019010, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.01800524, 10.00000000);
  p.Ln49 = Line(19.98456063, 9.99073638, 15.29995951, 7.17997571);
  p.Cr50 = ArcCtrEdge(
              20.01800524, 9.93499537,
              20.01800524, 10.00000000,
              19.98456063, 9.99073638);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.65019010, 8.26292473,
              14.65019010, 7.00000000,
              15.29995951, 7.17997571);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln46.Base, 60.00000000, 10.00000000, 
    p.Pt108, 20.00000000, 10.00000000, 
    47.18240753, 11.09884475);
  if(dim) dim.Name = "H21";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.01800524, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.98456063, 9.99073638, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.65019010, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.29995951, 7.17997571, 
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 20.00000000, 10.00000000, 
                p.Ln46, 55.00000000, 10.00000000);
  CoincidentCon(p.Pt108, 20.00000000, 10.00000000, 
                p.Ln49, 55.00000000, 10.00000000);
  CoincidentCon(p.Ln46.End, 20.01800524, 10.00000000, 
                p.Cr50.Base, 20.01800524, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.98456063, 9.99073638, 
                p.Cr50.End, 19.98456063, 9.99073638);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.65019010, 7.00000000, 
                p.Cr52.Base, 14.65019010, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.29995951, 7.17997571, 
                p.Cr52.End, 15.29995951, 7.17997571);
}
