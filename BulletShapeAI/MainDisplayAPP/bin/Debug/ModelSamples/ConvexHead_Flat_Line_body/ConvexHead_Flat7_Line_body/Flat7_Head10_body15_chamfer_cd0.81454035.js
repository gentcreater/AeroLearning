...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body15_chamfer_cd0.81454035.js
//         On: 07/04/19, 19:23:33
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.96048418, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.03951582, 10.00000000);
  p.Ln49 = Line(44.96062855, 9.99662530, 10.03937145, 7.00337470);
  p.Cr50 = ArcCtrEdge(
              45.03951582, 9.07627376,
              45.03951582, 10.00000000,
              44.96062855, 9.99662530);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.96048418, 7.92372624,
              9.96048418, 7.00000000,
              10.03937145, 7.00337470);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.03951582, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.96062855, 9.99662530, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.96048418, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.03937145, 7.00337470, 
  ...
  CoincidentCon(p.Ln46.End, 45.03951582, 10.00000000, 
                p.Cr50.Base, 45.03951582, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.96062855, 9.99662530, 
                p.Cr50.End, 44.96062855, 9.99662530);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.96048418, 7.00000000, 
                p.Cr52.Base, 9.96048418, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.03937145, 7.00337470, 
                p.Cr52.End, 10.03937145, 7.00337470);
}
