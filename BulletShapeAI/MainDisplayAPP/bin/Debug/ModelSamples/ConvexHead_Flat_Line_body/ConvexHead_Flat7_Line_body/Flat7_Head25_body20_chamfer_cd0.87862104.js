...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body20_chamfer_cd0.87862104.js
//         On: 07/04/19, 19:25:35
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.90557265, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.03426671, 10.00000000);
  p.Ln49 = Line(39.96639873, 9.99327975, 25.09259363, 7.01851873);
  p.Cr50 = ArcCtrEdge(
              40.03426671, 9.65393983,
              40.03426671, 10.00000000,
              39.96639873, 9.99327975);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.90557265, 7.95362362,
              24.90557265, 7.00000000,
              25.09259363, 7.01851873);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.03426671, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.96639873, 9.99327975, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.90557265, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.09259363, 7.01851873, 
  ...
  CoincidentCon(p.Ln46.End, 40.03426671, 10.00000000, 
                p.Cr50.Base, 40.03426671, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.96639873, 9.99327975, 
                p.Cr50.End, 39.96639873, 9.99327975);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.90557265, 7.00000000, 
                p.Cr52.Base, 24.90557265, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.09259363, 7.01851873, 
                p.Cr52.End, 25.09259363, 7.01851873);
}
