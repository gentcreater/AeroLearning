...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body40_chamfer_cd0.64044953.js
//         On: 07/04/19, 19:35:48
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.81464201, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 20.00954065, 10.00000000);
  p.Ln49 = Line(19.99086171, 9.99725851, 10.17754076, 7.05326223);
  p.Cr50 = ArcCtrEdge(
              20.00954065, 9.93499537,
              20.00954065, 10.00000000,
              19.99086171, 9.99725851);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.81464201, 8.26292473,
              9.81464201, 7.00000000,
              10.17754076, 7.05326223);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 20.00954065, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 19.99086171, 9.99725851, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.81464201, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.17754076, 7.05326223, 
  ...
  CoincidentCon(p.Ln46.End, 20.00954065, 10.00000000, 
                p.Cr50.Base, 20.00954065, 10.00000000);
  CoincidentCon(p.Ln49.Base, 19.99086171, 9.99725851, 
                p.Cr50.End, 19.99086171, 9.99725851);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.81464201, 7.00000000, 
                p.Cr52.Base, 9.81464201, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.17754076, 7.05326223, 
                p.Cr52.End, 10.17754076, 7.05326223);
}
