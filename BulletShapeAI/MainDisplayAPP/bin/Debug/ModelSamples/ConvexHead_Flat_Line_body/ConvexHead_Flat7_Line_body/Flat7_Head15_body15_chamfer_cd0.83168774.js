...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head15_body15_chamfer_cd0.83168774.js
//         On: 07/04/19, 19:23:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 14.95392858, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.04607142, 10.00000000);
  p.Ln49 = Line(44.95415722, 9.99541572, 15.04584278, 7.00458428);
  p.Cr50 = ArcCtrEdge(
              45.04607142, 9.07627376,
              45.04607142, 10.00000000,
              44.95415722, 9.99541572);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              14.95392858, 7.92372624,
              14.95392858, 7.00000000,
              15.04584278, 7.00458428);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.04607142, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.95415722, 9.99541572, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 14.95392858, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 15.04584278, 7.00458428, 
  ...
  CoincidentCon(p.Ln46.End, 45.04607142, 10.00000000, 
                p.Cr50.Base, 45.04607142, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.95415722, 9.99541572, 
                p.Cr50.End, 44.95415722, 9.99541572);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 15.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.95392858, 7.00000000, 
                p.Cr52.Base, 14.95392858, 7.00000000);
  CoincidentCon(p.Ln49.End, 15.04584278, 7.00458428, 
                p.Cr52.End, 15.04584278, 7.00458428);
}
