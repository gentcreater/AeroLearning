...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head35_body20_chamfer_cd0.91523572.js
//         On: 07/04/19, 19:24:44
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 34.73586155, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.09585312, 10.00000000);
  p.Ln49 = Line(39.91780663, 9.95068398, 35.22649685, 7.13589811);
  p.Cr50 = ArcCtrEdge(
              40.09585312, 9.65393983,
              40.09585312, 10.00000000,
              39.91780663, 9.95068398);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              34.73586155, 7.95362362,
              34.73586155, 7.00000000,
              35.22649685, 7.13589811);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.09585312, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.91780663, 9.95068398, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 34.73586155, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 35.22649685, 7.13589811, 
  ...
  CoincidentCon(p.Ln46.End, 40.09585312, 10.00000000, 
                p.Cr50.Base, 40.09585312, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.91780663, 9.95068398, 
                p.Cr50.End, 39.91780663, 9.95068398);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 35.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.73586155, 7.00000000, 
                p.Cr52.Base, 34.73586155, 7.00000000);
  CoincidentCon(p.Ln49.End, 35.22649685, 7.13589811, 
                p.Cr52.End, 35.22649685, 7.13589811);
}
