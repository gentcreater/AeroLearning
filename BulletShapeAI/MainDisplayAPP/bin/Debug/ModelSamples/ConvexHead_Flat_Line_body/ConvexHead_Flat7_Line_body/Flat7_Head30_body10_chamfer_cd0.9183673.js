...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head30_body10_chamfer_cd0.9183673.js
//         On: 07/04/19, 19:18:02
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 29.81354299, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.18645701, 10.00000000);
  p.Ln49 = Line(49.81560588, 9.97234088, 30.18439412, 7.02765912);
  p.Cr50 = ArcCtrEdge(
              50.18645701, 7.50000000,
              50.18645701, 10.00000000,
              49.81560588, 9.97234088);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.81354299, 9.50000000,
              29.81354299, 7.00000000,
              30.18439412, 7.02765912);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.18645701, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.81560588, 9.97234088, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.81354299, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.18439412, 7.02765912, 
  ...
  CoincidentCon(p.Ln46.End, 50.18645701, 10.00000000, 
                p.Cr50.Base, 50.18645701, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.81560588, 9.97234088, 
                p.Cr50.End, 49.81560588, 9.97234088);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.81354299, 7.00000000, 
                p.Cr52.Base, 29.81354299, 7.00000000);
  CoincidentCon(p.Ln49.End, 30.18439412, 7.02765912, 
                p.Cr52.End, 30.18439412, 7.02765912);
}
