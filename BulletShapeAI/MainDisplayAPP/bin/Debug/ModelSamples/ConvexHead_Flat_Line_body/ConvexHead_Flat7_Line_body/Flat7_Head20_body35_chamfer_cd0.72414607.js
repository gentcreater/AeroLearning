...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body35_chamfer_cd0.72414607.js
//         On: 07/04/19, 19:33:10
//Using:
...
with (p.Sk2)
{
  ...
  p.Pt114 = ConstructionPoint(20.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.66174574, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 25.02352496, 10.00000000);
  p.Ln49 = Line(24.97982751, 9.98789651, 20.29005064, 7.17403038);
  p.Cr50 = ArcCtrEdge(
              25.02352496, 9.91506743,
              25.02352496, 10.00000000,
              24.97982751, 9.98789651);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.66174574, 8.22120522,
              19.66174574, 7.00000000,
              20.29005064, 7.17403038);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt114, 20.00000000, 7.00000000, 
    13.00476804, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 25.02352496, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 24.97982751, 9.98789651, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.66174574, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.29005064, 7.17403038, 
  ...
  CoincidentCon(p.Ln46.End, 25.02352496, 10.00000000, 
                p.Cr50.Base, 25.02352496, 10.00000000);
  CoincidentCon(p.Ln49.Base, 24.97982751, 9.98789651, 
                p.Cr50.End, 24.97982751, 9.98789651);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.66174574, 7.00000000, 
                p.Cr52.Base, 19.66174574, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.29005064, 7.17403038, 
                p.Cr52.End, 20.29005064, 7.17403038);
}
