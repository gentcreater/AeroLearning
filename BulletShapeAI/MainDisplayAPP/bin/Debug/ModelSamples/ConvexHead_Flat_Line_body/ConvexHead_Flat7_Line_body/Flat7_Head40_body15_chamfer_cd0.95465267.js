...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head40_body15_chamfer_cd0.95465267.js
//         On: 07/04/19, 19:20:50
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 39.38685336, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.61314664, 10.00000000);
  p.Ln49 = Line(44.47423109, 9.68453865, 40.52576891, 7.31546135);
  p.Cr50 = ArcCtrEdge(
              45.61314664, 7.78634607,
              45.61314664, 10.00000000,
              44.47423109, 9.68453865);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              39.38685336, 9.21365393,
              39.38685336, 7.00000000,
              40.52576891, 7.31546135);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.61314664, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.47423109, 9.68453865, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 39.38685336, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 40.52576891, 7.31546135, 
  ...
  CoincidentCon(p.Ln46.End, 45.61314664, 10.00000000, 
                p.Cr50.Base, 45.61314664, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.47423109, 9.68453865, 
                p.Cr50.End, 44.47423109, 9.68453865);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 40.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.38685336, 7.00000000, 
                p.Cr52.Base, 39.38685336, 7.00000000);
  CoincidentCon(p.Ln49.End, 40.52576891, 7.31546135, 
                p.Cr52.End, 40.52576891, 7.31546135);
}
