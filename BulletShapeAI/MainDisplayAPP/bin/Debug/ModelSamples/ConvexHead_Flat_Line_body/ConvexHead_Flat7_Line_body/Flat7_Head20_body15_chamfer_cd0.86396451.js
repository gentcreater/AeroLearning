...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body15_chamfer_cd0.86396451.js
//         On: 07/04/19, 19:22:36
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.94477453, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 45.05522547, 10.00000000);
  p.Ln49 = Line(44.94516791, 9.99342015, 20.05483209, 7.00657985);
  p.Cr50 = ArcCtrEdge(
              45.05522547, 9.07627376,
              45.05522547, 10.00000000,
              44.94516791, 9.99342015);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.94477453, 7.92372624,
              19.94477453, 7.00000000,
              20.05483209, 7.00657985);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 45.05522547, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 44.94516791, 9.99342015, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.94477453, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.05483209, 7.00657985, 
  ...
  CoincidentCon(p.Ln46.End, 45.05522547, 10.00000000, 
                p.Cr50.Base, 45.05522547, 10.00000000);
  CoincidentCon(p.Ln49.Base, 44.94516791, 9.99342015, 
                p.Cr50.End, 44.94516791, 9.99342015);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.94477453, 7.00000000, 
                p.Cr52.Base, 19.94477453, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.05483209, 7.00657985, 
                p.Cr52.End, 20.05483209, 7.00657985);
}
