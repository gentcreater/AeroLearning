...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head20_body25_chamfer_cd0.82310712.js
//         On: 07/04/19, 19:28:49
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.89332518, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 35.01829723, 10.00000000);
  p.Ln49 = Line(34.98205809, 9.99641162, 20.10460327, 7.02092065);
  p.Cr50 = ArcCtrEdge(
              35.01829723, 9.81521593,
              35.01829723, 10.00000000,
              34.98205809, 9.99641162);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              19.89332518, 8.07731112,
              19.89332518, 7.00000000,
              20.10460327, 7.02092065);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 35.01829723, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 34.98205809, 9.99641162, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 19.89332518, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 20.10460327, 7.02092065, 
  ...
  CoincidentCon(p.Ln46.End, 35.01829723, 10.00000000, 
                p.Cr50.Base, 35.01829723, 10.00000000);
  CoincidentCon(p.Ln49.Base, 34.98205809, 9.99641162, 
                p.Cr50.End, 34.98205809, 9.99641162);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 20.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.89332518, 7.00000000, 
                p.Cr52.Base, 19.89332518, 7.00000000);
  CoincidentCon(p.Ln49.End, 20.10460327, 7.02092065, 
                p.Cr52.End, 20.10460327, 7.02092065);
}
