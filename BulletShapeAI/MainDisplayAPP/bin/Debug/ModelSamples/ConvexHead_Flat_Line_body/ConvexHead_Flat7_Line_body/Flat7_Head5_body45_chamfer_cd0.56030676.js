...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head5_body45_chamfer_cd0.56030676.js
//         On: 07/04/19, 19:37:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 4.81007959, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 15.00764953, 10.00000000);
  p.Ln49 = Line(14.99267308, 9.99780192, 5.18191076, 7.05457323);
  p.Cr50 = ArcCtrEdge(
              15.00764953, 9.94788045,
              15.00764953, 10.00000000,
              14.99267308, 9.99780192);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              4.81007959, 8.29401048,
              4.81007959, 7.00000000,
              5.18191076, 7.05457323);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 15.00764953, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 14.99267308, 9.99780192, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 4.81007959, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 5.18191076, 7.05457323, 
  ...
  CoincidentCon(p.Ln46.End, 15.00764953, 10.00000000, 
                p.Cr50.Base, 15.00764953, 10.00000000);
  CoincidentCon(p.Ln49.Base, 14.99267308, 9.99780192, 
                p.Cr50.End, 14.99267308, 9.99780192);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 5.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 4.81007959, 7.00000000, 
                p.Cr52.Base, 4.81007959, 7.00000000);
  CoincidentCon(p.Ln49.End, 5.18191076, 7.05457323, 
                p.Cr52.End, 5.18191076, 7.05457323);
}
