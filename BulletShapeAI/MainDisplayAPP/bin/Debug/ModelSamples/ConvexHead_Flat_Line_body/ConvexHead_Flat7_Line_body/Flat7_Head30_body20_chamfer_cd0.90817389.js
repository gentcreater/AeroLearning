...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head30_body20_chamfer_cd0.90817389.js
//         On: 07/04/19, 19:25:09
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 29.68422791, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 40.23011964, 10.00000000);
  p.Ln49 = Line(39.77958536, 9.93387561, 30.30245481, 7.09073644);
  p.Cr50 = ArcCtrEdge(
              40.23011964, 8.43209465,
              40.23011964, 10.00000000,
              39.77958536, 9.93387561);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              29.68422791, 9.15149279,
              29.68422791, 7.00000000,
              30.30245481, 7.09073644);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 40.23011964, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 39.77958536, 9.93387561, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 29.68422791, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 30.30245481, 7.09073644, 
  ...
  CoincidentCon(p.Ln46.End, 40.23011964, 10.00000000, 
                p.Cr50.Base, 40.23011964, 10.00000000);
  CoincidentCon(p.Ln49.Base, 39.77958536, 9.93387561, 
                p.Cr50.End, 39.77958536, 9.93387561);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 30.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.68422791, 7.00000000, 
                p.Cr52.Base, 29.68422791, 7.00000000);
  CoincidentCon(p.Ln49.End, 30.30245481, 7.09073644, 
                p.Cr52.End, 30.30245481, 7.09073644);
}
