...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head10_body10_chamfer_cd0.83498174.js
//         On: 07/04/19, 19:19:45
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.90638147, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 50.09361853, 10.00000000);
  p.Ln49 = Line(49.90664366, 9.99299827, 10.09335634, 7.00700173);
  p.Cr50 = ArcCtrEdge(
              50.09361853, 7.50000000,
              50.09361853, 10.00000000,
              49.90664366, 9.99299827);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              9.90638147, 9.50000000,
              9.90638147, 7.00000000,
              10.09335634, 7.00700173);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 50.09361853, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 49.90664366, 9.99299827, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 9.90638147, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 10.09335634, 7.00700173, 
  ...
  CoincidentCon(p.Ln46.End, 50.09361853, 10.00000000, 
                p.Cr50.Base, 50.09361853, 10.00000000);
  CoincidentCon(p.Ln49.Base, 49.90664366, 9.99299827, 
                p.Cr50.End, 49.90664366, 9.99299827);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 10.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.90638147, 7.00000000, 
                p.Cr52.Base, 9.90638147, 7.00000000);
  CoincidentCon(p.Ln49.End, 10.09335634, 7.00700173, 
                p.Cr52.End, 10.09335634, 7.00700173);
}
