...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_body\ConvexHead_Flat7_Line_body\Flat7_Head25_body5_chamfer_cd0.94399172.js
//         On: 07/04/19, 19:14:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.87531095, 7.00000000);
  p.Ln46 = Line(60.00000000, 10.00000000, 55.12468905, 10.00000000);
  p.Ln49 = Line(54.87592976, 9.98759298, 25.12407024, 7.01240702);
  p.Cr50 = ArcCtrEdge(
              55.12468905, 7.50000000,
              55.12468905, 10.00000000,
              54.87592976, 9.98759298);
  p.Cr50.DeleteCenter();
  p.Cr52 = ArcCtrEdge(
              24.87531095, 9.50000000,
              24.87531095, 7.00000000,
              25.12407024, 7.01240702);
  p.Cr52.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr50, 55.12468905, 10.00000000, 
                p.Ln46, 57.50000000, 10.00000000);
  TangentCon(p.Cr50, 54.87592976, 9.98759298, 
                p.Ln49, 55.00000000, 7.50000000);
  TangentCon(p.Cr52, 24.87531095, 7.00000000, 
                p.Ln43, 52.50000000, 1.00000000);
  TangentCon(p.Cr52, 25.12407024, 7.01240702, 
  ...
  CoincidentCon(p.Ln46.End, 55.12468905, 10.00000000, 
                p.Cr50.Base, 55.12468905, 10.00000000);
  CoincidentCon(p.Ln49.Base, 54.87592976, 9.98759298, 
                p.Cr50.End, 54.87592976, 9.98759298);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt114, 25.00000000, 7.00000000, 
                p.Ln49, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.87531095, 7.00000000, 
                p.Cr52.Base, 24.87531095, 7.00000000);
  CoincidentCon(p.Ln49.End, 25.12407024, 7.01240702, 
                p.Cr52.End, 25.12407024, 7.01240702);
}
