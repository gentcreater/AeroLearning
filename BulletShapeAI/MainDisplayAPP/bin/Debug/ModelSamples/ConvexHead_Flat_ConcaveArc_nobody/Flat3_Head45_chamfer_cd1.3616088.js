...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat3_Head45_chamfer_cd1.3616088.js
//         On: 06/21/19, 22:29:46
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(45.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 49.27201392, 3.00000000);
  p.Cr45 = ArcCtrEdge(
              47.35885051, 17.51674891,
              50.25745454, 3.09807112,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              49.27201392, 8.00000000,
              49.27201392, 3.00000000,
              50.25745454, 3.09807112);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt102, 45.00000000, 3.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 49.27201392, 3.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 50.25745454, 3.09807112, 
                p.Cr45, 50.25745454, 3.09807112);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 45.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 45.00000000, 3.00000000, 
                p.Cr45, 45.00000000, 3.00000000);
  CoincidentCon(p.Ln43.End, 49.27201392, 3.00000000, 
                p.Cr47.Base, 49.27201392, 3.00000000);
  CoincidentCon(p.Cr45.Base, 50.25745454, 3.09807112, 
                p.Cr47.End, 50.25745454, 3.09807112);
}
