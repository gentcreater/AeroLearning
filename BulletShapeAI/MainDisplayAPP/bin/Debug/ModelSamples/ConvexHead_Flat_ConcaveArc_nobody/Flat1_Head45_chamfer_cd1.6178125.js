...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat1_Head45_chamfer_cd1.6178125.js
//         On: 06/19/19, 11:50:16
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(45.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 47.56705782, 1.00000000);
  p.Cr45 = ArcCtrEdge(
              46.41675016, 15.63874973,
              48.15956335, 1.03523040,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              47.56705782, 6.00000000,
              47.56705782, 1.00000000,
              48.15956335, 1.03523040);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt102, 45.00000000, 1.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 47.56705782, 1.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 48.15956335, 1.03523040, 
                p.Cr45, 48.15956335, 1.03523040);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 45.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 45.00000000, 1.00000000, 
                p.Cr45, 45.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 47.56705782, 1.00000000, 
                p.Cr47.Base, 47.56705782, 1.00000000);
  CoincidentCon(p.Cr45.Base, 48.15956335, 1.03523040, 
                p.Cr47.End, 48.15956335, 1.03523040);
}
