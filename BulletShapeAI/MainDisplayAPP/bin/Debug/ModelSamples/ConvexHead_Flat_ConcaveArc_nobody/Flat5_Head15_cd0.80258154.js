...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat5_Head15_cd0.80258154.js
//         On: 06/19/19, 12:57:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 15.00000000, 5.00000000);
  p.Ln46 = Line(60.00000000, 0.00000000, 60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              15.00000000, 210.00000000,
              15.00000000, 5.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Ln43.End, 15.00000000, 5.00000000, 
  ...
  if(dim) dim.Name = "V18";
  dim = VerticalDim(p.Ln46.Base, 60.00000000, 0.00000000, 
    p.Ln46.End, 60.00000000, 10.00000000, 
    62.62201758, 4.25685869);
  if(dim) dim.Name = "V21";
  ...
  VerticalCon(p.Ln24);
  VerticalCon(p.Ln46);
  TangentCon(p.Cr47, 15.00000000, 5.00000000, 
                p.Ln43, 15.00000000, 5.00000000);
  ...
  CoincidentCon(p.Ln46.Base, 60.00000000, 0.00000000, 
                p.Ln19.End, 60.00000000, 0.00000000);
  CoincidentCon(p.Cr47.End, 60.00000000, 10.00000000, 
                p.Ln46.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr47.Base, 15.00000000, 5.00000000, 
                p.Ln43.End, 15.00000000, 5.00000000);
}
