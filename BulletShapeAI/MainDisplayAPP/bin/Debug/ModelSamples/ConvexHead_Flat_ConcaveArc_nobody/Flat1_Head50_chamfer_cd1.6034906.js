...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat1_Head50_chamfer_cd1.6034906.js
//         On: 06/19/19, 11:49:22
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(50.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 49.28354034, 1.00000000);
  p.Cr45 = ArcCtrEdge(
              46.25086772, 15.22125809,
              50.84562269, 1.25027383,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              49.28354034, 6.00000000,
              49.28354034, 1.00000000,
              50.84562269, 1.25027383);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt102, 50.00000000, 1.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 49.28354034, 1.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 50.84562269, 1.25027383, 
                p.Cr45, 50.84562269, 1.25027383);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 50.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 50.00000000, 1.00000000, 
                p.Cr45, 50.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 49.28354034, 1.00000000, 
                p.Cr47.Base, 49.28354034, 1.00000000);
  CoincidentCon(p.Cr45.Base, 50.84562269, 1.25027383, 
                p.Cr47.End, 50.84562269, 1.25027383);
}
