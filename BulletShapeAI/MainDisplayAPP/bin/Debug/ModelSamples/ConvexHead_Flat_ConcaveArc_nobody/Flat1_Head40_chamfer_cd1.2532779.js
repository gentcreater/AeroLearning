...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat1_Head40_chamfer_cd1.2532779.js
//         On: 06/19/19, 11:50:47
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(40.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 50.77827596, 1.00000000);
  p.Cr45 = ArcCtrEdge(
              45.97821314, 14.43730413,
              53.25071343, 1.65407628,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              50.77827596, 6.00000000,
              50.77827596, 1.00000000,
              53.25071343, 1.65407628);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt102, 40.00000000, 1.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 50.77827596, 1.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 53.25071343, 1.65407628, 
                p.Cr45, 53.25071343, 1.65407628);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 40.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 40.00000000, 1.00000000, 
                p.Cr45, 40.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 50.77827596, 1.00000000, 
                p.Cr47.Base, 50.77827596, 1.00000000);
  CoincidentCon(p.Cr45.Base, 53.25071343, 1.65407628, 
                p.Cr47.End, 53.25071343, 1.65407628);
}
