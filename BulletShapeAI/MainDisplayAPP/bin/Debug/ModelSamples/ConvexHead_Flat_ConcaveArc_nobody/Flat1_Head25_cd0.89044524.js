...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat1_Head25_cd0.89044524.js
//         On: 06/19/19, 11:46:08
//Using:
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr48, 25.00000000, 1.00000000, 
                p.Ln43, 25.00000000, 1.00000000);
  ...
  CoincidentCon(p.Cr48.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr48.Base, 25.00000000, 1.00000000, 
                p.Ln43.End, 25.00000000, 1.00000000);
}
