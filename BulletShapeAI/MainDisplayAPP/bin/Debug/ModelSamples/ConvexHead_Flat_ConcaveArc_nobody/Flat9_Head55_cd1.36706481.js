...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat9_Head55_cd1.36706481.js
//         On: 06/21/19, 22:40:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 55.00000000, 9.00000000);
  p.Cr45 = ArcCtrEdge(
              54.65935967, 23.70320165,
              55.00000000, 9.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Ln43.End, 55.00000000, 9.00000000, 
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr45.Base, 55.00000000, 9.00000000, 
                p.Ln43.End, 55.00000000, 9.00000000);
}
