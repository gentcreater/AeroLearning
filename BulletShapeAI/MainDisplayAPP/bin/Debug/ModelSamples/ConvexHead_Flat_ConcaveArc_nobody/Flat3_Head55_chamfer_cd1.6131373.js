...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat3_Head55_chamfer_cd1.6131373.js
//         On: 06/21/19, 22:28:40
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(55.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 53.10380911, 3.00000000);
  p.Cr45 = ArcCtrEdge(
              46.05553447, 14.67461824,
              56.73426541, 4.56200828,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              53.10380911, 8.00000000,
              53.10380911, 3.00000000,
              56.73426541, 4.56200828);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Pt102, 55.00000000, 3.00000000, 
    35.76311211, 4.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 53.10380911, 3.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 56.73426541, 4.56200828, 
                p.Cr45, 56.73426541, 4.56200828);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 3.00000000, 
                p.Cr45, 55.00000000, 3.00000000);
  CoincidentCon(p.Ln43.End, 53.10380911, 3.00000000, 
                p.Cr47.Base, 53.10380911, 3.00000000);
  CoincidentCon(p.Cr45.Base, 56.73426541, 4.56200828, 
                p.Cr47.End, 56.73426541, 4.56200828);
}
