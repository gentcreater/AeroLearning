...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat9_Head55_chamfer_cd1.3834491.js
//         On: 06/21/19, 22:33:14
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(55.00000000, 9.00000000);
  ...
  p.Ln24 = Line(-0.00000000, 9.00000000, 0.00000000, 0.00000000);
  p.Ln43 = Line(-0.00000000, 9.00000000, 54.93609375, 9.00000000);
  p.Cr45 = ArcCtrEdge(
              54.65935967, 23.70320165,
              55.07863516, 9.00203222,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              54.93609375, 14.00000000,
              54.93609375, 9.00000000,
              55.07863516, 9.00203222);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "H15";
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt102, 55.00000000, 9.00000000, 
    35.76311211, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  if(dim) dim.Name = "V13";
  dim = VerticalDim(p.Ln24.Base, -0.00000000, 9.00000000, 
    p.Ln24.End, 0.00000000, 0.00000000, 
    -1.36157420, 4.15849023);
  if(dim) dim.Name = "V18";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 54.93609375, 9.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 55.07863516, 9.00203222, 
                p.Cr45, 55.07863516, 9.00203222);
  ...
  CoincidentCon(p.Ln43.Base, -0.00000000, 9.00000000, 
                p.Ln24.Base, -0.00000000, 9.00000000);
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 9.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 9.00000000, 
                p.Cr45, 55.00000000, 9.00000000);
  CoincidentCon(p.Ln43.End, 54.93609375, 9.00000000, 
                p.Cr47.Base, 54.93609375, 9.00000000);
  CoincidentCon(p.Cr45.Base, 55.07863516, 9.00203222, 
                p.Cr47.End, 55.07863516, 9.00203222);
}
