...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat5_Head55_chamfer_cd0.51606491.js
//         On: 06/19/19, 12:59:04
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(55.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 53.45121834, 5.00000000);
  p.Cr45 = ArcCtrEdge(
              47.40544269, 17.59455731,
              56.56530306, 6.08816202,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              53.45121834, 10.00000000,
              53.45121834, 5.00000000,
              56.56530306, 6.08816202);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 5.00000000, 
    p.Pt102, 55.00000000, 5.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 53.45121834, 5.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 56.56530306, 6.08816202, 
                p.Cr45, 56.56530306, 6.08816202);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 5.00000000, 
                p.Cr45, 55.00000000, 5.00000000);
  CoincidentCon(p.Ln43.End, 53.45121834, 5.00000000, 
                p.Cr47.Base, 53.45121834, 5.00000000);
  CoincidentCon(p.Cr45.Base, 56.56530306, 6.08816202, 
                p.Cr47.End, 56.56530306, 6.08816202);
}
