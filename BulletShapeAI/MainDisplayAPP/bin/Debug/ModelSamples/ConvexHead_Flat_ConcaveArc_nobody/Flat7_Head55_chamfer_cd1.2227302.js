...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat3_Head55_chamfer_cd1.2227302.js
//         On: 06/21/19, 22:30:59
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(55.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 54.04716730, 7.00000000);
  p.Cr45 = ArcCtrEdge(
              50.08340182, 20.86099697,
              56.08884105, 7.43583871,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              54.04716730, 12.00000000,
              54.04716730, 7.00000000,
              56.08884105, 7.43583871);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt102, 55.00000000, 7.00000000, 
    35.76311211, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 54.04716730, 7.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 56.08884105, 7.43583871, 
                p.Cr45, 56.08884105, 7.43583871);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 7.00000000, 
                p.Cr45, 55.00000000, 7.00000000);
  CoincidentCon(p.Ln43.End, 54.04716730, 7.00000000, 
                p.Cr47.Base, 54.04716730, 7.00000000);
  CoincidentCon(p.Cr45.Base, 56.08884105, 7.43583871, 
                p.Cr47.End, 56.08884105, 7.43583871);
}
