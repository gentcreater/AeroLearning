...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat3_Head50_chamfer_cd1.1603296.js
//         On: 06/21/19, 22:31:38
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(50.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 51.90112336, 7.00000000);
  p.Cr45 = ArcCtrEdge(
              51.04909536, 21.66968212,
              52.33998968, 7.01929761,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              51.90112336, 12.00000000,
              51.90112336, 7.00000000,
              52.33998968, 7.01929761);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Pt102, 50.00000000, 7.00000000, 
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 51.90112336, 7.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 52.33998968, 7.01929761, 
                p.Cr45, 52.33998968, 7.01929761);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 50.00000000, 7.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 50.00000000, 7.00000000, 
                p.Cr45, 50.00000000, 7.00000000);
  CoincidentCon(p.Ln43.End, 51.90112336, 7.00000000, 
                p.Cr47.Base, 51.90112336, 7.00000000);
  CoincidentCon(p.Cr45.Base, 52.33998968, 7.01929761, 
                p.Cr47.End, 52.33998968, 7.01929761);
}
