...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat7_Head25_cd1.0195942.js
//         On: 06/21/19, 22:37:37
//Using:
...
with (p.Sk2)
{
  ...
  p.Cr48 = ArcCtrEdge(
              25.00000000, 212.66666667,
              25.00000000, 7.00000000,
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr48, 25.00000000, 7.00000000, 
                p.Ln43, 25.00000000, 7.00000000);
  ...
  CoincidentCon(p.Cr48.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr48.Base, 25.00000000, 7.00000000, 
                p.Ln43.End, 25.00000000, 7.00000000);
}
