...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat1_Head55_chamfer_cd1.5416776.js
//         On: 06/19/19, 11:48:55
//Using:
...
with (p.Sk2)
{
  p.Pt102 = ConstructionPoint(55.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 52.93388385, 1.00000000);
  p.Cr45 = ArcCtrEdge(
              45.45691142, 12.19060477,
              56.78515569, 2.81131607,
              60.00000000, 10.00000000);
  p.Cr47 = ArcCtrEdge(
              52.93388385, 6.00000000,
              52.93388385, 1.00000000,
              56.78515569, 2.81131607);
  p.Cr47.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Pt102, 55.00000000, 1.00000000, 
    35.76311211, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr47, 52.93388385, 1.00000000, 
                p.Ln43, 52.93388385, 1.00000000);
  TangentCon(p.Cr47, 56.78515569, 2.81131607, 
                p.Cr45, 56.78515569, 2.81131607);
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt102, 55.00000000, 1.00000000, 
                p.Cr45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 52.93388385, 1.00000000, 
                p.Cr47.Base, 52.93388385, 1.00000000);
  CoincidentCon(p.Cr45.Base, 56.78515569, 2.81131607, 
                p.Cr47.End, 56.78515569, 2.81131607);
}
