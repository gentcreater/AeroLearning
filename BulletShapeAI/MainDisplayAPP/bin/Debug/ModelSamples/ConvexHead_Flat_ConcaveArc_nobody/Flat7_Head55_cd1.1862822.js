...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConcaveArc_nobody\Flat7_Head55_cd1.1862822.js
//         On: 06/21/19, 22:34:29
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 55.00000000, 7.00000000);
  p.Cr45 = ArcCtrEdge(
              50.08340182, 20.86099697,
              55.00000000, 7.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Ln43.End, 55.00000000, 7.00000000, 
  ...
  CoincidentCon(p.Cr45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr45.Base, 55.00000000, 7.00000000, 
                p.Ln43.End, 55.00000000, 7.00000000);
}
