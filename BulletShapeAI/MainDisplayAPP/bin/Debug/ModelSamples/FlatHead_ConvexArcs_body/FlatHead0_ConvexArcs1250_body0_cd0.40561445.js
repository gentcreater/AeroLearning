...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs1250_body0_cd0.40561445.js
//         On: 06/26/19, 22:56:34
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, -14.44269065, 3.41099288, 0);
  if(dim) dim.Name = "R20";
  ...
  CoincidentCon(p.Cr30.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr30.End, 0.00000000, 0.00000000, 
