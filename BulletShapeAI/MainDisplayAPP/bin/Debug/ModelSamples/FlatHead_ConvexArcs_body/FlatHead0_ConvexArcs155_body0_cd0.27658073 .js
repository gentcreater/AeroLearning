...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs155_body0_cd0.75404446.js
//         On: 06/26/19, 22:52:00
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, 22.93077250, 13.00377297, 0);
  if(dim) dim.Name = "R20";
