...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead1_ConvexArcs_body30_cd0.30669318.js
//         On: 06/27/19, 09:23:52
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln23 = Line(60.00000000, 10.00000000, 30.00000000, 10.00000000);
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 1.00000000);
  p.Cr39 = ArcCtrEdge(
              30.00000000, -44.50000000,
              30.00000000, 10.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln23.Base, 60.00000000, 10.00000000, 
    p.Ln23.End, 30.00000000, 10.00000000, 
    31.46551251, 12.03506848);
  if(dim) dim.Name = "H18";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln37);
  TangentCon(p.Cr39, 30.00000000, 10.00000000, 
  ...
  CoincidentCon(p.Cr39.Base, 30.00000000, 10.00000000, 
                p.Ln23.End, 30.00000000, 10.00000000);
