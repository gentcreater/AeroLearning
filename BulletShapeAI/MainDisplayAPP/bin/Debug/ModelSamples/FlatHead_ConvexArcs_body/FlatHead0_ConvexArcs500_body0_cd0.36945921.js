...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs500_body0_cd0.36945921.js
//         On: 06/26/19, 22:54:39
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, 11.36181731, 8.74391705, 0);
  if(dim) dim.Name = "R20";
