...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead1_ConvexArcs_body20_cd0.30047281 .js
//         On: 06/27/19, 09:23:00
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln23 = Line(60.00000000, 10.00000000, 40.00000000, 10.00000000);
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 1.00000000);
  p.Cr39 = ArcCtrEdge(
              40.00000000, -83.38888889,
              40.00000000, 10.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln23.Base, 60.00000000, 10.00000000, 
    p.Ln23.End, 40.00000000, 10.00000000, 
    40.97700834, 12.03506848);
  if(dim) dim.Name = "H18";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln37);
  TangentCon(p.Cr39, 40.00000000, 10.00000000, 
  ...
  CoincidentCon(p.Cr39.Base, 40.00000000, 10.00000000, 
                p.Ln23.End, 40.00000000, 10.00000000);
