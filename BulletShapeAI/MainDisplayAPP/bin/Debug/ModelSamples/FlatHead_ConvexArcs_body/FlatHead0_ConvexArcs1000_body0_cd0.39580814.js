...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs1000_body0_cd0.39305218.js
//         On: 06/26/19, 22:55:49
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, -5.82594570, 5.09718051, 0);
  if(dim) dim.Name = "R20";
