...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead8_ConvexArcs_body0_cd0.88960411.js
//         On: 06/27/19, 11:18:52
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 8.00000000);
  p.Cr44 = ArcCtrEdge(
              46.71294340, -492.38830206,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 8.00000000, 
    2.14745116, -6.49206422);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 8.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr44.End, -0.00000000, 8.00000000, 
                p.Ln37.End, 0.00000000, 8.00000000);
}
