...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead1_ConvexArcs_body50_cd0.33240095.js
//         On: 06/27/19, 09:26:06
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln23 = Line(60.00000000, 10.00000000, 10.00000000, 10.00000000);
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 1.00000000);
  p.Cr39 = ArcCtrEdge(
              10.00000000, -0.05555556,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln23.Base, 60.00000000, 10.00000000, 
    p.Ln23.End, 10.00000000, 10.00000000, 
    12.44252085, 12.03506848);
  if(dim) dim.Name = "H18";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln37);
  TangentCon(p.Cr39, 10.00000000, 10.00000000, 
  ...
  CoincidentCon(p.Cr39.Base, 10.00000000, 10.00000000, 
                p.Ln23.End, 10.00000000, 10.00000000);
