...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead4_ConvexArcs_body_cd0.17461578.js
//         On: 06/27/19, 11:16:47
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 4.00000000);
  p.Cr42 = ArcCtrEdge(
              46.23146808, -155.31468084,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 4.00000000, 
    2.14745116, -3.24603211);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 4.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr42.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr42.End, 0.00000000, 4.00000000, 
                p.Ln37.End, 0.00000000, 4.00000000);
}
