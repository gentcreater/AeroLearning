...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead1_ConvexArcs_body10_cd0.30223163.js
//         On: 06/27/19, 09:21:39
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln23 = Line(60.00000000, 10.00000000, 50.00000000, 10.00000000);
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 1.00000000);
  p.Cr39 = ArcCtrEdge(
              50.00000000, -133.38888889,
              50.00000000, 10.00000000,
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln23.Base, 60.00000000, 10.00000000, 
    p.Ln23.End, 50.00000000, 10.00000000, 
    50.48850417, 12.03506848);
  if(dim) dim.Name = "H18";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln37);
  TangentCon(p.Cr39, 50.00000000, 10.00000000, 
                p.Ln23, 59.00000000, 10.00000000);
  ...
  CoincidentCon(p.Cr39.Base, 50.00000000, 10.00000000, 
                p.Ln23.End, 50.00000000, 10.00000000);
  CoincidentCon(p.Cr39.End, 0.00000000, 1.00000000, 
                p.Ln37.End, 0.00000000, 1.00000000);
}
