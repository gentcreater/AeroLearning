...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs300_body0_cd0.33172797.js
//         On: 06/26/19, 22:53:55
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, 18.16549262, 10.63119103, 0);
  if(dim) dim.Name = "R20";
