...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead9_ConvexArcs_body0_cd1.15802700 .js
//         On: 06/27/19, 11:19:16
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 9.00000000);
  p.Cr44 = ArcCtrEdge(
              41.21746496, -663.54789734,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 9.00000000, 
    2.14745116, -7.30357224);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 9.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr44.End, 0.00000000, 9.00000000, 
                p.Ln37.End, 0.00000000, 9.00000000);
}
