...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead3_ConvexArcs_body_cd0.12952794.js
//         On: 06/27/19, 11:16:19
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 3.00000000);
  p.Cr42 = ArcCtrEdge(
              48.90179610, -155.51539518,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 3.00000000, 
    2.14745116, -2.43452408);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 3.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr42.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr42.End, 0.00000000, 3.00000000, 
                p.Ln37.End, 0.00000000, 3.00000000);
}
