...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead_ConvexArcs750_body0_cd0.39305218.js
//         On: 06/26/19, 22:55:15
//Using:
...
with (p.Plane)
{
  ...
  if(dim) dim.Name = "V17";
  dim = RadiusDim(p.Cr30, 2.78064577, 6.84428897, 0);
  if(dim) dim.Name = "R20";
