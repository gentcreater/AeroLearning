...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead1_ConvexArcs_body55_chamfer_cd0.39068301.js
//         On: 06/27/19, 09:27:05
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln23 = Line(60.00000000, 10.00000000, 5.76678161, 10.00000000);
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 1.00000000);
  p.Cr40 = ArcCtrEdge(
              10.60000000, 1.00000000,
              4.27504754, 9.50617284,
              0.00000000, 1.00000000);
  p.Cr41 = ArcCtrEdge(
              5.76678161, 7.50000000,
              5.76678161, 10.00000000,
              4.27504754, 9.50617284);
  p.Cr41.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln23.Base, 60.00000000, 10.00000000, 
    p.Pt96, 5.00000000, 10.00000000, 
    7.68677293, 12.03506848);
  if(dim) dim.Name = "H18";
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 1.00000000, 
    2.14745116, -0.81150803);
  if(dim) dim.Name = "V34";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln37);
  TangentCon(p.Cr40, 0.00000000, 1.00000000, 
                p.Ln37, 0.00000000, 1.00000000);
  TangentCon(p.Cr41, 5.76678161, 10.00000000, 
                p.Ln23, 5.76678161, 10.00000000);
  TangentCon(p.Cr41, 4.27504754, 9.50617284, 
                p.Cr40, 4.27504754, 9.50617284);
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 1.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr40.End, 0.00000000, 1.00000000, 
                p.Ln37.End, 0.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 5.00000000, 10.00000000, 
                p.Ln23, 5.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 5.00000000, 10.00000000, 
                p.Cr40, 5.00000000, 10.00000000);
  CoincidentCon(p.Ln23.End, 5.76678161, 10.00000000, 
                p.Cr41.Base, 5.76678161, 10.00000000);
  CoincidentCon(p.Cr40.Base, 4.27504754, 9.50617284, 
                p.Cr41.End, 4.27504754, 9.50617284);
}
