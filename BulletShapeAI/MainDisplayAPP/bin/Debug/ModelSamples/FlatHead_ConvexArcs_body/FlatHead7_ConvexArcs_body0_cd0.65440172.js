...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead7_ConvexArcs_body0_cd0.65440172.js
//         On: 06/27/19, 11:18:25
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 7.00000000);
  p.Cr44 = ArcCtrEdge(
              46.23801573, -316.26031466,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 7.00000000, 
    2.14745116, -5.68055619);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 7.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr44.End, 0.00000000, 7.00000000, 
                p.YAxis, 0.00000000, 6.60259303);
  CoincidentCon(p.Cr44.End, 0.00000000, 7.00000000, 
                p.Ln37.End, 0.00000000, 7.00000000);
}
