...
// Written to: G:\workbench\SimpleModelJS\FlatHead_ConvexArcs_body\FlatHead2_ConvexArcs_body_cd0.09946523.js
//         On: 06/27/19, 11:15:49
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln37 = Line(0.00000000, 0.00000000, 0.00000000, 2.00000000);
  p.Cr42 = ArcCtrEdge(
              51.55626989, -155.67202417,
...
with (p.Plane)
{
  ...
  dim = VerticalDim(p.Ln37.Base, 0.00000000, 0.00000000, 
    p.Ln37.End, 0.00000000, 2.00000000, 
    2.14745116, -1.62301605);
  if(dim) dim.Name = "V34";
  ...
  CoincidentCon(p.Ln37.End, 0.00000000, 2.00000000, 
                p.YAxis, 0.00000000, 2.49507260);
  CoincidentCon(p.Cr42.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr42.End, 0.00000000, 2.00000000, 
                p.Ln37.End, 0.00000000, 2.00000000);
}
