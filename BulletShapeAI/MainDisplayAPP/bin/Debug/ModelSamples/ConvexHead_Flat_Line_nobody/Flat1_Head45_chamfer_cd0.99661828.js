...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head45_chamfer_cd0.99661828.js
//         On: 06/19/19, 09:14:35
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(45.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 44.30754009, 1.00000000);
  p.Ln45 = Line(45.59377948, 1.35626769, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              44.30754009, 3.50000000,
              44.30754009, 1.00000000,
              45.59377948, 1.35626769);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 44.30754009, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 45.59377948, 1.35626769, 
  ...
  CoincidentCon(p.Pt98, 45.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 45.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.30754009, 1.00000000, 
                p.Cr46.Base, 44.30754009, 1.00000000);
  CoincidentCon(p.Ln45.Base, 45.59377948, 1.35626769, 
                p.Cr46.End, 45.59377948, 1.35626769);
}
