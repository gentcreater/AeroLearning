...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head15_chamfer_cd0.48075213.js
//         On: 06/19/19, 10:43:46
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(15.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 14.75245122, 1.00000000);
  p.Ln45 = Line(15.24274155, 1.04854831, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              14.75245122, 3.50000000,
              14.75245122, 1.00000000,
              15.24274155, 1.04854831);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 14.75245122, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 15.24274155, 1.04854831, 
  ...
  CoincidentCon(p.Pt98, 15.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 15.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.75245122, 1.00000000, 
                p.Cr46.Base, 14.75245122, 1.00000000);
  CoincidentCon(p.Ln45.Base, 15.24274155, 1.04854831, 
                p.Cr46.End, 15.24274155, 1.04854831);
}
