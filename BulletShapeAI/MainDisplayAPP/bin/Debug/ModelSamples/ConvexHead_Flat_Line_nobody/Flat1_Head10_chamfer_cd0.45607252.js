...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head10_chamfer_cd0.45607252.js
//         On: 06/19/19, 10:44:37
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(10.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 9.77679356, 1.00000000);
  p.Ln45 = Line(10.21967606, 1.03954169, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              9.77679356, 3.50000000,
              9.77679356, 1.00000000,
              10.21967606, 1.03954169);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 9.77679356, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 10.21967606, 1.03954169, 
  ...
  CoincidentCon(p.Pt98, 10.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 10.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.77679356, 1.00000000, 
                p.Cr46.Base, 9.77679356, 1.00000000);
  CoincidentCon(p.Ln45.Base, 10.21967606, 1.03954169, 
                p.Cr46.End, 10.21967606, 1.03954169);
}
