...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head15_chamfer_cd0.68622629.js
//         On: 07/04/19, 15:22:41
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(15.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 14.86153715, 5.00000000);
  p.Ln45 = Line(15.13761597, 5.01529066, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              14.86153715, 7.50000000,
              14.86153715, 5.00000000,
              15.13761597, 5.01529066);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 14.86153715, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 15.13761597, 5.01529066, 
  ...
  CoincidentCon(p.Pt98, 15.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 15.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.86153715, 5.00000000, 
                p.Cr46.Base, 14.86153715, 5.00000000);
  CoincidentCon(p.Ln45.Base, 15.13761597, 5.01529066, 
                p.Cr46.End, 15.13761597, 5.01529066);
}
