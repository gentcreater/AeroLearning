...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head35_chamfer_cd1.29473020.js
//         On: 07/04/19, 15:41:47
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(35.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 34.95001998, 9.00000000);
  p.Ln45 = Line(35.04994008, 9.00199760, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              34.95001998, 11.50000000,
              34.95001998, 9.00000000,
              35.04994008, 9.00199760);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 35.00000000, 9.00000000, 
    22.75834407, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 34.95001998, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 35.04994008, 9.00199760, 
  ...
  CoincidentCon(p.Pt98, 35.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 35.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.95001998, 9.00000000, 
                p.Cr46.Base, 34.95001998, 9.00000000);
  CoincidentCon(p.Ln45.Base, 35.04994008, 9.00199760, 
                p.Cr46.End, 35.04994008, 9.00199760);
}
