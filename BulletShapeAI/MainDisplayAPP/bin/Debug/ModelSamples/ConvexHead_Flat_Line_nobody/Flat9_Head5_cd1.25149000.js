...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head5_cd1.25149000.js
//         On: 07/04/19, 15:39:03
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 1.00000000, 9.00000000);
  p.Ln45 = Line(1.00000000, 9.00000000, 60.00000000, 10.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Ln43.End, 1.00000000, 9.00000000, 
    0.65023840, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  CoincidentCon(p.Ln45.Base, 1.00000000, 9.00000000, 
