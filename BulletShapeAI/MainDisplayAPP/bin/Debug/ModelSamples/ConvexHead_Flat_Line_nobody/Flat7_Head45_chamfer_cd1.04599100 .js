...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head45_chamfer_cd1.04599100 .js
//         On: 07/04/19, 22:31:14
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(45.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 44.75245122, 7.00000000);
  p.Ln45 = Line(45.24274155, 7.04854831, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              44.75245122, 9.50000000,
              44.75245122, 7.00000000,
              45.24274155, 7.04854831);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 44.75245122, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 45.24274155, 7.04854831, 
  ...
  CoincidentCon(p.Pt98, 45.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 45.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.75245122, 7.00000000, 
                p.Cr46.Base, 44.75245122, 7.00000000);
  CoincidentCon(p.Ln45.Base, 45.24274155, 7.04854831, 
                p.Cr46.End, 45.24274155, 7.04854831);
}
