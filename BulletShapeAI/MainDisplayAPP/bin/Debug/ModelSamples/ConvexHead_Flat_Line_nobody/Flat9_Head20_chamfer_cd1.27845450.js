...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head20_chamfer_cd1.27845450.js
//         On: 07/04/19, 15:43:02
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(20.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 19.96875488, 9.00000000);
  p.Ln45 = Line(20.03123536, 9.00078088, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              19.96875488, 11.50000000,
              19.96875488, 9.00000000,
              20.03123536, 9.00078088);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 20.00000000, 9.00000000, 
    13.00476804, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 19.96875488, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 20.03123536, 9.00078088, 
  ...
  CoincidentCon(p.Pt98, 20.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 20.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.96875488, 9.00000000, 
                p.Cr46.Base, 19.96875488, 9.00000000);
  CoincidentCon(p.Ln45.Base, 20.03123536, 9.00078088, 
                p.Cr46.End, 20.03123536, 9.00078088);
}
