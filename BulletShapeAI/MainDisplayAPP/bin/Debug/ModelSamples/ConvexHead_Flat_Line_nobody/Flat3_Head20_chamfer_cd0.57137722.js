...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head20_chamfer_cd0.57137722.js
//         On: 07/04/19, 14:58:23
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(20.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 19.78289964, 3.00000000);
  p.Ln45 = Line(20.21385047, 3.03742383, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              19.78289964, 5.50000000,
              19.78289964, 3.00000000,
              20.21385047, 3.03742383);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 19.78289964, 3.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 20.21385047, 3.03742383, 
  ...
  CoincidentCon(p.Pt98, 20.00000000, 3.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 20.00000000, 3.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.78289964, 3.00000000, 
                p.Cr46.Base, 19.78289964, 3.00000000);
  CoincidentCon(p.Ln45.Base, 20.21385047, 3.03742383, 
                p.Cr46.End, 20.21385047, 3.03742383);
}
