...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head50_chamfer_cd1.08722490 .js
//         On: 07/04/19, 14:55:52
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(50.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 49.21194442, 3.00000000);
  p.Ln45 = Line(50.64560028, 3.45192020, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              49.21194442, 5.50000000,
              49.21194442, 3.00000000,
              50.64560028, 3.45192020);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 49.21194442, 3.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 50.64560028, 3.45192020, 
  ...
  CoincidentCon(p.Pt98, 50.00000000, 3.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 50.00000000, 3.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 49.21194442, 3.00000000, 
                p.Cr46.Base, 49.21194442, 3.00000000);
  CoincidentCon(p.Ln45.Base, 50.64560028, 3.45192020, 
                p.Cr46.End, 50.64560028, 3.45192020);
}
