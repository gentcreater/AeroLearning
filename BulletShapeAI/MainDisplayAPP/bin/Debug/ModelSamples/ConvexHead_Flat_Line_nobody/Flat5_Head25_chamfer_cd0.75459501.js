...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head25_chamfer_cd0.75459501.js
//         On: 07/04/19, 15:21:57
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(25.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 24.82233047, 5.00000000);
  p.Ln45 = Line(25.17588386, 5.02512627, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              24.82233047, 7.50000000,
              24.82233047, 5.00000000,
              25.17588386, 5.02512627);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 24.82233047, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 25.17588386, 5.02512627, 
  ...
  CoincidentCon(p.Pt98, 25.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 25.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.82233047, 5.00000000, 
                p.Cr46.Base, 24.82233047, 5.00000000);
  CoincidentCon(p.Ln45.Base, 25.17588386, 5.02512627, 
                p.Cr46.End, 25.17588386, 5.02512627);
}
