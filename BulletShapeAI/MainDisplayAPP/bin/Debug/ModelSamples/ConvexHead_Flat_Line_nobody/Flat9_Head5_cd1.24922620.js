...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head5_cd1.24922620.js
//         On: 07/04/19, 15:38:42
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 5.00000000, 9.00000000);
  p.Ln45 = Line(5.00000000, 9.00000000, 60.00000000, 10.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Ln43.End, 5.00000000, 9.00000000, 
    3.25119201, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  CoincidentCon(p.Ln45.Base, 5.00000000, 9.00000000, 
