...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head1_cd0.85193507.js
//         On: 07/04/19, 22:29:58
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 1.00000000, 7.00000000);
  p.Ln45 = Line(1.00000000, 7.00000000, 60.00000000, 10.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 7.00000000, 
    p.Ln43.End, 1.00000000, 7.00000000, 
    0.65023840, 8.08291601);
  if(dim) dim.Name = "H20";
  ...
  CoincidentCon(p.Ln45.Base, 1.00000000, 7.00000000, 
