...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head40_chamfer_cd0.85357330 .js
//         On: 07/04/19, 15:20:26
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(40.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 39.69223594, 5.00000000);
  p.Ln45 = Line(40.29857500, 5.07464375, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              39.69223594, 7.50000000,
              39.69223594, 5.00000000,
              40.29857500, 5.07464375);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 39.69223594, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 40.29857500, 5.07464375, 
  ...
  CoincidentCon(p.Pt98, 40.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 40.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.69223594, 5.00000000, 
                p.Cr46.Base, 39.69223594, 5.00000000);
  CoincidentCon(p.Ln45.Base, 40.29857500, 5.07464375, 
                p.Cr46.End, 40.29857500, 5.07464375);
}
