...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head40_chamfer_cd0.81602083.js
//         On: 06/19/19, 10:37:11
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(40.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 39.46341328, 1.00000000);
  p.Ln45 = Line(40.48932497, 1.22019624, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              39.46341328, 3.50000000,
              39.46341328, 1.00000000,
              40.48932497, 1.22019624);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 39.46341328, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 40.48932497, 1.22019624, 
  ...
  CoincidentCon(p.Pt98, 40.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 40.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.46341328, 1.00000000, 
                p.Cr46.Base, 39.46341328, 1.00000000);
  CoincidentCon(p.Ln45.Base, 40.48932497, 1.22019624, 
                p.Cr46.End, 40.48932497, 1.22019624);
}
