...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head25_chamfer_cd0.55208024.js
//         On: 06/19/19, 10:42:24
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(25.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 24.68371611, 1.00000000);
  p.Ln45 = Line(25.30631871, 1.07876767, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              24.68371611, 3.50000000,
              24.68371611, 1.00000000,
              25.30631871, 1.07876767);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 24.68371611, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 25.30631871, 1.07876767, 
  ...
  CoincidentCon(p.Pt98, 25.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 25.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.68371611, 1.00000000, 
                p.Cr46.Base, 24.68371611, 1.00000000);
  CoincidentCon(p.Ln45.Base, 25.30631871, 1.07876767, 
                p.Cr46.End, 25.30631871, 1.07876767);
}
