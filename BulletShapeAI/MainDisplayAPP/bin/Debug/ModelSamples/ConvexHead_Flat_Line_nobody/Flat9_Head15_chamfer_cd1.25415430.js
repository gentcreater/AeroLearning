...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head15_chamfer_cd1.25415430.js
//         On: 07/04/19, 15:43:26
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(15.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 14.97222565, 9.00000000);
  p.Ln45 = Line(15.02776749, 9.00061706, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              14.97222565, 11.50000000,
              14.97222565, 9.00000000,
              15.02776749, 9.00061706);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 15.00000000, 9.00000000, 
    9.75357603, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 14.97222565, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 15.02776749, 9.00061706, 
  ...
  CoincidentCon(p.Pt98, 15.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 15.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 14.97222565, 9.00000000, 
                p.Cr46.Base, 14.97222565, 9.00000000);
  CoincidentCon(p.Ln45.Base, 15.02776749, 9.00061706, 
                p.Cr46.End, 15.02776749, 9.00061706);
}
