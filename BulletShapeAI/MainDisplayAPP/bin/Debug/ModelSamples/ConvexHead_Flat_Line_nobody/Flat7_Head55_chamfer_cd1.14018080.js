...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head55_chamfer_cd1.14018080.js
//         On: 07/04/19, 22:30:28
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(55.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 54.30754009, 7.00000000);
  p.Ln45 = Line(55.59377948, 7.35626769, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              54.30754009, 9.50000000,
              54.30754009, 7.00000000,
              55.59377948, 7.35626769);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 54.30754009, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 55.59377948, 7.35626769, 
  ...
  CoincidentCon(p.Pt98, 55.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 55.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 54.30754009, 7.00000000, 
                p.Cr46.Base, 54.30754009, 7.00000000);
  CoincidentCon(p.Ln45.Base, 55.59377948, 7.35626769, 
                p.Cr46.End, 55.59377948, 7.35626769);
}
