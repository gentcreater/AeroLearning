...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head50_chamfer_cd1.50042960.js
//         On: 06/19/19, 09:13:31
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(50.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 49.04065999, 1.00000000);
  p.Ln45 = Line(50.71307182, 1.64176463, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              49.04065999, 3.50000000,
              49.04065999, 1.00000000,
              50.71307182, 1.64176463);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 49.04065999, 1.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 50.71307182, 1.64176463, 
  ...
  CoincidentCon(p.Pt98, 50.00000000, 1.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 50.00000000, 1.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 49.04065999, 1.00000000, 
                p.Cr46.Base, 49.04065999, 1.00000000);
  CoincidentCon(p.Ln45.Base, 50.71307182, 1.64176463, 
                p.Cr46.End, 50.71307182, 1.64176463);
}
