...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head10_chamfer_cd0.88150073.js
//         On: 07/04/19, 22:35:27
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(10.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 9.92506738, 7.00000000);
  p.Ln45 = Line(10.07479811, 7.00448789, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              9.92506738, 9.50000000,
              9.92506738, 7.00000000,
              10.07479811, 7.00448789);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 9.92506738, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 10.07479811, 7.00448789, 
  ...
  CoincidentCon(p.Pt98, 10.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 10.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.92506738, 7.00000000, 
                p.Cr46.Base, 9.92506738, 7.00000000);
  CoincidentCon(p.Ln45.Base, 10.07479811, 7.00448789, 
                p.Cr46.End, 10.07479811, 7.00448789);
}
