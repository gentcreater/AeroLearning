...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head30_chamfer_cd0.63206376.js
//         On: 07/04/19, 14:57:30
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(30.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 29.71219871, 3.00000000);
  p.Ln45 = Line(30.28027275, 3.06539698, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              29.71219871, 5.50000000,
              29.71219871, 3.00000000,
              30.28027275, 3.06539698);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 29.71219871, 3.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 30.28027275, 3.06539698, 
  ...
  CoincidentCon(p.Pt98, 30.00000000, 3.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 30.00000000, 3.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.71219871, 3.00000000, 
                p.Cr46.Base, 29.71219871, 3.00000000);
  CoincidentCon(p.Ln45.Base, 30.28027275, 3.06539698, 
                p.Cr46.End, 30.28027275, 3.06539698);
}
