...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head45_chamfer_cd1.32103540.js
//         On: 07/04/19, 15:41:00
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(45.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 44.91675905, 9.00000000);
  p.Ln45 = Line(45.08305658, 9.00553711, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              44.91675905, 11.50000000,
              44.91675905, 9.00000000,
              45.08305658, 9.00553711);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 45.00000000, 9.00000000, 
    29.26072809, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 44.91675905, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 45.08305658, 9.00553711, 
                p.Ln45, 55.71438482, 2.28589267);
  ...
  CoincidentCon(p.Pt98, 45.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 45.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.91675905, 9.00000000, 
                p.Cr46.Base, 44.91675905, 9.00000000);
  CoincidentCon(p.Ln45.Base, 45.08305658, 9.00553711, 
                p.Cr46.End, 45.08305658, 9.00553711);
}
