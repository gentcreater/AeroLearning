...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head40_chamfer_cd1.02610170.js
//         On: 07/04/19, 22:31:39
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(40.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 39.81354299, 7.00000000);
  p.Ln45 = Line(40.18439412, 7.02765912, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              39.81354299, 9.50000000,
              39.81354299, 7.00000000,
              40.18439412, 7.02765912);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 39.81354299, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 40.18439412, 7.02765912, 
  ...
  CoincidentCon(p.Pt98, 40.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 40.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.81354299, 7.00000000, 
                p.Cr46.Base, 39.81354299, 7.00000000);
  CoincidentCon(p.Ln45.Base, 40.18439412, 7.02765912, 
                p.Cr46.End, 40.18439412, 7.02765912);
}
