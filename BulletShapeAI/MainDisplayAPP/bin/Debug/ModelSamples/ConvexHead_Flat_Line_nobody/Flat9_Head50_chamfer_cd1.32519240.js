...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head50_chamfer_cd1.32519240.js
//         On: 07/04/19, 15:40:04
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(50.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 49.87531095, 9.00000000);
  p.Ln45 = Line(50.12407024, 9.01240702, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              49.87531095, 11.50000000,
              49.87531095, 9.00000000,
              50.12407024, 9.01240702);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 50.00000000, 9.00000000, 
    32.51192010, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 49.87531095, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 50.12407024, 9.01240702, 
  ...
  CoincidentCon(p.Pt98, 50.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 50.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 49.87531095, 9.00000000, 
                p.Cr46.Base, 49.87531095, 9.00000000);
  CoincidentCon(p.Ln45.Base, 50.12407024, 9.01240702, 
                p.Cr46.End, 50.12407024, 9.01240702);
}
