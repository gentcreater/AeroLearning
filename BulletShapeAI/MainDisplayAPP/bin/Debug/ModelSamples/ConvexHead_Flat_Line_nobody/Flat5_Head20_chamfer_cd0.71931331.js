...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head20_chamfer_cd0.71931331.js
//         On: 07/04/19, 15:22:19
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(20.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 19.84435563, 5.00000000);
  p.Ln45 = Line(20.15444247, 5.01930531, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              19.84435563, 7.50000000,
              19.84435563, 5.00000000,
              20.15444247, 5.01930531);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 19.84435563, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 20.15444247, 5.01930531, 
  ...
  CoincidentCon(p.Pt98, 20.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 20.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.84435563, 5.00000000, 
                p.Cr46.Base, 19.84435563, 5.00000000);
  CoincidentCon(p.Ln45.Base, 20.15444247, 5.01930531, 
                p.Cr46.End, 20.15444247, 5.01930531);
}
