...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head25_chamfer_cd1.28170190.js
//         On: 07/04/19, 15:42:39
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(25.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 24.96429300, 9.00000000);
  p.Ln45 = Line(25.03569243, 9.00101978, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              24.96429300, 11.50000000,
              24.96429300, 9.00000000,
              25.03569243, 9.00101978);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 25.00000000, 9.00000000, 
    16.25596005, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 24.96429300, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 25.03569243, 9.00101978, 
  ...
  CoincidentCon(p.Pt98, 25.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 25.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.96429300, 9.00000000, 
                p.Cr46.Base, 24.96429300, 9.00000000);
  CoincidentCon(p.Ln45.Base, 25.03569243, 9.00101978, 
                p.Cr46.End, 25.03569243, 9.00101978);
}
