...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat1_Head1_cd0.43031592 .js
//         On: 06/19/19, 09:11:15
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 1.00000000, 1.00000000);
  p.Ln45 = Line(1.00000000, 1.00000000, 60.00000000, 10.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Ln43.End, 1.00000000, 1.00000000, 
    0.65023840, 2.08291601);
  if(dim) dim.Name = "H20";
  ...
  CoincidentCon(p.Ln45.Base, 1.00000000, 1.00000000, 
