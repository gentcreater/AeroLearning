...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head25_chamfer_cd0.94871982 .js
//         On: 07/04/19, 22:33:59
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(25.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 24.89305322, 7.00000000);
  p.Ln45 = Line(25.10655607, 7.00913338, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              24.89305322, 9.50000000,
              24.89305322, 7.00000000,
              25.10655607, 7.00913338);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 24.89305322, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 25.10655607, 7.00913338, 
  ...
  CoincidentCon(p.Pt98, 25.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 25.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 24.89305322, 7.00000000, 
                p.Cr46.Base, 24.89305322, 7.00000000);
  CoincidentCon(p.Ln45.Base, 25.10655607, 7.00913338, 
                p.Cr46.End, 25.10655607, 7.00913338);
}
