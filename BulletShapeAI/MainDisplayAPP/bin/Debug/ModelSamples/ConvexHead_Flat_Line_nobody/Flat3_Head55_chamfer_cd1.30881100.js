...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head55_chamfer_cd1.30881100.js
//         On: 07/04/19, 14:55:31
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(55.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 53.71345526, 3.00000000);
  p.Ln45 = Line(55.74778894, 4.04690452, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              53.71345526, 5.50000000,
              53.71345526, 3.00000000,
              55.74778894, 4.04690452);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 53.71345526, 3.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 55.74778894, 4.04690452, 
  ...
  CoincidentCon(p.Pt98, 55.00000000, 3.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 55.00000000, 3.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 53.71345526, 3.00000000, 
                p.Cr46.Base, 53.71345526, 3.00000000);
  CoincidentCon(p.Ln45.Base, 55.74778894, 4.04690452, 
                p.Cr46.End, 55.74778894, 4.04690452);
}
