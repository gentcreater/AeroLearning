...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head10_chamfer_cd1.25640810.js
//         On: 07/04/19, 15:43:47
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(10.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 9.97500250, 9.00000000);
  p.Ln45 = Line(10.02499250, 9.00049985, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              9.97500250, 11.50000000,
              9.97500250, 9.00000000,
              10.02499250, 9.00049985);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 10.00000000, 9.00000000, 
    6.50238402, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 9.97500250, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 10.02499250, 9.00049985, 
  ...
  CoincidentCon(p.Pt98, 10.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 10.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.97500250, 9.00000000, 
                p.Cr46.Base, 9.97500250, 9.00000000);
  CoincidentCon(p.Ln45.Base, 10.02499250, 9.00049985, 
                p.Cr46.End, 10.02499250, 9.00049985);
}
