...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head20_chamfer_cd0.93258829 .js
//         On: 07/04/19, 22:34:23
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(20.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 19.90638147, 7.00000000);
  p.Ln45 = Line(20.09335634, 7.00700173, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              19.90638147, 9.50000000,
              19.90638147, 7.00000000,
              20.09335634, 7.00700173);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 19.90638147, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 20.09335634, 7.00700173, 
  ...
  CoincidentCon(p.Pt98, 20.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 20.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 19.90638147, 7.00000000, 
                p.Cr46.Base, 19.90638147, 7.00000000);
  CoincidentCon(p.Ln45.Base, 20.09335634, 7.00700173, 
                p.Cr46.End, 20.09335634, 7.00700173);
}
