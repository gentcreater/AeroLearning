...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head1_cd0.46010200.js
//         On: 07/04/19, 14:54:43
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 1.00000000, 3.00000000);
  p.Ln45 = Line(1.00000000, 3.00000000, 60.00000000, 10.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Ln43.End, 1.00000000, 3.00000000, 
    0.65023840, 4.08291601);
  if(dim) dim.Name = "H20";
  ...
  CoincidentCon(p.Ln45.Base, 1.00000000, 3.00000000, 
