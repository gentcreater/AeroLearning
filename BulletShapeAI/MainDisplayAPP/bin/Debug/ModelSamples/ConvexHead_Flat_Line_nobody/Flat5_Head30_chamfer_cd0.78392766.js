...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head30_chamfer_cd0.78392766.js
//         On: 07/04/19, 15:21:29
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(30.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 29.79309367, 5.00000000);
  p.Ln45 = Line(30.20409114, 5.03401519, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              29.79309367, 7.50000000,
              29.79309367, 5.00000000,
              30.20409114, 5.03401519);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 29.79309367, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 30.20409114, 5.03401519, 
  ...
  CoincidentCon(p.Pt98, 30.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 30.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.79309367, 5.00000000, 
                p.Cr46.Base, 29.79309367, 5.00000000);
  CoincidentCon(p.Ln45.Base, 30.20409114, 5.03401519, 
                p.Cr46.End, 30.20409114, 5.03401519);
}
