...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head40_chamfer_cd1.30562670.js
//         On: 07/04/19, 15:41:23
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(40.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 39.93753901, 9.00000000);
  p.Ln45 = Line(40.06238306, 9.00311915, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              39.93753901, 11.50000000,
              39.93753901, 9.00000000,
              40.06238306, 9.00311915);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 40.00000000, 9.00000000, 
    26.00953608, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 39.93753901, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 40.06238306, 9.00311915, 
  ...
  CoincidentCon(p.Pt98, 40.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 40.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 39.93753901, 9.00000000, 
                p.Cr46.Base, 39.93753901, 9.00000000);
  CoincidentCon(p.Ln45.Base, 40.06238306, 9.00311915, 
                p.Cr46.End, 40.06238306, 9.00311915);
}
