...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head45_chamfer_cd0.91253248 .js
//         On: 07/04/19, 15:20:03
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(45.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 44.59430585, 5.00000000);
  p.Ln45 = Line(45.38487526, 5.12829175, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              44.59430585, 7.50000000,
              44.59430585, 5.00000000,
              45.38487526, 5.12829175);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 44.59430585, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 45.38487526, 5.12829175, 
  ...
  CoincidentCon(p.Pt98, 45.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 45.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 44.59430585, 5.00000000, 
                p.Cr46.Base, 44.59430585, 5.00000000);
  CoincidentCon(p.Ln45.Base, 45.38487526, 5.12829175, 
                p.Cr46.End, 45.38487526, 5.12829175);
}
