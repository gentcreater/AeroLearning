...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat7_Head35_chamfer_cd1.02102170 .js
//         On: 07/04/19, 22:32:46
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(35.00000000, 7.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 7.00000000, 34.85053615, 7.00000000);
  p.Ln45 = Line(35.14839920, 7.01780790, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              34.85053615, 9.50000000,
              34.85053615, 7.00000000,
              35.14839920, 7.01780790);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 34.85053615, 7.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 35.14839920, 7.01780790, 
  ...
  CoincidentCon(p.Pt98, 35.00000000, 7.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 35.00000000, 7.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.85053615, 7.00000000, 
                p.Cr46.Base, 34.85053615, 7.00000000);
  CoincidentCon(p.Ln45.Base, 35.14839920, 7.01780790, 
                p.Cr46.End, 35.14839920, 7.01780790);
}
