...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat3_Head35_chamfer_cd0.68272555.js
//         On: 07/04/19, 14:57:06
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(35.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 34.65660358, 3.00000000);
  p.Ln45 = Line(35.33067840, 3.09258995, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              34.65660358, 5.50000000,
              34.65660358, 3.00000000,
              35.33067840, 3.09258995);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 34.65660358, 3.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 35.33067840, 3.09258995, 
  ...
  CoincidentCon(p.Pt98, 35.00000000, 3.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 35.00000000, 3.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 34.65660358, 3.00000000, 
                p.Cr46.Base, 34.65660358, 3.00000000);
  CoincidentCon(p.Ln45.Base, 35.33067840, 3.09258995, 
                p.Cr46.End, 35.33067840, 3.09258995);
}
