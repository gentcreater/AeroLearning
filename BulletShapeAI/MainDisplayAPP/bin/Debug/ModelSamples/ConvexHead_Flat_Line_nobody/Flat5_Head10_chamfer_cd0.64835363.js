...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head10_chamfer_cd0.64835363.js
//         On: 07/04/19, 15:23:11
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(10.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 9.87531095, 5.00000000);
  p.Ln45 = Line(10.12407024, 5.01240702, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              9.87531095, 7.50000000,
              9.87531095, 5.00000000,
              10.12407024, 5.01240702);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 9.87531095, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 10.12407024, 5.01240702, 
  ...
  CoincidentCon(p.Pt98, 10.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 10.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 9.87531095, 5.00000000, 
                p.Cr46.Base, 9.87531095, 5.00000000);
  CoincidentCon(p.Ln45.Base, 10.12407024, 5.01240702, 
                p.Cr46.End, 10.12407024, 5.01240702);
}
