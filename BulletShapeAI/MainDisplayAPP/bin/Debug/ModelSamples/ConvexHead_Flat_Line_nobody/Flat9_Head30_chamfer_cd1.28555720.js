...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat9_Head30_chamfer_cd1.28555720.js
//         On: 07/04/19, 15:42:11
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(30.00000000, 9.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 9.00000000, 29.95834490, 9.00000000);
  p.Ln45 = Line(30.04163198, 9.00138773, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              29.95834490, 11.50000000,
              29.95834490, 9.00000000,
              30.04163198, 9.00138773);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 9.00000000, 
    p.Pt98, 30.00000000, 9.00000000, 
    19.50715206, 10.08291601);
  if(dim) dim.Name = "H20";
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 29.95834490, 9.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 30.04163198, 9.00138773, 
  ...
  CoincidentCon(p.Pt98, 30.00000000, 9.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 30.00000000, 9.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 29.95834490, 9.00000000, 
                p.Cr46.Base, 29.95834490, 9.00000000);
  CoincidentCon(p.Ln45.Base, 30.04163198, 9.00138773, 
                p.Cr46.End, 30.04163198, 9.00138773);
}
