...
// Written to: D:\SimpleModelJS\ConvexHead_Flat_Line_nobody\Flat5_Head55_chamfer_cd1.16431410.js
//         On: 07/04/19, 15:19:11
//Using:
...
with (p.Sk2)
{
  p.Pt98 = ConstructionPoint(55.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 53.96446609, 5.00000000);
  p.Ln45 = Line(55.73223305, 5.73223305, 60.00000000, 10.00000000);
  p.Cr46 = ArcCtrEdge(
              53.96446609, 7.50000000,
              53.96446609, 5.00000000,
              55.73223305, 5.73223305);
  p.Cr46.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr46, 53.96446609, 5.00000000, 
                p.Ln43, 53.52899163, 1.00000000);
  TangentCon(p.Cr46, 55.73223305, 5.73223305, 
  ...
  CoincidentCon(p.Pt98, 55.00000000, 5.00000000, 
                p.Ln43, 55.02393605, 1.00000000);
  CoincidentCon(p.Ln45.End, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt98, 55.00000000, 5.00000000, 
                p.Ln45, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 53.96446609, 5.00000000, 
                p.Cr46.Base, 53.96446609, 5.00000000);
  CoincidentCon(p.Ln45.Base, 55.73223305, 5.73223305, 
                p.Cr46.End, 55.73223305, 5.73223305);
}
