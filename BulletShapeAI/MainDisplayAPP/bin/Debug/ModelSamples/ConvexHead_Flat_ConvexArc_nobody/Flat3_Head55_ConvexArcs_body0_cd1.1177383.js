...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat3_Head55_ConvexArcs_body0_cd1.1177383.js
//         On: 07/03/19, 15:28:11
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 55.00000000, 3.00000000);
  p.Cr44 = ArcCtrEdge(
              66.24974222, 0.25018413,
              60.00000000, 10.00000000,
              55.00000000, 3.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, -0.00000000, 3.00000000, 
    p.Ln43.End, 55.00000000, 3.00000000, 
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr44.End, 55.00000000, 3.00000000, 
                p.Ln43.End, 55.00000000, 3.00000000);
}
