...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat1_Head50_ConvexArcs_body0_chamfer_cd0.63683106.js
//         On: 07/02/19, 20:36:11
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(50.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 48.14568121, 1.00000000);
  p.Cr44 = ArcCtrEdge(
              61.30632550, -1.50702833,
              60.00000000, 10.00000000,
              50.48228723, 2.61102737);
  p.Cr45 = ArcCtrEdge(
              48.14568121, 3.50000000,
              48.14568121, 1.00000000,
              50.48228723, 2.61102737);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 48.14568121, 1.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 50.48228723, 2.61102737, 
                p.Cr44, 50.48228723, 2.61102737);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 50.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 50.00000000, 1.00000000, 
                p.Cr44, 50.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 48.14568121, 1.00000000, 
                p.Cr45.Base, 48.14568121, 1.00000000);
  CoincidentCon(p.Cr44.End, 50.48228723, 2.61102737, 
                p.Cr45.End, 50.48228723, 2.61102737);
}
