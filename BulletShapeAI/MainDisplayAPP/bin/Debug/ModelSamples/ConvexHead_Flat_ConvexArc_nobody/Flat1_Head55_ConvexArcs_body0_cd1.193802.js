...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\FlatHead1_ConvexArcs_body0_cd1.193802.js
//         On: 07/02/19, 20:13:16
//Using:
...
with (p.Sk2)
{
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 55.00000000, 1.00000000);
  p.Cr44 = ArcCtrEdge(
              66.56843644, 0.46197976,
              60.00000000, 10.00000000,
              55.00000000, 1.00000000);
}
...
with (p.Plane)
{
  ...
  dim = HorizontalDim(p.Ln43.Base, 0.00000000, 1.00000000, 
    p.Ln43.End, 55.00000000, 1.00000000, 
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr44.End, 55.00000000, 1.00000000, 
                p.Ln43.End, 55.00000000, 1.00000000);
}
