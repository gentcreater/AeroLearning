...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat5_Head45_ConvexArcs_body0_chamfer_cd0.7375396.js
//         On: 07/07/19, 16:54:44
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(45.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 43.60824830, 5.00000000);
  p.Cr45 = ArcCtrEdge(
              43.60824830, 7.50000000,
              43.60824830, 5.00000000,
              45.22448190, 5.59270113);
  p.Cr45.DeleteCenter();
  p.Cr46 = ArcCtrEdge(
              57.63974373, -9.05840801,
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 43.60824830, 5.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr46, 45.22448190, 5.59270113, 
                p.Cr45, 45.22448190, 5.59270113);
  ...
  CoincidentCon(p.Pt96, 45.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 43.60824830, 5.00000000, 
                p.Cr45.Base, 43.60824830, 5.00000000);
  CoincidentCon(p.Cr46.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr46.End, 45.22448190, 5.59270113, 
                p.Cr45.End, 45.22448190, 5.59270113);
}
