...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat1_Head55_ConvexArcs_body0_chamfer_cd1.1929498.js
//         On: 07/02/19, 20:34:04
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(55.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 52.81913377, 1.00000000);
  p.Cr44 = ArcCtrEdge(
              66.56843644, 0.46197976,
              60.00000000, 10.00000000,
              55.26025311, 2.96061483);
  p.Cr45 = ArcCtrEdge(
              52.81913377, 3.50000000,
              52.81913377, 1.00000000,
              55.26025311, 2.96061483);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 52.81913377, 1.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 55.26025311, 2.96061483, 
                p.Cr44, 55.26025311, 2.96061483);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 1.00000000, 
                p.Cr44, 55.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 52.81913377, 1.00000000, 
                p.Cr45.Base, 52.81913377, 1.00000000);
  CoincidentCon(p.Cr44.End, 55.26025311, 2.96061483, 
                p.Cr45.End, 55.26025311, 2.96061483);
}
