...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat5_Head55_ConvexArcs_body0_chamfer_cd1.0680321.js
//         On: 07/07/19, 16:53:48
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(55.00000000, 5.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 5.00000000, 53.57352297, 5.00000000);
  p.Cr44 = ArcCtrEdge(
              65.29801857, -0.29801857,
              60.00000000, 10.00000000,
              55.65514803, 6.11550113);
  p.Cr45 = ArcCtrEdge(
              53.57352297, 7.50000000,
              53.57352297, 5.00000000,
              55.65514803, 6.11550113);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 53.57352297, 5.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 55.65514803, 6.11550113, 
                p.Cr44, 55.65514803, 6.11550113);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 5.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 5.00000000, 
                p.Cr44, 55.00000000, 5.00000000);
  CoincidentCon(p.Ln43.End, 53.57352297, 5.00000000, 
                p.Cr45.Base, 53.57352297, 5.00000000);
  CoincidentCon(p.Cr44.End, 55.65514803, 6.11550113, 
                p.Cr45.End, 55.65514803, 6.11550113);
}
