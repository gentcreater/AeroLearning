...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat3_Head55_ConvexArcs_body0_chamfer_cd1.1163549.js
//         On: 07/04/19, 13:12:22
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(55.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 53.18404958, 3.00000000);
  p.Cr44 = ArcCtrEdge(
              66.24974222, 0.25018413,
              60.00000000, 10.00000000,
              55.50379741, 4.56792167);
  p.Cr45 = ArcCtrEdge(
              53.18404958, 5.50000000,
              53.18404958, 3.00000000,
              55.50379741, 4.56792167);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 53.18404958, 3.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 55.50379741, 4.56792167, 
                p.Cr44, 55.50379741, 4.56792167);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 55.00000000, 3.00000000, 
                p.Cr44, 55.00000000, 3.00000000);
  CoincidentCon(p.Ln43.End, 53.18404958, 3.00000000, 
                p.Cr45.Base, 53.18404958, 3.00000000);
  CoincidentCon(p.Cr44.End, 55.50379741, 4.56792167, 
                p.Cr45.End, 55.50379741, 4.56792167);
}
