...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat5_Head25_ConvexArcs_body0_cd0.66316569.js
//         On: 07/07/19, 16:51:24
//Using:
...
with (p.Sk2)
{
  ...
  p.Cr45 = ArcCtrEdge(
              56.86480679, -93.05364754,
              60.00000000, 10.00000000,
              25.00000000, 5.00000000);
}
...
with (p.Plane)
{
  ...
  CoincidentCon(p.Cr45.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Cr45.End, 25.00000000, 5.00000000, 
                p.Ln43, 24.98567701, 5.00000000);
  CoincidentCon(p.Cr45.End, 25.00000000, 5.00000000, 
                p.Ln43.End, 25.00000000, 5.00000000);
}
