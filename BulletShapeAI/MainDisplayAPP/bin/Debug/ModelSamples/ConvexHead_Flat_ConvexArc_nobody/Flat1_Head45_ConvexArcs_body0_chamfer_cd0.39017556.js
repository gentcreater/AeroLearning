...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat1_Head45_ConvexArcs_body0_chamfer_cd0.39017556.js
//         On: 07/02/19, 20:36:51
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(45.00000000, 1.00000000);
  ...
  p.Ln43 = Line(0.00000000, 1.00000000, 43.06586163, 1.00000000);
  p.Cr44 = ArcCtrEdge(
              56.40536466, -1.00894110,
              60.00000000, 10.00000000,
              45.43422311, 2.69946025);
  p.Cr45 = ArcCtrEdge(
              43.06586163, 3.50000000,
              43.06586163, 1.00000000,
              45.43422311, 2.69946025);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 43.06586163, 1.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 45.43422311, 2.69946025, 
                p.Cr44, 45.43422311, 2.69946025);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 45.00000000, 1.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 45.00000000, 1.00000000, 
                p.Cr44, 45.00000000, 1.00000000);
  CoincidentCon(p.Ln43.End, 43.06586163, 1.00000000, 
                p.Cr45.Base, 43.06586163, 1.00000000);
  CoincidentCon(p.Cr44.End, 45.43422311, 2.69946025, 
                p.Cr45.End, 45.43422311, 2.69946025);
}
