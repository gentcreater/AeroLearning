...
// Written to: G:\workbench\SimpleModelJS\ConvexHead_Flat_ConvexArc_nobody\Flat3_Head50_ConvexArcs_body0_chamfer_cd0.67164322.js
//         On: 07/04/19, 13:12:41
//Using:
...
with (p.Sk2)
{
  p.Pt96 = ConstructionPoint(50.00000000, 3.00000000);
  ...
  p.Ln43 = Line(-0.00000000, 3.00000000, 48.46270176, 3.00000000);
  p.Cr44 = ArcCtrEdge(
              60.64411030, -1.56301471,
              60.00000000, 10.00000000,
              50.62544941, 4.24599736);
  p.Cr45 = ArcCtrEdge(
              48.46270176, 5.50000000,
              48.46270176, 3.00000000,
              50.62544941, 4.24599736);
  p.Cr45.DeleteCenter();
}
...
with (p.Plane)
{
  ...
  VerticalCon(p.Ln20);
  VerticalCon(p.Ln24);
  TangentCon(p.Cr45, 48.46270176, 3.00000000, 
                p.Ln43, 52.81913377, 1.00000000);
  TangentCon(p.Cr45, 50.62544941, 4.24599736, 
                p.Cr44, 50.62544941, 4.24599736);
  ...
  CoincidentCon(p.Cr44.Base, 60.00000000, 10.00000000, 
                p.Ln20.End, 60.00000000, 10.00000000);
  CoincidentCon(p.Pt96, 50.00000000, 3.00000000, 
                p.Ln43, 55.00000000, 1.00000000);
  CoincidentCon(p.Pt96, 50.00000000, 3.00000000, 
                p.Cr44, 50.00000000, 3.00000000);
  CoincidentCon(p.Ln43.End, 48.46270176, 3.00000000, 
                p.Cr45.Base, 48.46270176, 3.00000000);
  CoincidentCon(p.Cr44.End, 50.62544941, 4.24599736, 
                p.Cr45.End, 50.62544941, 4.24599736);
}
